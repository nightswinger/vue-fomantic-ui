import{o as i,c as r,w as a,a as s,b as e,u as t,a7 as o,f as d,U as p,Y as u,h,a5 as _,F as g,a4 as b,O as y,e as f,D as w}from"./index-DSC_QGPC.js";import{_ as m}from"./DocSection-Dy7AO88P.js";const v=`<template>
  <Message
  ...
  />
</template>`,$=d({__name:"ListMessageDoc",setup(l){return(c,n)=>(i(),r(m,{label:"List Message",code:x},{description:a(()=>[s(" A message with a list ")]),example:a(()=>[e(t(o),{header:"New Site Features",list:["You can now have cover images on blog pages","Drafts will now auto-save while writing"]})]),_:1}))}}),F=`<template>
  <Message
    icon="inbox"
  ...
  />
</template>`,W=d({__name:"HiddenDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Hidden",code:V},{description:a(()=>[s(" A message can be hidden ")]),example:a(()=>[e(t(o),{hidden:"",content:"You can't see me"})]),_:1}))}}),Y=`<template>
  <Message
    visible
    content="You can always see me"
  />
</template>`,k=d({__name:"VisibleDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Visible",code:Y},{description:a(()=>[s(" A message can be set to visible to force itself to be shown. ")]),example:a(()=>[e(t(o),{visible:"",content:"You can always see me"})]),_:1}))}}),N=`<template>
  <Message
    aligned="center"
  ...
  <Message
    ...
    content="When are you going to update?"
  />
</template>`,z=d({__name:"AlignedDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Aligned",code:N},{description:a(()=>[s(" A message can be displayed center or right aligned ")]),example:a(()=>[e(t(o),{aligned:"center",header:"New Version is available!",content:"When are you going to update?"}),e(t(o),{aligned:"right",header:"New Version is available!",content:"When are you going to update?"})]),_:1}))}}),S=`<template>
  <Message
    floating
    content="Way to go!"
  />
  ...
  />
</template>`,G=d({__name:"CompactDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Compact",code:B},{description:a(()=>[s(" A message can only take up the width of its content. ")]),example:a(()=>[e(t(o),{compact:"",content:"Get all the best inventions in your e-mail every day. Sign up now!"})]),_:1}))}}),I=f("a",{href:"#"},"Login here",-1),P=`<template>
  <Message
    attached
...
</template>`,L=d({__name:"AttachedDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Attached",code:P},{description:a(()=>[s(" A message can be formatted to attach itself to other content ")]),example:a(()=>[e(t(o),{attached:"",header:"Welcome to our site!",content:"Fill out the form below to sign-up for a new account"}),e(t(u),{attached:""},{default:a(()=>[e(t(h),null,{default:a(()=>[e(t(_),{widths:"equal"},{default:a(()=>[e(t(g),{label:"First Name",placeholder:"First Name"}),e(t(g),{label:"Last Name",placeholder:"Last Name"})]),_:1}),e(t(g),{label:"Username",placeholder:"Username"}),e(t(g),{label:"Password",type:"password",placeholder:"Password"}),e(t(g),null,{default:a(()=>[e(t(b),{label:"I agree to the Terms and Conditions"})]),_:1}),e(t(y),{primary:""},{default:a(()=>[s("Submit")]),_:1})]),_:1})]),_:1}),e(t(o),{warning:"",attached:"bottom"},{default:a(()=>[e(t(p),{name:"help"}),s(" Already signed up? "),I,s(" instead. ")]),_:1})]),_:1}))}}),O=`<template>
  <Message
    warning
