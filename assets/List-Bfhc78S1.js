import{e as g,r as I,o as s,c as r,w as e,a as i,b as a,u as t,Z as p,p as f,F as S,s as b,l as n,t as _,K as C,G as m,v,y as k,d as H,Q as u,z as h,L as A,D as j}from"./index-B2sz39O7.js";import{_ as L}from"./DocSection-LsN_yblw.js";const w=`<template>
  <List :items="items" />
</template>
...
<\/script>`,$=g({__name:"ListDoc",setup(d){const o=I(["Apples","Pears","Oranges"]);return(c,y)=>(s(),r(L,{label:"List",code:w},{description:e(()=>[i(" A list groups related content ")]),example:e(()=>[a(t(p),{items:o.value},null,8,["items"])]),_:1}))}}),z=["href"],F=["href"],T=`<template>
  <List>
    <ListItem
      v-for="item in items"
      :key="item.content"
...
<\/script>`,U=g({__name:"ListWithIconDoc",setup(d){const o=I([{icon:"users",content:"Fomantic UI"},{icon:"marker",content:"Worldwide"},{icon:"mail",content:"contact@fomantic-ui.com"},{icon:"linkify",content:"fomantic-ui.com"}]);return(c,y)=>(s(),r(L,{code:T},{example:e(()=>[a(t(p),null,{default:e(()=>[(s(!0),f(S,null,b(o.value,l=>(s(),r(t(n),{key:l.content,icon:l.icon},{default:e(()=>[l.icon==="mail"?(s(),f("a",{key:0,href:"mailto:"+l.content},_(l.content),9,z)):l.icon==="linkify"?(s(),f("a",{key:1,href:"https://"+l.content},_(l.content),9,F)):(s(),f(S,{key:2},[i(_(l.content),1)],64))]),_:2},1032,["icon"]))),128))]),_:1})]),_:1}))}}),P=`<template>
...
</template>`,G={__name:"BulletedDoc",setup(d){return(o,c)=>(s(),r(L,{label:"Bulleted",code:V},{description:e(()=>[i(" A list can mark items with a bullet ")]),example:e(()=>[a(t(p),{bulleted:""},{default:e(()=>[a(t(n),null,{default:e(()=>[i("Gaining Access")]),_:1}),a(t(n),null,{default:e(()=>[i("Inviting Friends")]),_:1}),a(t(n),null,{default:e(()=>[i(" Benefits "),a(t(k),null,{default:e(()=>[a(t(n),null,{default:e(()=>[i("Link to somewhere")]),_:1}),a(t(n),null,{default:e(()=>[i("Rebates")]),_:1}),a(t(n),null,{default:e(()=>[i("Discounts")]),_:1})]),_:1})]),_:1}),a(t(n),null,{default:e(()=>[i("Warranty")]),_:1})]),_:1})]),_:1}))}},R=H("a",null,"Languages",-1),J=`<template>
  <SuiList ordered>
...
</template>`,W={__name:"OrderedDoc",setup(d){return(o,c)=>(s(),r(L,{label:"Ordered",code:J},{description:e(()=>[i(" A list can be ordered numerically ")]),example:e(()=>[a(t(p),{ordered:""},{default:e(()=>[a(t(n),{as:"a"},{default:e(()=>[i("Getting Started")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("Introduction")]),_:1}),a(t(n),null,{default:e(()=>[R,a(t(k),null,{default:e(()=>[a(t(n),{as:"a"},{default:e(()=>[i("HTML")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("Javascript")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("CSS")]),_:1})]),_:1})]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("Review")]),_:1})]),_:1})]),_:1}))}},E=`<template>
  <List link>
...
</template>`,O={__name:"LinkDoc",setup(d){return(o,c)=>(s(),r(L,{label:"Link",code:E},{description:e(()=>[i(" A list can be specially formatted for navigation links ")]),example:e(()=>[a(t(p),{link:""},{default:e(()=>[a(t(n),{active:""},{default:e(()=>[i("Home")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("About")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("Jobs")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("Team")]),_:1})]),_:1})]),_:1}))}},q=`<template>
  <SuiList>
    <SuiListItem as="a">
      <SuiIcon name="help" />
      <SuiListContent>
...
</template>`,M={__name:"IconDoc",setup(d){return(o,c)=>(s(),r(L,{label:"Icon",code:q},{description:e(()=>[i(" A list item can contain an icon ")]),example:e(()=>[a(t(p),null,{default:e(()=>[a(t(n),{as:"a"},{default:e(()=>[a(t(C),{name:"help"}),a(t(u),null,{default:e(()=>[a(t(m),null,{default:e(()=>[i("Floated Icon")]),_:1}),a(t(v),null,{default:e(()=>[i(" This text will always have a left margin to make sure it sits alongside your icon ")]),_:1})]),_:1})]),_:1}),a(t(n),{as:"a"},{default:e(()=>[a(t(C),{name:"right triangle"}),a(t(u),null,{default:e(()=>[a(t(m),null,{default:e(()=>[i("Icon Alignment")]),_:1}),a(t(v),null,{default:e(()=>[i(" Floated icons are by default top aligned. To have an icon top aligned try this example. ")]),_:1})]),_:1})]),_:1}),a(t(n),null,{default:e(()=>[a(t(C),{name:"help"}),i(" Inline Text ")]),_:1})]),_:1})]),_:1}))}},N=H("a",null,[H("b",null,"Arrested Development")],-1),K=H("a",null,[H("b",null,"Bob's Burgers")],-1),Z=H("a",null,[H("b",null,"The Godfather Part 2")],-1),Q=H("a",null,[H("b",null,"Twin Peaks")],-1),X=`<template>
  <SuiList>
    <SuiListItem>
...
</template>`,Y={__name:"ImageDoc",setup(d){return(o,c)=>(s(),r(L,{label:"Image",code:X},{description:e(()=>[i(" A list item can contain an image ")]),example:e(()=>[a(t(p),null,{default:e(()=>[a(t(n),null,{default:e(()=>[a(t(h),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/rachel.png"}),a(t(u),null,{default:e(()=>[a(t(m),{as:"a"},{default:e(()=>[i("Rachel")]),_:1}),a(t(v),null,{default:e(()=>[i(" Last seen watching "),N,i(" just now. ")]),_:1})]),_:1})]),_:1}),a(t(n),null,{default:e(()=>[a(t(h),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/lindsay.png"}),a(t(u),null,{default:e(()=>[a(t(m),{as:"a"},{default:e(()=>[i("Lindsay")]),_:1}),a(t(v),null,{default:e(()=>[i(" Last seen watching "),K,i(" 10 hours ago. ")]),_:1})]),_:1})]),_:1}),a(t(n),null,{default:e(()=>[a(t(h),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matthew.png"}),a(t(u),null,{default:e(()=>[a(t(m),{as:"a"},{default:e(()=>[i("Matthew")]),_:1}),a(t(v),null,{default:e(()=>[i(" Last seen watching "),Z,i(" yesterday. ")]),_:1})]),_:1})]),_:1}),a(t(n),null,{default:e(()=>[a(t(h),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/jenny.jpg"}),a(t(u),null,{default:e(()=>[a(t(m),{as:"a"},{default:e(()=>[i("Jenny Hess")]),_:1}),a(t(v),null,{default:e(()=>[i(" Last seen watching "),Q,i(" 3 days ago. ")]),_:1})]),_:1})]),_:1}),a(t(n),null,{default:e(()=>[a(t(h),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/veronika.jpg"}),a(t(u),null,{default:e(()=>[a(t(m),{as:"a"},{default:e(()=>[i("Veronika Ossi")]),_:1}),a(t(v),null,{default:e(()=>[i(" Has not watched anything recently ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}))}},ee=`<template>
  <List>
    <ListItem>
