import{o as i,c as r,w as a,a as s,b as e,u as t,R as o,_ as d,d as m,k as p,y as u,m as h,n as _,p as g,q as b,D as y,f,l as w}from"./index-MO8VB4d8.js";const v=`<template>
  <Message
  ...
  />
</template>`,A=m({__name:"DismissableBlockDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Dismissable Block",code:D},{description:a(()=>[s(" A message that the user can choose to hide ")]),example:a(()=>[e(t(o),{header:"Welcome back!",content:"This is a special notification which you can dismiss if you're bored with it.",closable:"",onClose:n[0]||(n[0]=()=>console.log("Message closed"))})]),_:1}))}}),V=`<template>
  <Message
    hidden
  ...
  <Message
    ...
    closable
  />
</template>`,O=m({__name:"WarningDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Warning",code:H},{description:a(()=>[s(" A message may be formatted to display warning messages. ")]),example:a(()=>[e(t(o),{warning:"",header:"You must register before you can do that!",content:"Visit our registration page, then try again",closable:""})]),_:1}))}}),R=`<template>
  <Message
    info
    ...
    closable
  />
</template>`,U=m({__name:"InfoDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Info",code:R},{description:a(()=>[s(" A message may be formatted to display information. ")]),example:a(()=>[e(t(o),{info:"",header:"Was this what you wanted?",list:["It's good to see you again.","Did you know it's been a while?"],closable:""},null,8,["list"])]),_:1}))}}),q=`<template>
  <Message
    positive
