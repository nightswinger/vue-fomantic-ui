import{f as g,o as n,c as l,w as e,a as r,b as t,u as a,aj as d,q as m,ak as o,e as i,U as k,X as F,r as b,al as w,y as h,A as v,B as y,t as f,I as D,O as x,am as A,N as I,an as j,ao as $,E as G,g as M,Y as E,D as N}from"./index-DSC_QGPC.js";import{_}from"./DocSection-Dy7AO88P.js";const z=i("span",null,"Joined in 2013",-1),V=i("span",{class:"right floated"},"14h",-1),J={class:"right floated"},B=`<template>
  <Card>
...
</template>`,H=g({__name:"CardDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Card",code:B},{description:e(()=>[r(" A single card. ")]),example:e(()=>[t(a(d),null,{default:e(()=>[t(a(m),{src:"/vue-fomantic-ui/images/avatar/large/kristy.png"}),t(a(o),{header:"Kristy"},{meta:e(()=>[z]),description:e(()=>[r(" Kristy is an art director living in New York. ")]),_:1}),t(a(o),{extra:""},{default:e(()=>[i("a",null,[t(a(k),{name:"user"}),r(" 22 Friends ")])]),_:1})]),_:1}),t(a(d),null,{default:e(()=>[t(a(o),null,{meta:e(()=>[V]),default:e(()=>[t(a(m),{avatar:"",src:"/vue-fomantic-ui/images/avatar/large/elliot.jpg"}),r(" Elliot ")]),_:1}),t(a(m),{src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(a(o),null,{default:e(()=>[i("span",J,[t(a(k),{name:"heart outline like"}),r(" 17 likes ")]),t(a(k),{name:"comment"}),r(" 3 comments ")]),_:1}),t(a(o),{extra:""},{default:e(()=>[t(a(F),{icon:"heart outline",iconPosition:"left",size:"large",transparent:"",placeholder:"Add Comment..."})]),_:1})]),_:1})]),_:1}))}}),S=`<template>
  <CardGroup>
...
<\/script>`,X=g({__name:"HeaderDoc",setup(p){const s=b([{header:"Elliot Fu",meta:"Friend",description:"Elliot Fu is a film-maker from New York."},{header:"Veronika Ossi",meta:"Friend",description:"Veronika Ossi is a set designer living in New York who enjoys kittens, music, and partying."},{header:"Jenny Hess",meta:"Friend",description:"Jenny is a student studying Media Management at the New School"}]);return(u,C)=>(n(),l(_,{label:"Header",code:U},{description:e(()=>[r(" A card can contain a header ")]),example:e(()=>[t(a(w),null,{default:e(()=>[(n(!0),h(v,null,y(s.value,c=>(n(),l(a(d),null,{default:e(()=>[t(a(o),null,{header:e(()=>[r(f(c.header),1)]),meta:e(()=>[r(f(c.meta),1)]),description:e(()=>[r(f(c.description),1)]),_:2},1024)]),_:2},1024))),256))]),_:1})]),_:1}))}}),Q=i("span",null,"2 days ago",-1),W=i("a",null,"Animals",-1),Z=`<template>
  <Card>
...
</template>`,ee=g({__name:"MetadataDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Metadata",code:Z},{description:e(()=>[r(" A card can contain content metadata ")]),example:e(()=>[t(a(d),null,{default:e(()=>[t(a(o),{header:"Cute Dog"},{meta:e(()=>[Q,W]),description:e(()=>[t(a(m),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1})]),_:1})]),_:1}))}}),ae=`<template>
  <CardGroup>
    <Card v-for="item in items">
      <CardContent>
        <template #header>
...
</template>`,ze=g({__name:"RaisedCardDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Raised Card",code:Ne},{description:e(()=>[r(" A card can contain content metadata ")]),example:e(()=>[t(a(d),{raised:""},{default:e(()=>[t(a(o),{header:"Cute Dog"},{meta:e(()=>[Ge,Me]),description:e(()=>[t(a(m),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(o),{extra:""},{default:e(()=>[i("div",Ee,[t(a(m),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1})]),_:1}))}}),Ve=i("span",null,"2 days ago",-1),Je=i("a",null,"Animals",-1),Be={class:"right floated"},He=i("span",null,"2 days ago",-1),Se=i("a",null,"Animals",-1),Ye={class:"right floated"},Pe=`<template>
...
</template>`,Re=g({__name:"LinkCardDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Link Card",code:Pe},{description:e(()=>[r(" A card can be formatted so that the entire contents link to another page ")]),example:e(()=>[t(a(d),{href:"https://dog.com"},{default:e(()=>[t(a(o),{header:"Cute Dog"},{meta:e(()=>[Ve,Je]),description:e(()=>[t(a(m),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(o),{extra:""},{default:e(()=>[i("div",Be,[t(a(m),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1}),t(a(d),{link:""},{default:e(()=>[t(a(o),{header:"Cute Dog"},{meta:e(()=>[He,Se]),description:e(()=>[t(a(m),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(o),{extra:""},{default:e(()=>[i("div",Ye,[t(a(m),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1})]),_:1}))}}),Ke=i("span",{class:"right floated"},"2 days ago",-1),Te={class:"right floated"},Le=`<template>
  <Card>
    <CardContent header="Cute Dog">
      <template #meta>
...
</template>`,Oe=g({__name:"FloatedContentDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Floated Content",code:Le},{description:e(()=>[r(" Any content element can be floated left or right ")]),example:e(()=>[t(a(d),null,{default:e(()=>[t(a(o),{header:"Cute Dog"},{meta:e(()=>[Ke,r(" Animals ")]),description:e(()=>[t(a(m),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(o),{extra:""},{default:e(()=>[i("div",Te,[t(a(m),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1})]),_:1}))}}),qe=i("div",{class:"center aligned"},"Jenny Hess",-1),Ue=i("p",{class:"center aligned"},"Jenny is a student studying Media Management at the New School",-1),Xe={class:"center aligned"},Qe=`<template>
  <Card>
    <CardContent>
      <template #header>
...
</template>`,We=g({__name:"TextAlignmentDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Text Alignment",code:Qe},{description:e(()=>[r(" Any element inside a card can have its text alignment specified ")]),example:e(()=>[t(a(d),null,{default:e(()=>[t(a(o),null,{header:e(()=>[qe]),description:e(()=>[Ue]),_:1}),t(a(o),{extra:""},{default:e(()=>[i("div",Xe,[t(a(m),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/jenny.jpg"}),r(" Jenny ")])]),_:1})]),_:1})]),_:1}))}}),Ze=`<template>
  <Segment inverted>
    <CardGroup inverted>
      <Card v-for="item in items">
        <Image :src="item.avatar" />
