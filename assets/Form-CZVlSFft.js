import{o as r,c as n,w as t,a as o,b as e,u as a,k as m,T as l,a5 as F,C as d,a6 as b,a7 as _,a8 as p,D as S}from"./index-C5UtasSn.js";import{_ as u}from"./DocSection-DNwpJszJ.js";const h=`<template>
  <SuiForm>
    <SuiFormField
      label="First Name"
...
</template>`,T={__name:"TextAreaDoc",setup(s){return(i,c)=>(r(),n(u,{label:"TextArea",code:$},{description:t(()=>[o(" A textarea can be used to allow for extended user input. ")]),example:t(()=>[e(a(m),null,{default:t(()=>[e(a(_),{label:"Text"}),e(a(_),{label:"Short Text",rows:2})]),_:1})]),_:1}))}},D=`<template>
  <SuiForm loading>
    <SuiFormField label="E-mail" type="email" placeholder="joe@schome.com" />
    <SuiButton type="submit">Submit</SuiButton>
  </SuiForm>
</template>`,N={__name:"LoadingDoc",setup(s){return(i,c)=>(r(),n(u,{label:"Loading",code:D},{description:t(()=>[o(" If a form is in loading state, it will automatically show a loading indicator. ")]),example:t(()=>[e(a(m),{loading:""},{default:t(()=>[e(a(l),{label:"E-mail",type:"email",placeholder:"joe@schome.com"}),e(a(d),{type:"submit"},{default:t(()=>[o("Submit")]),_:1})]),_:1})]),_:1}))}},k=`<template>
  <SuiForm success>
    <SuiFormField label="E-mail" type="email" placeholder="joe@schome.com" />
    <SuiMessage
      success
...
</template>`,C={__name:"SuccessDoc",setup(s){return(i,c)=>(r(),n(u,{label:"Success",code:k},{description:t(()=>[o(" If a form is in an success state, it will automatically show any success message blocks. ")]),example:t(()=>[e(a(m),{success:""},{default:t(()=>[e(a(l),{label:"E-mail",type:"email",placeholder:"joe@schome.com"}),e(a(p),{success:"",header:"Form Completed",content:"You're all signed up for the newsletter"}),e(a(d),{type:"submit"},{default:t(()=>[o("Submit")]),_:1})]),_:1})]),_:1}))}},B=`<template>
  <SuiForm error>
    <SuiFormField label="E-mail" type="email" placeholder="joe@schome.com" />
    <SuiMessage
      error
...
</template>`,E={__name:"ErrorDoc",setup(s){return(i,c)=>(r(),n(u,{label:"Error",code:B},{description:t(()=>[o(" If a form is in an error state, it will automatically show any error message blocks. ")]),example:t(()=>[e(a(m),{error:""},{default:t(()=>[e(a(l),{label:"E-mail",type:"email",placeholder:"joe@schome.com"}),e(a(p),{error:"",header:"Action Forbidden",content:"You can only sign up for an account once with a given e-mail address."}),e(a(d),{type:"submit"},{default:t(()=>[o("Submit")]),_:1})]),_:1})]),_:1}))}},L=`<template>
  <SuiForm warning>
    <SuiFormField label="E-mail" type="email" placeholder="joe@schome.com" />
    <SuiMessage
      warning
...
</template>`,j={__name:"DisabledDoc",setup(s){return(i,c)=>(r(),n(u,{label:"Disabled",code:I},{description:t(()=>[o(" Individual fields may be disabled ")]),example:t(()=>[e(a(m),null,{default:t(()=>[e(a(b),null,{default:t(()=>[e(a(l),{disabled:"",label:"First name",placeholder:"Read only"}),e(a(l),{disabled:"",label:"Last name",placeholder:"Disabled"})]),_:1})]),_:1})]),_:1}))}},Y={__name:"Form",setup(s){const i=[{id:"form",label:"Form",category:"Types",component:f},{id:"field",label:"Field",category:"Content",component:g},{id:"fields",label:"Fields",category:"Content",component:w},{id:"textarea",label:"TextArea",category:"Content",component:T},{id:"loading",label:"Loading",category:"Form States",component:N},{id:"success",label:"Success",category:"Form States",component:C},{id:"error",label:"Error",category:"Form States",component:E},{id:"warning",label:"Warning",category:"Form States",component:A},{id:"disabled",label:"Disabled",category:"Field States",component:j}];return(c,v)=>(r(),n(S,{title:"Form",description:"A form displays a set of related user input fields in a structured way","component-docs":i}))}};export{Y as default};
