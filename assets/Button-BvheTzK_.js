import{r as b,o as c,c as l,w as t,a as i,b as e,u as o,d as n,t as g,X as p,J as _,j as m,x as f,e as d,f as B,D as v}from"./index-CGimrHOv.js";import{_ as s}from"./DocSection-IMxQEgJe.js";const h=`<template>
...
</template>`,V={__name:"IconDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Icon",code:A},{description:t(()=>[i(" A button can have only an icon ")]),example:t(()=>[e(o(n),{icon:"cloud"})]),_:1}))}},C=`<template>
...
</template>`,W={__name:"ConditionalsDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Conditionals",code:Y},{description:t(()=>[i(" Button groups can contain conditionals ")]),example:t(()=>[e(o(d),null,{default:t(()=>[e(o(n),{content:"Cancel"}),R,e(o(n),{content:"Save",positive:""})]),_:1}),e(o(d),null,{default:t(()=>[e(o(n),{content:"un"}),H,e(o(n),{content:"deux",positive:""})]),_:1})]),_:1}))}},j=`<template>
  <SuiButton active icon="user" content=" Follow" />
</template>`,K={__name:"ActiveDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Active",code:j},{description:t(()=>[i(" A button can show it is currently the active user selection ")]),example:t(()=>[e(o(n),{active:"",icon:"user",content:" Follow"})]),_:1}))}},X=`<template>
...
</template>`,U={__name:"LoadingDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Loading",code:Q},{description:t(()=>[i(" A button can show a loading indicator ")]),example:t(()=>[e(o(n),{loading:"",content:"Loading"}),e(o(n),{loading:"double",primary:"",content:"Loading"}),e(o(n),{loading:"elastic",secondary:"",content:"Loading"})]),_:1}))}},Z=`<template>
...
</template>`,qt={__name:"GroupSizesDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Group Sizes",code:It},{description:t(()=>[i(" Groups can have a shared color ")]),example:t(()=>[e(o(d),{size:"large"},{default:t(()=>[e(o(n),null,{default:t(()=>[i("One")]),_:1}),e(o(n),null,{default:t(()=>[i("Two")]),_:1}),e(o(n),null,{default:t(()=>[i("Three")]),_:1})]),_:1})]),_:1}))}},Rt={__name:"Button",setup(r){const a=[{id:"button",label:"Button",category:"Types",component:y},{id:"emphasis",label:"Emphasis",category:"Types",component:w},{id:"animated",label:"Animated",category:"Types",component:$},{id:"labeled",label:"Labeled",category:"Types",component:T},{id:"icon",label:"Icon",category:"Types",component:V},{id:"labeled-icon",label:"Labeled Icon",category:"Types",component:D},{id:"basic",label:"Basic",category:"Types",component:P},{id:"tertiary",label:"Tertiary",category:"Types",component:F},{id:"inverted",label:"Inverted",category:"Types",component:I},{id:"buttons",label:"Buttons",category:"Groups",component:N},{id:"icon-buttons",label:"Icon Buttons",category:"Groups",component:E},{id:"content",label:"Content",category:"Content",component:W},{id:"active",label:"Active",category:"States",component:K},{id:"disabled",label:"Disabled",category:"States",component:J},{id:"loading",label:"Loading",category:"States",component:U},{id:"social",label:"Social",category:"Variations",component:tt},{id:"size",label:"Size",category:"Variations",component:ot},{id:"floated",label:"Floated",category:"Variations",component:it},{id:"colored",label:"Colored",category:"Variations",component:ut},{id:"compact",label:"Compact",category:"Variations",component:lt},{id:"toggle",label:"Toggle",category:"Variations",component:st},{id:"positive",label:"Positive",category:"Variations",component:pt},{id:"negative",label:"Negative",category:"Variations",component:mt},{id:"fluid",label:"Fluid",category:"Variations",component:St},{id:"circular",label:"Circular",category:"Variations",component:ft},{id:"vertically-attached",label:"Vertically Attached",category:"Variations",component:ht},{id:"horizontally-attached",label:"Horizontally Attached",category:"Variations",component:xt},{id:"vertical-buttons",label:"Vertical Buttons",category:"Group Variations",component:kt},{id:"stackable-buttons",label:"Stackable Buttons",category:"Group Variations",component:Gt},{id:"labeled-icon-buttons",label:"Labeled Icon Buttons",category:"Group Variations",component:At},{id:"mixed-group",label:"Mixed Group",category:"Group Variations",component:Ct},{id:"equal-width",label:"Equal Width",category:"Group Variations",component:Lt},{id:"colored-buttons",label:"Colored Buttons",category:"Group Variations",component:zt},{id:"basic-buttons",label:"Basic Buttons",category:"Group Variations",component:Ot},{id:"group-sizes",label:"Group Sizes",category:"Group Variations",component:qt}];return(u,S)=>(c(),l(v,{title:"Button",description:"A button indicates a possible user action","component-docs":a}))}};export{Rt as default};
