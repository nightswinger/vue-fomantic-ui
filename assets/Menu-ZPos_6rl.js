import{g as u,r as _,o as c,c as m,w as e,a as o,b as t,u as n,z as r,W as i,$ as g,x as b,f as y,a1 as k,a9 as A,aa as h,ab as v,j as x,d as I,ac as w,ad as $,ae as f,af as D,J as L,D as C}from"./index-DnKco_xq.js";import{_ as p}from"./DocSection-cZg6Pyvx.js";const T=`<template>
  <Menu
    :items="items"
    :widths="items.length"
...
const items = ref(['Home', 'Messages', 'Friends'])
<\/script>`,j=u({__name:"PointingDoc",setup(l){const a=_(["Home","Messages","Friends"]);return(s,d)=>(c(),m(p,{label:"Pointing",code:F},{description:e(()=>[o(" A menu can point to show its relationship to nearby content ")]),example:e(()=>[t(n(r),{pointing:"",items:a.value},{right:e(()=>[t(n(i),{as:"div"},{default:e(()=>[t(n(g),{icon:"search",placeholder:"Search..."})]),_:1})]),_:1},8,["items"]),t(n(b),null,{default:e(()=>[R]),_:1}),t(n(r),{secondary:"",pointing:"",items:a.value},{right:e(()=>[t(n(i),null,{default:e(()=>[o(" Logout ")]),_:1})]),_:1},8,["items"]),t(n(b),null,{default:e(()=>[z]),_:1})]),_:1}))}}),E=`<template>
  <Menu
    tabular
    :items="['Bio', 'Photos']"
  />
</template>`,P=u({__name:"TabularDoc",setup(l){return(a,s)=>(c(),m(p,{label:"Tabular",code:E},{description:e(()=>[o(" A menu can be formatted to show tabs of information ")]),example:e(()=>[t(n(r),{tabular:"",items:["Bio","Photos"]})]),_:1}))}}),N=`<template>
...
<\/script>`,G=u({__name:"TextDoc",setup(l){const a=_([{text:"SORT BY",header:!0},{text:"Closest"},{text:"Most Comments"},{text:"Most Popular"}]);return(s,d)=>(c(),m(p,{label:"Text",code:N},{description:e(()=>[o(" A menu can be formatted for text content ")]),example:e(()=>[t(n(r),{text:"",items:a.value},null,8,["items"])]),_:1}))}}),U=`<template>
...
<\/script>`,q=u({__name:"HeaderDoc",setup(l){const a=_([{text:"Our Company",header:!0},{text:"About Us"},{text:"Jobs"},{text:"Locations"}]);return(s,d)=>(c(),m(p,{label:"Header",code:Y},{description:e(()=>[o(" A menu item may include a header or may itself be a header ")]),example:e(()=>[t(n(r),{items:a.value},null,8,["items"])]),_:1}))}}),X=`<template>
  <Menu>
    <MenuItem as="div">
      <Input icon="search" placeholder="Search..." />
    </MenuItem>
...
</template>`,K=u({__name:"InputDoc",setup(l){return(a,s)=>(c(),m(p,{label:"Input",code:X},{description:e(()=>[o(" A menu item can contain an input inside of it ")]),example:e(()=>[t(n(r),null,{right:e(()=>[t(n(i),{as:"div"},{default:e(()=>[t(n(g),{placeholder:"Navigate to...",action:"Go"})]),_:1})]),default:e(()=>[t(n(i),{as:"div"},{default:e(()=>[t(n(g),{icon:"search",placeholder:"Search..."})]),_:1})]),_:1})]),_:1}))}}),Q=`<template>
  <Menu>
    <MenuItem as="div">
...
</template>`,re=u({__name:"SubMenuDoc",setup(l){return(a,s)=>(c(),m(p,{label:"Sub Menu",code:se},{description:e(()=>[o(" A menu item may contain another menu nested inside that acts as a grouped sub-menu. ")]),example:e(()=>[t(n(r),{vertical:""},{default:e(()=>[t(n(i),{as:"div"},{default:e(()=>[t(n(g),{placeholder:"Search..."})]),_:1}),t(n(i),{as:"div"},{default:e(()=>[o(" Home "),t(n(D),null,{default:e(()=>[t(n(i),null,{default:e(()=>[o("Search")]),_:1}),t(n(i),null,{default:e(()=>[o("Add")]),_:1}),t(n(i),null,{default:e(()=>[o("Remove")]),_:1})]),_:1})]),_:1}),t(n(i),null,{default:e(()=>[t(n(L),{name:"grid layout"}),o(" Browse ")]),_:1}),t(n(i),null,{default:e(()=>[o("Messages")]),_:1}),t(n(w),{item:"",text:"More"},{default:e(()=>[t(n($),null,{default:e(()=>[t(n(f),{icon:"edit",text:"Edit Profile"}),t(n(f),{icon:"globe",text:"Choose Language"}),t(n(f),{icon:"settings",text:"Account Settings"})]),_:1})]),_:1})]),_:1})]),_:1}))}}),ce=`<template>
  <Menu compact>
...
<\/script>`,$e=u({__name:"FluidDoc",setup(l){const a=_(["Run","Walk","Bike"]);return(s,d)=>(c(),m(p,{label:"Fluid",code:we},{description:e(()=>[o(" A vertical menu may take the size of its container ")]),example:e(()=>[t(n(r),{fluid:"",vertical:"",items:a.value},null,8,["items"])]),_:1}))}}),De=`<template>
...
<\/script>`,Ae=u({__name:"EvenlyDividedDoc",setup(l){const a=_(["Buy","Sell","Rent"]);return(s,d)=>(c(),m(p,{label:"Evenly Divided",code:ke},{description:e(()=>[o(" A menu may divide its items evenly ")]),example:e(()=>[t(n(r),{widths:3,items:a.value},null,8,["items"])]),_:1}))}}),Le=`<template>
...
</template>`,Be=u({__name:"SizeDoc",setup(l){return(a,s)=>(c(),m(p,{label:"Size",code:Te},{description:e(()=>[o(" A menu can vary in size ")]),example:e(()=>[t(n(r),{size:"mini"},{default:e(()=>[t(n(i),{active:""},{default:e(()=>[o("Home")]),_:1}),t(n(i),null,{default:e(()=>[o("Messages")]),_:1}),t(n(D),{position:"right"},{default:e(()=>[t(n(w),{item:"",text:"Language"},{default:e(()=>[t(n($),null,{default:e(()=>[t(n(f),{text:"English"}),t(n(f),{text:"Russian"}),t(n(f),{text:"Spanish"})]),_:1})]),_:1}),t(n(i),{as:"div"},{default:e(()=>[t(n(I),{color:"primary"},{default:e(()=>[o("Sign up")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}))}}),Ve=`<template>
  <Menu>
...
</template>`,ze=u({__name:"BorderlessDoc",setup(l){return(a,s)=>(c(),m(p,{label:"Borderless",code:Re},{description:e(()=>[o(" A menu item or menu can have no borders ")]),example:e(()=>[t(n(r),{borderless:"",items:["1","2","3","4","5","6"]})]),_:1}))}}),Ee={__name:"Menu",setup(l){const a=[{id:"menu",label:"Menu",category:"Types",component:B},{id:"secondary-menu",label:"Secondary Menu",category:"Types",component:H},{id:"pointing",label:"Pointing",category:"Types",component:j},{id:"tabular",label:"Tabular",category:"Types",component:P},{id:"text",label:"Text",category:"Types",component:G},{id:"vertical-menu",label:"Vertical Menu",category:"Types",component:O},{id:"pagination",label:"Pagination",category:"Types",component:W},{id:"header",label:"Header",category:"Content",component:q},{id:"input",label:"Input",category:"Content",component:K},{id:"button",label:"Button",category:"Content",component:Z},{id:"link-item",label:"Link Item",category:"Content",component:te},{id:"dropdown-item",label:"Dropdown Item",category:"Content",component:oe},{id:"right-menu",label:"Right Menu",category:"Content",component:ie},{id:"sub-menu",label:"Sub Menu",category:"Content",component:re},{id:"hover",label:"Hover",category:"States",component:me},{id:"active",label:"Active",category:"States",component:ue},{id:"stackable",label:"Stackable",category:"Variations",component:fe},{id:"inverted",label:"Inverted",category:"Variations",component:ge},{id:"colored",label:"Colored",category:"Variations",component:ve},{id:"icons",label:"Icons",category:"Variations",component:be},{id:"labeled-icon",label:"Labeled Icon",category:"Variations",component:ye},{id:"fluid",label:"Fluid",category:"Variations",component:$e},{id:"compact",label:"Compact",category:"Variations",component:Se},{id:"evenly-divided",label:"Evenly Divided",category:"Variations",component:Ae},{id:"attached",label:"Attached",category:"Variations",component:Ce},{id:"size",label:"Size",category:"Variations",component:Be},{id:"fitted",label:"Fitted",category:"Variations",component:He},{id:"borderless",label:"Borderless",category:"Variations",component:ze}];return(s,d)=>(c(),m(C,{title:"Menu",description:"A menu displays grouped navigation actions","component-docs":a}))}};export{Ee as default};
