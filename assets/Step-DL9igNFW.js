import{o as s,c as a,w as e,a as p,b as t,u as i,$ as c,a0 as _,e as u,r,R as g,f as S,j as v,d as h,D as b}from"./index-BPzz6yRK.js";import{_ as d}from"./DocSection-CUzZAhfI.js";import{_ as y}from"./paragraph-acT4RHv3.js";const C=`<template>
  <StepGroup>
    <Step>Shopping</Step>
  </StepGroup>
...
</template>`,U=u({__name:"DisabledDoc",setup(l){return(o,n)=>(s(),a(d,{label:"Disabled",code:N},{description:e(()=>[p(" A step can show that it cannot be selected ")]),example:e(()=>[t(i(c),null,{default:e(()=>[t(i(_),{disabled:""},{default:e(()=>[p(" Billing ")]),_:1})]),_:1})]),_:1}))}}),j=`<template>
  <StepGroup
    stackable="tablet"
    noCompleted
    :steps="steps"
...
const active = ref(1)
<\/script>`,R=u({__name:"StackableDoc",setup(l){const o=r([{title:"Shipping",description:"Choose your shipping options",icon:"plane"},{title:"Billing",description:"Enter billing information",icon:"payment"},{title:"Confirm Order",description:"Verify order details",icon:"info"}]),n=r(1);return(m,f)=>(s(),a(d,{label:"Stackable",code:j},{description:e(()=>[p(" A step can stack vertically only on smaller screens ")]),example:e(()=>[t(i(c),{stackable:"tablet",noCompleted:"",steps:o.value,activeStep:n.value},null,8,["steps","activeStep"])]),_:1}))}}),q=`<template>
  <Grid :columns="2">
    <GridColumn>
      <StepGroup
        fluid
...
const active = ref(1)
<\/script>`,K=u({__name:"UnstackableDoc",setup(l){const o=r([{title:"Shipping",description:"Choose your shipping options",icon:"truck"},{title:"Billing",description:"Enter billing information",icon:"dollar"},{title:"Confirm Order",description:"Verify order details",icon:"info circle"}]),n=r(1);return(m,f)=>(s(),a(d,{label:"Unstackable",code:J},{description:e(()=>[p(" A step can prevent itself from stacking on mobile ")]),example:e(()=>[t(i(c),{unstackable:"",steps:o.value,activeStep:n.value,"no-completed":""},null,8,["steps","activeStep"])]),_:1}))}}),L=h("img",{src:y},null,-1),M=`<template>
  <StepGroup
    attached="top"
    :steps="steps"
    :activeStep="active"
...
const active = ref(1)
<\/script>`,W=u({__name:"SizeDoc",setup(l){const o=r([{title:"Shipping",description:"Choose your shipping options",icon:"truck"},{title:"Billing",description:"Enter billing information",icon:"payment"},{title:"Confirm Order",description:"Verify order details",icon:"info"}]),n=r(1);return(m,f)=>(s(),a(d,{label:"Size",code:Q},{description:e(()=>[p(" Steps can have different sizes ")]),example:e(()=>[t(i(c),{size:"mini",steps:o.value,activeStep:n.value},null,8,["steps","activeStep"])]),_:1}))}}),X=`<template>
  <StepGroup
    :steps="steps"
    :activeStep="active"
    no-completed
...
const active = ref(1)
<\/script>`,Y=u({__name:"InvertedDoc",setup(l){const o=r([{title:"Shipping",description:"Choose your shipping options",icon:"truck"},{title:"Billing",description:"Enter billing information",icon:"payment"},{title:"Confirm Order",icon:"info"}]),n=r(1);return(m,f)=>(s(),a(d,{label:"Inverted",code:X},{description:e(()=>[p(" A step's color can be inverted ")]),example:e(()=>[t(i(v),{inverted:""},{default:e(()=>[t(i(c),{inverted:"",steps:o.value,activeStep:n.value,"no-completed":""},null,8,["steps","activeStep"])]),_:1})]),_:1}))}}),ie={__name:"Step",setup(l){const o=[{id:"step",label:"Step",category:"Types",component:G},{id:"steps",label:"Steps",category:"Groups",component:x},{id:"ordered",label:"Ordered",category:"Groups",component:B},{id:"vertical",label:"Vertical",category:"Groups",component:D},{id:"description",label:"Description",category:"Content",component:A},{id:"icon",label:"Icon",category:"Content",component:w},{id:"active",label:"Active",category:"States",component:I},{id:"completed",label:"Completed",category:"States",component:F},{id:"disabled",label:"Disabled",category:"States",component:U},{id:"stackable",label:"Stackable",category:"Variations",component:R},{id:"fluid",label:"Fluid",category:"Variations",component:H},{id:"unstackable",label:"Unstackable",category:"Variations",component:K},{id:"attached",label:"Attached",category:"Variations",component:P},{id:"size",label:"Size",category:"Variations",component:W},{id:"inverted",label:"Inverted",category:"Variations",component:Y}];return(n,m)=>(s(),a(b,{title:"Step",description:"A step shows the completion status of an activity in a series of activities","component-docs":o}))}};export{ie as default};
