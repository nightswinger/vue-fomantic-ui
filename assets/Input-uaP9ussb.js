import{o,c as r,w as e,a as s,b as a,u as c,m as t,B as u,f as h}from"./index-Bk7GY-tj.js";import{_ as p}from"./DocSection-D3vdzv11.js";const _=`<template>
...
</template>`,A={__name:"IconDoc",setup(i){return(n,l)=>(o(),r(p,{label:"Icon",code:z},{description:e(()=>[s(" An input can be formatted with an icon ")]),example:e(()=>[a(c(t),{icon:"search",placeholder:"Search..."}),a(c(t),{icon:"users",iconPosition:"left",placeholder:"Search..."})]),_:1}))}},D=`<template>
  <SuiInput label="http://" placeholder="mysite.com" />
</template>`,v={__name:"LabeledDoc",setup(i){return(n,l)=>(o(),r(p,{label:"Labeled",code:D},{description:e(()=>[s(" An input can be formatted with a label ")]),example:e(()=>[a(c(t),{label:"http://",placeholder:"mysite.com"})]),_:1}))}},w=`<template>
...
</template>`,B={__name:"FluidDoc",setup(i){return(n,l)=>(o(),r(p,{label:"Fluid",code:P},{description:e(()=>[s(" An input can take the size of its container ")]),example:e(()=>[a(c(t),{fluid:"",icon:"search",placeholder:"Search..."})]),_:1}))}},C=`<template>
...
</template>`,E={__name:"SizeDoc",setup(i){return(n,l)=>(o(),r(p,{label:"Size",code:C},{description:e(()=>[s(" An input can vary in size ")]),example:e(()=>[a(c(t),{icon:"search",placeholder:"Search mini...",size:"mini"}),a(c(t),{icon:"search",placeholder:"Search small...",size:"small"}),a(c(t),{icon:"search",placeholder:"Search large...",size:"large"}),a(c(t),{icon:"search",placeholder:"Search big...",size:"big"}),a(c(t),{icon:"search",placeholder:"Search huge...",size:"huge"}),a(c(t),{icon:"search",placeholder:"Search massive...",size:"massive"})]),_:1}))}},q={__name:"Input",setup(i){const n=[{id:"input",label:"Input",category:"Types",component:m},{id:"focus",label:"Focus",category:"States",component:b},{id:"loading",label:"Loading",category:"States",component:g},{id:"disabled",label:"Disabled",category:"States",component:x},{id:"error",label:"Error",category:"States",component:y},{id:"icon",label:"Icon",category:"Variations",component:A},{id:"labeled",label:"Labeled",category:"Variations",component:v},{id:"action",label:"Action",category:"Variations",component:V},{id:"transparent",label:"Transparent",category:"Variations",component:F},{id:"inverted",label:"Inverted",category:"Variations",component:T},{id:"fluid",label:"Fluid",category:"Variations",component:B},{id:"size",label:"Size",category:"Variations",component:E}];return(l,d)=>(o(),r(h,{title:"Input",description:"An input is a field used to elicit a response from a user","component-docs":n}))}};export{q as default};
