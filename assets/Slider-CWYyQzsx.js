import{g as u,r as d,o,c as n,w as a,a as i,b as v,u as s,aV as p,t as _,x as y,E as g,F as S,G as V,D as x}from"./index-DnKco_xq.js";import{_ as m}from"./DocSection-cZg6Pyvx.js";const k=`<template>
...
const value = ref(8)
<\/script>`,E=u({__name:"InvertedDoc",setup(c){const e=d(8);return(r,l)=>(o(),n(m,{label:"Inverted",code:W},{description:a(()=>[i(" A slider can be inverted ")]),example:a(()=>[v(s(y),{inverted:""},{default:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),inverted:""},null,8,["modelValue"])]),_:1})]),_:1}))}}),F=`<template>
...
const value = ref(5)
<\/script>`,N=u({__name:"VerticalDoc",setup(c){const e=d(5);return(r,l)=>(o(),n(m,{label:"Vertical",code:M},{description:a(()=>[i(" A slider can be vertical ")]),example:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),vertical:""},null,8,["modelValue"]),i(" Slider value: "+_(e.value),1)]),_:1}))}}),G=`<template>
  <Slider
