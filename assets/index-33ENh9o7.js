...
</template>`,iC={__name:"VerticalDividerDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Vertical Divider",code:tC},{description:i(()=>[n(" A divider can segment content vertically. ")]),example:i(()=>[t(u(N),{placeholder:""},{default:i(()=>[t(u(hl),{columns:"equal"},{default:i(()=>[t(u(Tt),null,{default:i(()=>[t(u(Nt),null,{default:i(()=>[t(u(lt),null,{default:i(()=>[Xw,Qw]),_:1}),t(u(lt),null,{default:i(()=>[Zw,eC]),_:1}),t(u(P),{primary:""},{default:i(()=>[n("Login")]),_:1})]),_:1})]),_:1}),t(u(Tt),{textAlign:"middle"},{default:i(()=>[t(u(P),{secondary:"",icon:"signup",content:"Sign Up"})]),_:1})]),_:1}),t(u(Ve),{vertical:""},{default:i(()=>[n("Or")]),_:1})]),_:1})]),_:1}))}},aC=`<template>
...
</template>`,_A={__name:"LoadingDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Loading",code:hA},{description:i(()=>[n(" An icon can be used as a simple loader ")]),example:i(()=>[t(u(X),{name:"spinner",loading:""}),t(u(X),{name:"notched circle",loading:""}),t(u(X),{name:"asterisk",loading:""})]),_:1}))}},bA=v("br",null,null,-1),vA=`<template>
  <div>
    This icon
...
</template>`,SA={__name:"FittedDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Fitted",code:vA},{description:i(()=>[n(" An icon can be fitted, without any space to the left or right of it. ")]),example:i(()=>[v("div",null,[n(" This icon "),t(u(X),{name:"help",fitted:""}),n(" is fitted. "),bA,n(" This icon "),t(u(X),{name:"help"}),n(" is not fitted. ")])]),_:1}))}},yA=`<template>
...
</template>`,ck={__name:"ImageDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Image",code:uk},{description:i(()=>[n(" A label can be formatted to emphasize an image ")]),example:i(()=>[t(u(O),{as:"a",image:""},{default:i(()=>[ok,n(" Joe ")]),_:1}),t(u(O),{as:"a",image:"",color:"blue"},{default:i(()=>[sk,n(" Veronika "),t(u(Da),null,{default:i(()=>[n("Friend")]),_:1})]),_:1}),t(u(O),{as:"a",image:""},{default:i(()=>[rk,n(" Elliot "),t(u(X),{name:"delete"})]),_:1})]),_:1}))}},dk=v("input",{type:"text",placeholder:"First Name"},null,-1),mk=v("input",{type:"text"},null,-1),pk=v("input",{type:"text",placeholder:"Username"},null,-1),fk=v("input",{type:"password"},null,-1),gk=`<template>
  <SuiForm fluid>
    <SuiFormField>
...
</template>`,Ik={__name:"FloatingDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Floating",code:Lk},{description:i(()=>[n(" A label can float above or below another element ")]),example:i(()=>[t(u(_d),{compact:""},{default:i(()=>[t(u(Bo),null,{default:i(()=>[t(u(X),{name:"mail"}),n(" Messages "),t(u(O),{floating:"",color:"red"},{default:i(()=>[n("22")]),_:1})]),_:1}),t(u(Bo),null,{default:i(()=>[t(u(X),{name:"users"}),n(" Friends "),t(u(O),{floating:"",color:"teal"},{default:i(()=>[n("22")]),_:1})]),_:1})]),_:1})]),_:1}))}},Ek=`<template>
  <SuiSegment inverted>
...
</template>`,oD={__name:"DividerDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Divider",code:nD},{description:i(()=>[n(" A breadcrumb can contain a divider to show the relationship between sections, this can be formatted as an icon or text. ")]),example:i(()=>[t(u(ni),null,{default:i(()=>[t(u(it),{link:""},{default:i(()=>[n("Home")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),{link:""},{default:i(()=>[n("Registration")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),{active:""},{default:i(()=>[n("Personal Information")]),_:1})]),_:1})]),_:1}))}},sD=`<template>
  <SuiBreadcrumb>
    <SuiBreadcrumbSection link>Home</SuiBreadcrumbSection>
    <SuiBreadcrumbDivider> / </SuiBreadcrumbDivider>
    <SuiBreadcrumbSection active>Search</SuiBreadcrumbSection>
  </SuiBreadcrumb>
</template>`,rD={__name:"SectionDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Section",code:sD},{description:i(()=>[n(" A breadcrumb can contain sections that can either be formatted as a link or text ")]),example:i(()=>[t(u(ni),null,{default:i(()=>[t(u(it),{link:""},{default:i(()=>[n("Home")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),{active:""},{default:i(()=>[n("Search")]),_:1})]),_:1})]),_:1}))}},uD=v("a",{href:"#"},"paper towels",-1),cD=`<template>
  <SuiBreadcrumb>
    <SuiBreadcrumbSection link>Home</SuiBreadcrumbSection>
    <SuiBreadcrumbDivider> / </SuiBreadcrumbDivider>
    <SuiBreadcrumbSection active>Search for: <a href="#">paper towels</a></SuiBreadcrumbSection>
  </SuiBreadcrumb>
</template>`,dD={__name:"LinkDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Link",code:cD},{description:i(()=>[n(" A section may be linkable or contain a link ")]),example:i(()=>[t(u(ni),null,{default:i(()=>[t(u(it),{link:""},{default:i(()=>[n("Home")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),{active:""},{default:i(()=>[n("Search for: "),uD]),_:1})]),_:1})]),_:1}))}},mD=`<template>
  <SuiBreadcrumb>
    <SuiBreadcrumbSection link>Products</SuiBreadcrumbSection>
    <SuiBreadcrumbDivider> / </SuiBreadcrumbDivider>
    <SuiBreadcrumbSection active>Paper Towels</SuiBreadcrumbSection>
  </SuiBreadcrumb>
</template>`,pD={__name:"ActiveDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Active",code:mD},{description:i(()=>[n(" A section can be active ")]),example:i(()=>[t(u(ni),null,{default:i(()=>[t(u(it),{link:""},{default:i(()=>[n("Products")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),{active:""},{default:i(()=>[n("Paper Towels")]),_:1})]),_:1})]),_:1}))}},fD=v("br",null,null,-1),gD=`<template>
  <SuiSegment inverted>
...
</template>`,hD={__name:"InvertedDoc",setup(e){return(a,l)=>(k(),B(I,{label:"Inverted",code:gD},{description:i(()=>[n(" A breadcrumb can be inverted ")]),example:i(()=>[t(u(N),{inverted:""},{default:i(()=>[t(u(ni),{inverted:""},{default:i(()=>[t(u(it),{link:""},{default:i(()=>[n("Home")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),{link:""},{default:i(()=>[n("Registration")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),{active:""},{default:i(()=>[n("Personal Information")]),_:1})]),_:1}),fD,t(u(ni),{inverted:""},{default:i(()=>[t(u(it),null,{default:i(()=>[n("Home")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),null,{default:i(()=>[n("Registration")]),_:1}),t(u(Lt),null,{default:i(()=>[n(" / ")]),_:1}),t(u(it),{active:""},{default:i(()=>[n("Personal Information")]),_:1})]),_:1})]),_:1})]),_:1}))}},_D=`<template>
...
</sui-segment>`,$=G(3),D='<sui-slider reversed v-model="slider9" />',_=G(18),S='<sui-slider vertical v-model="slider10" :max="20" />',x=G(5),T=G(5),E=G(5),V=G(5),M=G(5),F=G(5),j=G(5),Q=G(5),Y=G(5),ge=G(5),Be=G(5),U=G(5),K=G(5),me=`<sui-slider color="red" v-model="redSlider" />
