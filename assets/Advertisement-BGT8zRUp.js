import{o as s,c as o,w as a,a as d,b as e,u as t,aj as n,f as p,ak as u,F as l,D as _}from"./index-CGimrHOv.js";import{_ as m}from"./DocSection-IMxQEgJe.js";const b=p("img",{src:u},null,-1),g=`<template>
...
</template>`,V=l({__name:"NetboardDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Netboard",code:N},{description:a(()=>[d(" An ad can use netboard ad unit size ")]),example:a(()=>[e(t(n),{unit:"netboard",test:"Netboard"})]),_:1}))}}),P=`<template>
  <Advertisement centered unit="banner" test="Centered" />
</template>`,w=l({__name:"CenteredDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Centered",code:P},{description:a(()=>[d(" An advertisement can appear centered ")]),example:a(()=>[e(t(n),{centered:"",unit:"banner",test:"Centered"})]),_:1}))}}),q=`<template>
  <Advertisement centered unit="banner" test="Centered" />
</template>`,H=l({__name:"TestDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Test",code:q},{description:a(()=>[d(" A advertisement can be formatted to help verify placement ")]),example:a(()=>[e(t(n),{unit:"medium rectangle",test:"Ad Unit 1"})]),_:1}))}}),F={__name:"Advertisement",setup(c){const r=[{id:"ad",label:"Ad",category:"Types",component:A},{id:"common-units",label:"Common Units",category:"Types",component:v},{id:"mobile",label:"Mobile",category:"Types",component:B},{id:"rectangle",label:"Rectangle",category:"Types",component:$},{id:"button",label:"Button",category:"Types",component:k},{id:"skyscraper",label:"Skyscraper",category:"Types",component:L},{id:"banner",label:"Banner",category:"Types",component:C},{id:"leaderboards",label:"Leaderboards",category:"Types",component:S},{id:"panorama",label:"Panorama",category:"Types",component:R},{id:"netboard",label:"Netboard",category:"Types",component:V},{id:"centered",label:"Centered",category:"Variations",component:w},{id:"test",label:"Test",category:"Variations",component:H}];return(i,U)=>(s(),o(_,{title:"Advertisement",description:"An ad displays third-party promotional content","component-docs":r}))}};export{F as default};
