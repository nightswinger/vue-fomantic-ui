import{o as s,c as l,w as i,a as t,b as e,u as a,q as n,h as d,d as u,j as _,D as p}from"./index-DnKco_xq.js";import{_ as r}from"./DocSection-cZg6Pyvx.js";const g=`<template>
  <SuiEmoji name="anguished" disabled />
</template>`,x={__name:"DisabledDoc",setup(m){return(o,c)=>(s(),l(r,{label:"Disabled",code:g},{description:i(()=>[t(" An emoji can show that it is disabled ")]),example:i(()=>[e(a(n),{name:"anguished",disabled:""})]),_:1}))}},b=`<template>
  <SuiEmoji name="angel" loading />
  <SuiEmoji name="blush" loading />
  <SuiEmoji name="grin" loading />
</template>`,z={__name:"LoadingDoc",setup(m){return(o,c)=>(s(),l(r,{label:"Loading",code:b},{description:i(()=>[t(" An emoji can be used as a simple loader ")]),example:i(()=>[e(a(n),{name:"angel",loading:""}),e(a(n),{name:"blush",loading:""}),e(a(n),{name:"grin",loading:""})]),_:1}))}},h=`<template>
...
</template>`,D={__name:"LinkDoc",setup(m){return(o,c)=>(s(),l(r,{label:"Link",code:E},{description:i(()=>[t(" An emoji can be formatted as a link ")]),example:i(()=>[e(a(n),{link:"",name:"slight_smile",size:"medium"})]),_:1}))}},y={__name:"Emoji",setup(m){const o=[{id:"disabled",label:"Disabled",category:"States",component:x},{id:"loading",label:"Loading",category:"States",component:z},{id:"size",label:"Size",category:"Variations",component:S},{id:"autosizing",label:"Autosizing",category:"Variations",component:f},{id:"link",label:"Link",category:"Variations",component:D}];return(c,L)=>(s(),l(p,{title:"Emoji",description:"An emoji is a glyph used to represent an emotional state","component-docs":o}))}};export{y as default};
