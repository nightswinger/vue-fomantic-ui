import{o as l,c as s,w as i,a as t,b as e,u as a,x as c,L as d,Q as r,V as n,D as g}from"./index-CGimrHOv.js";import{_ as p}from"./DocSection-IMxQEgJe.js";const _=`<template>
  <SuiSegment>
    <SuiDimmer active>
      <SuiLoader />
    </SuiDimmer>
  ...
  <SuiLoader active inline />
</template>`,z={__name:"InlineCenterDoc",setup(m){return(o,u)=>(l(),s(p,{label:"Inline Center",code:$},{description:i(()=>[t(" Loaders can appear inline centered with content ")]),example:i(()=>[e(a(r),{active:"",inline:"centered"})]),_:1}))}},V=`<template>
  <SuiLoader slow active inline />
  <SuiLoader active inline />
  <SuiLoader fast active inline />
</template>`,A={__name:"SpeedDoc",setup(m){return(o,u)=>(l(),s(p,{label:"Speed",code:V},{description:i(()=>[t(" Loaders can appear slow, normal or fast ")]),example:i(()=>[e(a(r),{slow:"",active:"",inline:""}),e(a(r),{active:"",inline:""}),e(a(r),{fast:"",active:"",inline:""})]),_:1}))}},k=`<template>
...
</template>`,C={__name:"ColorsDoc",setup(m){return(o,u)=>(l(),s(p,{label:"Colors",code:k},{description:i(()=>[t(" Loaders can be different colors ")]),example:i(()=>[e(a(r),{active:"",inline:"",primary:""}),e(a(r),{active:"",inline:"",secondary:""}),e(a(r),{active:"",inline:"",color:"red"}),e(a(r),{active:"",inline:"",color:"orange"}),e(a(r),{active:"",inline:"",color:"yellow"}),e(a(r),{active:"",inline:"",color:"olive"}),e(a(r),{active:"",inline:"",color:"green"}),e(a(r),{active:"",inline:"",color:"teal"}),e(a(r),{active:"",inline:"",color:"blue"}),e(a(r),{active:"",inline:"",color:"violet"}),e(a(r),{active:"",inline:"",color:"purple"}),e(a(r),{active:"",inline:"",color:"pink"}),e(a(r),{active:"",inline:"",color:"brown"}),e(a(r),{active:"",inline:"",color:"grey"}),e(a(r),{active:"",inline:"",color:"black"})]),_:1}))}},T=`<template>
  <SuiSegment>
    <SuiDimmer active>
