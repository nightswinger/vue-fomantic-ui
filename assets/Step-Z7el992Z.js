import{o as s,c as a,w as e,a as p,b as t,u as i,P as r,Q as _,R as u,r as c,i as g,j as S,y as v,d as h,S as b,f as y}from"./index-DXf-rKoW.js";import{_ as d}from"./DocSection-C2fGI9ub.js";const C=`<template>
  <StepGroup>
    <Step>Shopping</Step>
  </StepGroup>
...
</template>`,U=u({__name:"DisabledDoc",setup(l){return(o,n)=>(s(),a(d,{label:"Disabled",code:F},{description:e(()=>[p(" A step can show that it cannot be selected ")]),example:e(()=>[t(i(r),null,{default:e(()=>[t(i(_),{disabled:""},{default:e(()=>[p(" Billing ")]),_:1})]),_:1})]),_:1}))}}),j=`<template>
  <StepGroup
    stackable="tablet"
    noCompleted
    :steps="steps"
...
const active = ref(1)
<\/script>`,P=u({__name:"FluidDoc",setup(l){const o=c([{title:"Shipping",description:"Choose your shipping options",icon:"plane"},{title:"Billing",description:"Enter billing information",icon:"dollar"}]),n=c(1);return(m,f)=>(s(),a(d,{label:"Fluid",code:L},{description:e(()=>[p(" A fluid step takes up the width of its container ")]),example:e(()=>[t(i(g),{columns:2},{default:e(()=>[t(i(S),null,{default:e(()=>[t(i(r),{fluid:"",vertical:"",steps:o.value,activeStep:n.value},null,8,["steps","activeStep"])]),_:1}),t(i(S),null,{default:e(()=>[p(" The steps take up the entire column width ")]),_:1})]),_:1})]),_:1}))}}),Q=`<template>
  <StepGroup
    unstackable
    :steps="steps"
    :activeStep="active"
...
const active = ref(1)
<\/script>`,R=u({__name:"UnstackableDoc",setup(l){const o=c([{title:"Shipping",description:"Choose your shipping options",icon:"truck"},{title:"Billing",description:"Enter billing information",icon:"dollar"},{title:"Confirm Order",description:"Verify order details",icon:"info circle"}]),n=c(1);return(m,f)=>(s(),a(d,{label:"Unstackable",code:Q},{description:e(()=>[p(" A step can prevent itself from stacking on mobile ")]),example:e(()=>[t(i(r),{unstackable:"",steps:o.value,activeStep:n.value,"no-completed":""},null,8,["steps","activeStep"])]),_:1}))}}),H=h("img",{src:b},null,-1),J=`<template>
  <StepGroup
    attached="top"
    :steps="steps"
    :activeStep="active"
...
const active = ref(1)
<\/script>`,K=u({__name:"AttachedDoc",setup(l){const o=c([{title:"Shipping",description:"Choose your shipping options",icon:"truck"},{title:"Billing",description:"Enter billing information",icon:"payment"},{title:"Confirm Order",description:"Verify order details",icon:"info"}]),n=c(1);return(m,f)=>(s(),a(d,{label:"Attached",code:J},{description:e(()=>[p(" Steps can be attached to other elements ")]),example:e(()=>[t(i(r),{attached:"top",steps:o.value,activeStep:n.value},null,8,["steps","activeStep"]),t(i(v),{attached:""},{default:e(()=>[H]),_:1}),t(i(r),{attached:"bottom",steps:o.value,activeStep:n.value},null,8,["steps","activeStep"])]),_:1}))}}),M=`<template>
  <StepGroup
    size="mini"
    :steps="steps"
    :activeStep="active"
...
const active = ref(1)
<\/script>`,Y=u({__name:"InvertedDoc",setup(l){const o=c([{title:"Shipping",description:"Choose your shipping options",icon:"truck"},{title:"Billing",description:"Enter billing information",icon:"payment"},{title:"Confirm Order",icon:"info"}]),n=c(1);return(m,f)=>(s(),a(d,{label:"Inverted",code:X},{description:e(()=>[p(" A step's color can be inverted ")]),example:e(()=>[t(i(v),{inverted:""},{default:e(()=>[t(i(r),{inverted:"",steps:o.value,activeStep:n.value,"no-completed":""},null,8,["steps","activeStep"])]),_:1})]),_:1}))}}),te={__name:"Step",setup(l){const o=[{id:"step",label:"Step",category:"Types",component:G},{id:"steps",label:"Steps",category:"Groups",component:x},{id:"ordered",label:"Ordered",category:"Groups",component:B},{id:"vertical",label:"Vertical",category:"Groups",component:D},{id:"description",label:"Description",category:"Content",component:A},{id:"icon",label:"Icon",category:"Content",component:w},{id:"active",label:"Active",category:"States",component:I},{id:"completed",label:"Completed",category:"States",component:T},{id:"disabled",label:"Disabled",category:"States",component:U},{id:"stackable",label:"Stackable",category:"Variations",component:q},{id:"fluid",label:"Fluid",category:"Variations",component:P},{id:"unstackable",label:"Unstackable",category:"Variations",component:R},{id:"attached",label:"Attached",category:"Variations",component:K},{id:"size",label:"Size",category:"Variations",component:W},{id:"inverted",label:"Inverted",category:"Variations",component:Y}];return(n,m)=>(s(),a(y,{title:"Step",description:"A step shows the completion status of an activity in a series of activities","component-docs":o}))}};export{te as default};
