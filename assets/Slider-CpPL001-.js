import{e as u,r as d,o,c as n,w as a,a as i,b as v,u as s,aU as p,t as _,L as V,p as g,F as S,s as y,D as x}from"./index-B2sz39O7.js";import{_ as m}from"./DocSection-LsN_yblw.js";const k=`<template>
...
const value = ref(8)
<\/script>`,W=u({__name:"InvertedDoc",setup(c){const e=d(8);return(r,l)=>(o(),n(m,{label:"Inverted",code:H},{description:a(()=>[i(" A slider can be inverted ")]),example:a(()=>[v(s(V),{inverted:""},{default:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),inverted:""},null,8,["modelValue"])]),_:1})]),_:1}))}}),F=`<template>
