import{R as n,o as s,c as u,w as a,a as i,b as e,u as t,ay as l,az as m,aA as p,aB as b,e as _,n as S,d as v,y as f,f as h}from"./index-DXf-rKoW.js";import{_ as d}from"./DocSection-C2fGI9ub.js";const g=`<template>
...
</template>`,E=n({__name:"FloatedDoc",setup(r){return(o,c)=>(s(),u(d,{label:"Floated",code:Q},{description:a(()=>[i(" An statistic can sit to the left or right of other content ")]),example:a(()=>[e(t(f),null,{default:a(()=>[e(t(l),{floated:"right",value:"2,204",label:"Views"}),C,P,e(t(l),{floated:"left",value:"2,204",label:"Views"}),j,O]),_:1})]),_:1}))}}),R=`<template>
