...
</template>`,C=i({__name:"ProgressDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Progress",code:w},{description:t(()=>[g(" A progress bar can contain a text value indicating current progress ")]),example:t(()=>[e(r(o),{progress:"",percent:43})]),_:1}))}}),S=`<template>
  <Progress progress="centered" :percent="57" />
</template>`,A=i({__name:"CenteredProgressTextDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Centered Progress Text",code:S},{description:t(()=>[g(" The text inside a progress can be centered ")]),example:t(()=>[e(r(o),{progress:"centered",percent:57})]),_:1}))}}),D=`<template>
...
</template>`,T=i({__name:"ActiveDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Active",code:z},{description:t(()=>[g(" A progress bar can show activity ")]),example:t(()=>[e(r(o),{active:"",progress:"",percent:12,label:"Uploading Files"})]),_:1}))}}),F=`<template>
  <Progress success progress :percent="100" label="Everything worked, your file is all ready." />
</template>`,I=i({__name:"SuccessDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Success",code:F},{description:t(()=>[g(" A progress bar can show a success state ")]),example:t(()=>[e(r(o),{success:"",progress:"",percent:100,label:"Everything worked, your file is all ready."})]),_:1}))}}),U=`<template>
