import{d as n,o as s,c as u,w as a,a as i,b as e,u as t,ab as l,ac as m,ad as p,_ as d,ae as b,k as _,v as S,f as v,y as f,l as h}from"./index-MO8VB4d8.js";const g=`<template>
...
</template>`,G=n({__name:"LabelDoc",setup(r){return(o,c)=>(s(),u(d,{label:"Label",code:z},{description:a(()=>[i(" A statistic can contain a label to help provide context for the presented value ")]),example:a(()=>[e(t(l),{value:"2,204",label:"Views"})]),_:1}))}}),$=`<template>
...
</template>`,E=n({__name:"FloatedDoc",setup(r){return(o,c)=>(s(),u(d,{label:"Floated",code:Q},{description:a(()=>[i(" An statistic can sit to the left or right of other content ")]),example:a(()=>[e(t(f),null,{default:a(()=>[e(t(l),{floated:"right",value:"2,204",label:"Views"}),C,P,e(t(l),{floated:"left",value:"2,204",label:"Views"}),j,O]),_:1})]),_:1}))}}),H=`<template>
