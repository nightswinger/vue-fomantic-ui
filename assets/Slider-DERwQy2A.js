import{F as u,r as d,o,c as n,w as a,a as i,b as v,u as s,aU as p,t as _,x as V,H as g,I as S,K as y,D as x}from"./index-CGimrHOv.js";import{_ as m}from"./DocSection-IMxQEgJe.js";const k=`<template>
...
const value = ref(5)
<\/script>`,E=u({__name:"VerticalDoc",setup(c){const e=d(5);return(r,l)=>(o(),n(m,{label:"Vertical",code:N},{description:a(()=>[i(" A slider can be vertical ")]),example:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),vertical:""},null,8,["modelValue"]),i(" Slider value: "+_(e.value),1)]),_:1}))}}),K=`<template>
  <Slider
