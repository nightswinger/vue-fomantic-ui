...
const items = ref(['Home', 'Messages', 'Friends'])
<\/script>`,z=u({__name:"PointingDoc",setup(m){const a=_(["Home","Messages","Friends"]);return(l,d)=>(r(),c(p,{label:"Pointing",code:F},{description:e(()=>[o(" A menu can point to show its relationship to nearby content ")]),example:e(()=>[t(n(s),{pointing:"",items:a.value},{right:e(()=>[t(n(i),{as:"div"},{default:e(()=>[t(n(h),{icon:"search",placeholder:"Search..."})]),_:1})]),_:1},8,["items"]),t(n(I),null,{default:e(()=>[H]),_:1}),t(n(s),{secondary:"",pointing:"",items:a.value},{right:e(()=>[t(n(i),null,{default:e(()=>[o(" Logout ")]),_:1})]),_:1},8,["items"]),t(n(I),null,{default:e(()=>[R]),_:1})]),_:1}))}}),E=`<template>
  <Menu
    tabular
    :items="['Bio', 'Photos']"
  />
</template>`,P=u({__name:"TabularDoc",setup(m){return(a,l)=>(r(),c(p,{label:"Tabular",code:E},{description:e(()=>[o(" A menu can be formatted to show tabs of information ")]),example:e(()=>[t(n(s),{tabular:"",items:["Bio","Photos"]})]),_:1}))}}),N=`<template>
...
<\/script>`,j=u({__name:"TextDoc",setup(m){const a=_([{text:"SORT BY",header:!0},{text:"Closest"},{text:"Most Comments"},{text:"Most Popular"}]);return(l,d)=>(r(),c(p,{label:"Text",code:N},{description:e(()=>[o(" A menu can be formatted for text content ")]),example:e(()=>[t(n(s),{text:"",items:a.value},null,8,["items"])]),_:1}))}}),G=`<template>
...
<\/script>`,Ae=u({__name:"EvenlyDividedDoc",setup(m){const a=_(["Buy","Sell","Rent"]);return(l,d)=>(r(),c(p,{label:"Evenly Divided",code:Se},{description:e(()=>[o(" A menu may divide its items evenly ")]),example:e(()=>[t(n(s),{widths:3,items:a.value},null,8,["items"])]),_:1}))}}),ke=`<template>
