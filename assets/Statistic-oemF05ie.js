import{f as n,o as s,c as u,w as a,a as i,b as e,u as t,p as l,H as m,X as p,_ as d,$ as b,q as _,t as S,d as v,n as f,D as h}from"./index---8QmbsE.js";const g=`<template>
...
</template>`,E=n({__name:"FloatedDoc",setup(r){return(o,c)=>(s(),u(d,{label:"Floated",code:Q},{description:a(()=>[i(" An statistic can sit to the left or right of other content ")]),example:a(()=>[e(t(f),null,{default:a(()=>[e(t(l),{floated:"right",value:"2,204",label:"Views"}),M,P,e(t(l),{floated:"left",value:"2,204",label:"Views"}),j,O]),_:1})]),_:1}))}}),H=`<template>
