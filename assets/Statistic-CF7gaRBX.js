import{F as n,o as s,c as u,w as a,a as i,b as e,u as t,az as l,aA as m,aB as p,aC as b,J as _,V as S,f as v,x as f,D as h}from"./index-BienhS53.js";import{_ as d}from"./DocSection-BCb0rW96.js";const g=`<template>
...
</template>`,E=n({__name:"FloatedDoc",setup(r){return(o,c)=>(s(),u(d,{label:"Floated",code:Q},{description:a(()=>[i(" An statistic can sit to the left or right of other content ")]),example:a(()=>[e(t(f),null,{default:a(()=>[e(t(l),{floated:"right",value:"2,204",label:"Views"}),M,P,e(t(l),{floated:"left",value:"2,204",label:"Views"}),O,j]),_:1})]),_:1}))}}),R=`<template>
