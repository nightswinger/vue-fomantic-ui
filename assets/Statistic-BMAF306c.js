import{O as n,o as s,c as u,w as a,a as i,b as e,u as t,az as l,aA as m,aB as p,aC as b,e as _,n as S,d as v,y as f,f as h}from"./index-DqtkPo3d.js";import{_ as d}from"./DocSection-hLonYMiG.js";const g=`<template>
...
</template>`,E=n({__name:"FloatedDoc",setup(r){return(o,c)=>(s(),u(d,{label:"Floated",code:Q},{description:a(()=>[i(" An statistic can sit to the left or right of other content ")]),example:a(()=>[e(t(f),null,{default:a(()=>[e(t(l),{floated:"right",value:"2,204",label:"Views"}),M,P,e(t(l),{floated:"left",value:"2,204",label:"Views"}),O,j]),_:1})]),_:1}))}}),H=`<template>
