import{o as n,c as d,w as e,a as t,b as r,u as i,a1 as o,a2 as a,a3 as c,e as B,Y as f,y as b,A as _,B as v,j as D,D as k}from"./index-DSC_QGPC.js";import{_ as s}from"./DocSection-Dy7AO88P.js";const h=`<template>
  <SuiBreadcrumb
    :sections="[
...
</template>`,y={__name:"DividerDoc",setup(l){return(u,m)=>(n(),d(s,{label:"Divider",code:x},{description:e(()=>[t(" A breadcrumb can contain a divider to show the relationship between sections, this can be formatted as an icon or text. ")]),example:e(()=>[r(i(o),null,{default:e(()=>[r(i(a),{link:""},{default:e(()=>[t("Home")]),_:1}),r(i(c),null,{default:e(()=>[t(" / ")]),_:1}),r(i(a),{link:""},{default:e(()=>[t("Registration")]),_:1}),r(i(c),null,{default:e(()=>[t(" / ")]),_:1}),r(i(a),{active:""},{default:e(()=>[t("Personal Information")]),_:1})]),_:1})]),_:1}))}},H=`<template>
  <SuiBreadcrumb>
    <SuiBreadcrumbSection link>Home</SuiBreadcrumbSection>
    <SuiBreadcrumbDivider> / </SuiBreadcrumbDivider>
    <SuiBreadcrumbSection active>Search</SuiBreadcrumbSection>
  </SuiBreadcrumb>
</template>`,$={__name:"SectionDoc",setup(l){return(u,m)=>(n(),d(s,{label:"Section",code:H},{description:e(()=>[t(" A breadcrumb can contain sections that can either be formatted as a link or text ")]),example:e(()=>[r(i(o),null,{default:e(()=>[r(i(a),{link:""},{default:e(()=>[t("Home")]),_:1}),r(i(c),null,{default:e(()=>[t(" / ")]),_:1}),r(i(a),{active:""},{default:e(()=>[t("Search")]),_:1})]),_:1})]),_:1}))}},A=B("a",{href:"#"},"paper towels",-1),P=`<template>
  <SuiBreadcrumb>
    <SuiBreadcrumbSection link>Home</SuiBreadcrumbSection>
    <SuiBreadcrumbDivider> / </SuiBreadcrumbDivider>
