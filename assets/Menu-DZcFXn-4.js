import{e as u,r as _,o as c,c as m,w as e,a as o,b as t,u as n,m as r,W as i,Y as g,L as b,d as y,a1 as k,a9 as A,aa as h,ab as v,X as x,C as I,ac as w,ad as $,ae as f,af as D,K as L,D as C}from"./index-BLRrc4sh.js";import{_ as p}from"./DocSection-Da03Tz-a.js";const T=`<template>
  <Menu
    :items="items"
    :widths="items.length"
...
<\/script>`,X=u({__name:"HeaderDoc",setup(l){const a=_([{text:"Our Company",header:!0},{text:"About Us"},{text:"Jobs"},{text:"Locations"}]);return(s,d)=>(c(),m(p,{label:"Header",code:W},{description:e(()=>[o(" A menu item may include a header or may itself be a header ")]),example:e(()=>[t(n(r),{items:a.value},null,8,["items"])]),_:1}))}}),q=`<template>
  <Menu>
    <MenuItem as="div">
      <Input icon="search" placeholder="Search..." />
    </MenuItem>
