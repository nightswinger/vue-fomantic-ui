import{aL as m,B as h,o as l,c as r,w as t,a,b as i,d as S,r as b,u as f,D as d,aa as _,e as w,f as k}from"./index-Bk7GY-tj.js";import{_ as p}from"./DocSection-D3vdzv11.js";const B=`<template>
...
<\/script>`,K={__name:"MessageStyleDoc",setup(u){const{toast:e}=m(),s=()=>{e({messageStyle:!0,message:"I got my style from the message class",color:"purple"})};return(o,c)=>{const n=h("SuiButton");return l(),r(p,{label:"Use Message Style",code:N},{description:t(()=>[a(" You can use all of the styles and colors from the message component. ")]),example:t(()=>[i(n,{onClick:s},{default:t(()=>[a("Show")]),_:1})]),_:1})}}},R=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
