...
<\/script>`,yS={__name:"ButtonDoc",setup(e){const a=G("Follow"),n=()=>a.value=a.value==="Follow"?"Following":"Follow";return(o,r)=>(T(),I(M,{label:"Button",code:vS},{description:i(()=>[l(" A standard button ")]),example:i(()=>[t(g(P),{onClick:n},{default:i(()=>[l(ke(a.value),1)]),_:1})]),_:1}))}},SS=`<template>
...
</div>`,a=G(!1),n=G(!1);return{modalCode:e,modal1:a,basicModal:n,basicCode:`<div>
...
<sui-popup :trigger="positionTrigger8" position="left center" content="I am positioned to the left center" />`,F=G(null),V=`<sui-button ref="flowingTrigger">Show Flowing Popup</sui-button>
...
</sui-popup>`,z=G(null),j=G(null),K=G(null),U=G(null),me=G(null),Te=`<sui-icon name="heart" circular link ref="sizeTrigger1" />
...
</sui-segment>`,k=G(3),B='<sui-slider reversed v-model="slider9" />',b=G(18),w='<sui-slider vertical v-model="slider10" :max="20" />',x=G(5),$=G(5),D=G(5),F=G(5),V=G(5),z=G(5),j=G(5),K=G(5),U=G(5),me=G(5),Te=G(5),q=G(5),W=G(5),ce=`<sui-slider color="red" v-model="redSlider" />
