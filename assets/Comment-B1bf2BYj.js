import{o as p,c as i,w as t,a,b as l,u as s,ap as m,aq as o,d as e,ar as h,_ as d,as as g,L as v,D as C}from"./index-B2sz39O7.js";import{_ as y}from"./jenny-C8JmaaC7.js";import{_}from"./joe-CWv6CXVt.js";import{_ as u}from"./DocSection-LsN_yblw.js";const $=e("img",{src:h},null,-1),f=e("span",null,"Today at 5:42PM",-1),x=e("a",null,"Reply",-1),w=e("img",{src:d},null,-1),R=e("span",null,"Yesterday at 12:30AM",-1),T=e("a",null,"Reply",-1),b=e("img",{src:y},null,-1),j=e("span",null,"Just now",-1),M=e("a",null,"Reply",-1),G=e("img",{src:_},null,-1),H=e("span",null,"5 days ago",-1),k=e("a",null,"Reply",-1),J=`<template>
  <CommentGroup>
    <Comment>
      <template #avatar>
...
</template>`,z={__name:"ActionsDoc",setup(r){return(n,c)=>(p(),i(u,{label:"Actions",code:O},{description:t(()=>[a(" A comment can contain an list of actions a user may perform related to this comment. ")]),example:t(()=>[l(s(m),null,{default:t(()=>[l(s(o),null,{avatar:t(()=>[L]),author:t(()=>[a(" Tom Lukic ")]),text:t(()=>[a(" This will be great for business reports. I will definitely download this. ")]),actions:t(()=>[N,B,U,q]),_:1})]),_:1})]),_:1}))}},K="/vue-fomantic-ui/images/avatar/small/christian.jpg",Q=e("img",{src:K},null,-1),W=e("a",{class:"reply"},"Reply",-1),X=e("img",{src:d},null,-1),Z=e("a",{class:"reply"},"Reply",-1),tt=`<template>
  <CommentGroup>
    <Comment>
      <template #avatar>
