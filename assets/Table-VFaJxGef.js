import{e as h,r as p,o as r,c as m,w as a,a as c,b as t,u as e,ae as u,af as n,H as D,Y as T,K as S,d,t as N,a4 as x,O as A,U as _,ag as y,a7 as R,v as k,F as w,x as j,D as E}from"./index-BPzz6yRK.js";import{_ as g}from"./DocSection-CUzZAhfI.js";const $={class:"content"},P={class:"sub header"},q=`<template>
...
<\/script>`,Y=h({__name:"PositiveNegativeDoc",setup(f){const o=p([{name:"No Name Specified",status:"Unknown",notes:"None"},{name:"Jimmy",status:"Approved",notes:"None"},{name:"Jamie",status:"Unknown",notes:"Requires call"},{name:"Jill",status:"Unknown",notes:"None"}]),i=({index:v})=>v===1,l=({value:v})=>v==="Requires call",s=({index:v})=>v===3,b=({value:v,index:C})=>C===0&&v==="None";return(v,C)=>(r(),m(g,{label:"Positive / Negative",code:M},{description:a(()=>[c(" A cell or row may let a user know whether a value is good or bad ")]),example:a(()=>[t(e(u),{celled:"",items:o.value,rowPositive:i,rowNegative:s},{default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status"},{body:a(({data:J})=>[J.status==="Approved"?(r(),m(e(_),{key:0,name:"checkmark"})):y("",!0),c(" "+N(J.status),1)]),_:1}),t(e(n),{field:"notes",header:"Notes",positive:l,negative:b},{body:a(({data:J})=>[J.notes==="Requires call"?(r(),m(e(_),{key:0,name:"close"})):y("",!0),c(" "+N(J.notes),1)]),_:1})]),_:1},8,["items"])]),_:1}))}}),G=`<template>
  <Table
    celled
    :items="items"
    :rowError="rowError"
...
<\/script>`,O=h({__name:"ErrorDoc",setup(f){const o=p([{name:"No Name Specified",status:"Approved",notes:"None"},{name:"Jimmy",status:"Cannot pull data",notes:"None"},{name:"Jamie",status:"Approved",notes:"Classified"},{name:"Jill",status:"Approved",notes:"None"}]),i=({data:s})=>s.name==="Jimmy",l=({value:s})=>s==="Classified";return(s,b)=>(r(),m(g,{label:"Error",code:G},{description:a(()=>[c(" A cell or row may call attention to an error or a negative value ")]),example:a(()=>[t(e(u),{celled:"",items:o.value,rowError:i},{default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status"}),t(e(n),{field:"notes",header:"Notes",error:l},{body:a(({data:v})=>[v.notes==="Classified"?(r(),m(e(_),{key:0,name:"attention"})):y("",!0),c(" "+N(v.notes),1)]),_:1})]),_:1},8,["items"])]),_:1}))}}),Z=`<template>
  <Table
    celled
    :items="items"
...
<\/script>`,Ye=h({__name:"InvertedDoc",setup(f){const o=p([{name:"John",status:"Approved",notes:"None"},{name:"Jamie",status:"Approved",notes:"Requires call"},{name:"Jill",status:"Denied",notes:"None"}]);return(i,l)=>(r(),m(g,{label:"Inverted",code:Me},{description:a(()=>[c(" A table's colors can be inverted ")]),example:a(()=>[t(e(u),{inverted:"",items:o.value},{footer:a(()=>[We]),default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status"}),t(e(n),{field:"notes",header:"Notes"})]),_:1},8,["items"])]),_:1}))}}),Ge=`<template>
  <Table
    v-for="color in colors"
    :color="color"
    :key="color"
...
<\/script>`,Oe=h({__name:"InvertedColoredDoc",setup(f){const o=p([{food:"Apple",calories:200,protein:"0g"},{food:"Orange",calories:62,protein:"0g"}]),i=["red","orange","yellow","olive","green","teal","blue","violet","purple","pink","brown","grey","black"];return(l,s)=>(r(),m(g,{code:Ge},{example:a(()=>[(r(),k(w,null,j(i,b=>t(e(u),{color:b,key:b,inverted:"",items:o.value},{default:a(()=>[t(e(n),{field:"food",header:"Food"}),t(e(n),{field:"calories",header:"Calories"}),t(e(n),{field:"protein",header:"Protein"})]),_:2},1032,["color","items"])),64))]),_:1}))}}),Ze=`<template>
  <Table
    padded
    :items="items"
  >
