import{R as g,o as n,c as l,w as e,a as r,b as t,u as a,ah as d,n as c,ai as i,d as o,e as k,m as D,r as h,aj as v,X as y,Z as w,a0 as b,t as f,I as F,D as x,ak as j,h as A,al as I,am as $,i as M,j as G,y as E,f as N}from"./index-DXf-rKoW.js";import{_}from"./DocSection-C2fGI9ub.js";const V=o("span",null,"Joined in 2013",-1),J=o("span",{class:"right floated"},"14h",-1),H={class:"right floated"},B=`<template>
  <Card>
...
</template>`,ee=g({__name:"MetadataDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Metadata",code:U},{description:e(()=>[r(" A card can contain content metadata ")]),example:e(()=>[t(a(d),null,{default:e(()=>[t(a(i),{header:"Cute Dog"},{meta:e(()=>[W,Z]),description:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1})]),_:1})]),_:1}))}}),ae=`<template>
  <CardGroup>
    <Card v-for="item in items">
      <CardContent>
        <template #header>
