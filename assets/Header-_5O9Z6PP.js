import{o as d,c as n,w as e,a,b as t,u as r,g as o,J as _,k as m,l as p,f as h,V as H,x as u,D as S}from"./index-BienhS53.js";import{_ as s}from"./DocSection-BCb0rW96.js";const f=`<template>
  ...
  <span>$10.99</span>
</template>`,D={__name:"SubHeadersDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Sub Headers",code:$},{description:e(()=>[a(" Headers may be formatted to label smaller or de-emphasized content. ")]),example:e(()=>[t(r(o),{sub:""},{default:e(()=>[a("Price")]),_:1}),A]),_:1}))}},k=`<template>
  <SuiHeader as="h2">
    <SuiImage src="/images/avatar/large/steve.jpg" avatar />
    Steve
  </SuiHeader>
</template>`,w={__name:"ImageDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Image",code:k},{description:e(()=>[a(" A header may contain an image ")]),example:e(()=>[t(r(o),{as:"h2"},{default:e(()=>[t(r(H),{src:"/vue-fomantic-ui/images/avatar/large/steve.jpg",avatar:""}),a(" Steve ")]),_:1})]),_:1}))}},C=`<template>
  <SuiHeader as="h2">
    <SuiIcon name="plug" />
    <SuiHeaderContent>
      Uptime Guarantee
...
</template>`,V={__name:"SubheaderDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Subheader",code:T},{description:e(()=>[a(" Headers may contain subheaders ")]),example:e(()=>[t(r(o),{as:"h2"},{default:e(()=>[a(" Account Settings "),t(r(p),null,{default:e(()=>[a(" Manage your account settings and set e-mail preferences. ")]),_:1})]),_:1})]),_:1}))}},F=`<template>
  <SuiHeader disabled>
    Disabled Header
  </SuiHeader>
...
</template>`,G={__name:"DividingDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Dividing",code:P},{description:e(()=>[a(" A header can be formatted to divide itself from the content below it ")]),example:e(()=>[t(r(o),{as:"h3",dividing:""},{default:e(()=>[a(" Dividing Header ")]),_:1})]),_:1}))}},z=`<template>
...
</template>`,R={__name:"FloatingDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Floating",code:M},{description:e(()=>[a(" A header can sit to the left or right of other content ")]),example:e(()=>[t(r(u),{clearing:""},{default:e(()=>[t(r(o),{as:"h3",floated:"right"},{default:e(()=>[a(" Go Forward ")]),_:1}),t(r(o),{as:"h3",floated:"left"},{default:e(()=>[a(" Go Back ")]),_:1})]),_:1})]),_:1}))}},j=`<template>
  <SuiSegment>
