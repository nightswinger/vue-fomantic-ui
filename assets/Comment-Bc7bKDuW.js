import{o as p,c as i,w as t,a,b as l,u as s,ar as m,as as o,f as e,at as h,_ as d,au as g,x as v,D as C}from"./index-BienhS53.js";import{_ as y}from"./jenny-C8JmaaC7.js";import{_}from"./joe-CWv6CXVt.js";import{_ as u}from"./DocSection-BCb0rW96.js";const f=e("img",{src:h},null,-1),$=e("span",null,"Today at 5:42PM",-1),x=e("a",null,"Reply",-1),w=e("img",{src:d},null,-1),R=e("span",null,"Yesterday at 12:30AM",-1),T=e("a",null,"Reply",-1),b=e("img",{src:y},null,-1),j=e("span",null,"Just now",-1),M=e("a",null,"Reply",-1),G=e("img",{src:_},null,-1),H=e("span",null,"5 days ago",-1),k=e("a",null,"Reply",-1),J=`<template>
  <CommentGroup>
    <Comment>
      <template #avatar>
...
</template>`,V={__name:"MetadataDoc",setup(r){return(n,c)=>(p(),i(u,{label:"Metadata",code:Y},{description:t(()=>[a(" A comment can contain metadata about the comment, an arbitrary amount of metadata may be defined. ")]),example:t(()=>[l(s(m),null,{default:t(()=>[l(s(o),null,{avatar:t(()=>[I]),author:t(()=>[a(" Stevie Feliciano ")]),metadata:t(()=>[P,S]),text:t(()=>[a(" Hey guys, I hope this example comment is helping you read this documentation. ")]),_:1})]),_:1})]),_:1}))}},N=e("img",{src:_},null,-1),B=e("a",{class:"reply"},"Reply",-1),L=e("a",{class:"save"},"Save",-1),U=e("a",{class:"hide"},"Hide",-1),q=e("a",null,[e("i",{class:"expand icon"}),a(" Full-screen ")],-1),z=`<template>
  <CommentGroup>
    <Comment>
      <template #avatar>
        <img src="/images/avatar/small/stevie.jpg" />
...
</template>`,K={__name:"ActionsDoc",setup(r){return(n,c)=>(p(),i(u,{label:"Actions",code:z},{description:t(()=>[a(" A comment can contain an list of actions a user may perform related to this comment. ")]),example:t(()=>[l(s(m),null,{default:t(()=>[l(s(o),null,{avatar:t(()=>[N]),author:t(()=>[a(" Tom Lukic ")]),text:t(()=>[a(" This will be great for business reports. I will definitely download this. ")]),actions:t(()=>[B,L,U,q]),_:1})]),_:1})]),_:1}))}},O="/vue-fomantic-ui/images/avatar/small/christian.jpg",Q=e("img",{src:O},null,-1),W=e("a",{class:"reply"},"Reply",-1),X=e("img",{src:d},null,-1),Z=e("a",{class:"reply"},"Reply",-1),tt=`<template>
  <CommentGroup>
    <Comment>
      <template #avatar>
...
</template>`,Bt={__name:"InvertedDoc",setup(r){return(n,c)=>(p(),i(u,{label:"Inverted",code:Nt},{description:t(()=>[a(" Comments' colors can be inverted ")]),example:t(()=>[l(s(v),{inverted:""},{default:t(()=>[l(s(m),{inverted:"",threaded:""},{default:t(()=>[l(s(o),null,{avatar:t(()=>[Ht]),author:t(()=>[a(" Matt ")]),metadata:t(()=>[kt]),text:t(()=>[a(" How artistic! ")]),actions:t(()=>[Jt]),_:1}),l(s(o),null,{avatar:t(()=>[At]),author:t(()=>[a(" Elliot Fu ")]),metadata:t(()=>[Dt]),text:t(()=>[a(" This has been very useful for my research. Thanks as well! ")]),actions:t(()=>[Et]),default:t(()=>[l(s(m),null,{default:t(()=>[l(s(o),null,{avatar:t(()=>[Ft]),author:t(()=>[a(" Jenny Hess ")]),metadata:t(()=>[It]),text:t(()=>[a(" Elliot you are always so right :) ")]),actions:t(()=>[Pt]),_:1})]),_:1})]),_:1}),l(s(o),null,{avatar:t(()=>[St]),author:t(()=>[a(" Joe Henderson ")]),metadata:t(()=>[Yt]),text:t(()=>[a(" Dude, this is awesome. Thanks so much ")]),actions:t(()=>[Vt]),_:1})]),_:1})]),_:1})]),_:1}))}},Ot={__name:"Comment",setup(r){const n=[{id:"comments",label:"Comments",category:"Types",component:A},{id:"avatar",label:"Avatar",category:"Content",component:F},{id:"metadata",label:"Metadata",category:"Content",component:V},{id:"actions",label:"Actions",category:"Content",component:K},{id:"collapsed",label:"Collapsed",category:"States",component:et},{id:"threaded",label:"Threaded",category:"Variations",component:ht},{id:"minimal",label:"Minimal",category:"Variations",component:Gt},{id:"inverted",label:"Inverted",category:"Variations",component:Bt}];return(c,Lt)=>(p(),i(C,{title:"Comment",description:"A comment displays user feedback to site content","component-docs":n}))}};export{Ot as default};
