import{o as r,c as u,w as e,a as i,b as a,u as l,q as t,U as m,J as S,d as b,l as G,g as x,V as L,H as h,R as v,f as p,K as d,j as _,P as y,m as $,n as f,p as C,s as w,Z as g,D}from"./index-1OxQlk_2.js";import{_ as s}from"./DocSection-DUJg2L7o.js";import{_ as I}from"./joe-CWv6CXVt.js";const k=`<template>
  <SuiLabel>
    <SuiIcon name="mail" />
    23
  </SuiLabel>
</template>`,F={__name:"LabelDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Label",code:k},{description:e(()=>[i(" A label ")]),example:e(()=>[a(l(t),null,{default:e(()=>[a(l(m),{name:"mail"}),i(" 23 ")]),_:1})]),_:1}))}},z="/vue-fomantic-ui/images/avatar/small/veronika.jpg",B=b("img",{src:I},null,-1),T=b("img",{src:z},null,-1),P=b("img",{src:G},null,-1),V=`<template>
  <SuiLabel as="a" image>
...
</template>`,A={__name:"ImageDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Image",code:V},{description:e(()=>[i(" A label can be formatted to emphasize an image ")]),example:e(()=>[a(l(t),{as:"a",image:""},{default:e(()=>[B,i(" Joe ")]),_:1}),a(l(t),{as:"a",image:"",color:"blue"},{default:e(()=>[T,i(" Veronika "),a(l(S),null,{default:e(()=>[i("Friend")]),_:1})]),_:1}),a(l(t),{as:"a",image:""},{default:e(()=>[P,i(" Elliot "),a(l(m),{name:"delete"})]),_:1})]),_:1}))}},R=b("input",{type:"text",placeholder:"First Name"},null,-1),M=b("input",{type:"text"},null,-1),H=b("input",{type:"text",placeholder:"Username"},null,-1),O=b("input",{type:"password"},null,-1),U=`<template>
  <SuiForm fluid>
    <SuiFormField>
...
</template>`,j={__name:"PointingDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Pointing",code:U},{description:e(()=>[i(" A label can point to content next to it ")]),example:e(()=>[a(l(x),{fluid:""},{default:e(()=>[a(l(L),null,{default:e(()=>[R,a(l(t),{pointing:""},{default:e(()=>[i("Please enter a value")]),_:1})]),_:1}),a(l(h)),a(l(L),null,{default:e(()=>[a(l(t),{pointing:"below"},{default:e(()=>[i("Please enter a value")]),_:1}),M]),_:1}),a(l(h)),a(l(L),{inline:""},{default:e(()=>[H,a(l(t),{pointing:"left",color:"red",basic:""},{default:e(()=>[i("That name is taken!")]),_:1})]),_:1}),a(l(h)),a(l(L),{inline:""},{default:e(()=>[a(l(t),{pointing:"right",color:"red",basic:""},{default:e(()=>[i("Your password must be 6 characters or more")]),_:1}),O]),_:1})]),_:1})]),_:1}))}},E=`<template>
  <SuiGrid :columns="2">
    <SuiGridColumn>
      <SuiImage
...
</template>`,q={__name:"TagDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Tag",code:N},{description:e(()=>[i(" A label can appear as a tag ")]),example:e(()=>[a(l(t),{as:"a",tag:""},{default:e(()=>[i("New")]),_:1}),a(l(t),{as:"a",tag:"",color:"red"},{default:e(()=>[i("Upcoming")]),_:1}),a(l(t),{as:"a",tag:"",color:"teal"},{default:e(()=>[i("Featured")]),_:1})]),_:1}))}},J=b("span",null,"Account Details",-1),K=b("span",null,"User Reviews",-1),W=b("span",null,"Technical Specifications",-1),Z=b("span",null,"User Reviews",-1),Q=`<template>
  <SuiGrid :columns="2">
    <SuiGridColumn>
      <SuiSegment raised>
...
</template>`,X={__name:"RibbonDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Ribbon",code:Q},{description:e(()=>[i(" A label can appear as a ribbon attaching itself to an element. ")]),example:e(()=>[a(l(v),{columns:2},{default:e(()=>[a(l(p),null,{default:e(()=>[a(l(_),{raised:""},{default:e(()=>[a(l(t),{as:"a",ribbon:"",color:"red"},{default:e(()=>[i("Overview")]),_:1}),J,a(l(d),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"}),a(l(t),{as:"a",ribbon:"",color:"blue"},{default:e(()=>[i("Community")]),_:1}),K,a(l(d),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1})]),_:1}),a(l(p),null,{default:e(()=>[a(l(_),{raised:""},{default:e(()=>[a(l(t),{as:"a",ribbon:"right",color:"orange"},{default:e(()=>[i("Specs")]),_:1}),W,a(l(d),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"}),a(l(t),{as:"a",ribbon:"right",color:"teal"},{default:e(()=>[i("Reviews")]),_:1}),Z,a(l(d),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1})]),_:1})]),_:1})]),_:1}))}},ee=`<template>
  <SuiGrid :columns="3">
    <SuiGridRow>
      <SuiGridColumn>
        <SuiSegment padded>
...
</template>`,oe={__name:"FloatingDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Floating",code:te},{description:e(()=>[i(" A label can float above or below another element ")]),example:e(()=>[a(l(C),{compact:""},{default:e(()=>[a(l(w),null,{default:e(()=>[a(l(m),{name:"mail"}),i(" Messages "),a(l(t),{floating:"",color:"red"},{default:e(()=>[i("22")]),_:1})]),_:1}),a(l(w),null,{default:e(()=>[a(l(m),{name:"users"}),i(" Friends "),a(l(t),{floating:"",color:"teal"},{default:e(()=>[i("22")]),_:1})]),_:1})]),_:1})]),_:1}))}},re=`<template>
  <SuiSegment inverted>
...
</template>`,De={__name:"SizeDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Size",code:Ce},{description:e(()=>[i(" A label can be small or large ")]),example:e(()=>[a(l(t),{size:"mini"},{default:e(()=>[i("Mini")]),_:1}),a(l(t),{size:"tiny"},{default:e(()=>[i("Tiny")]),_:1}),a(l(t),{size:"small"},{default:e(()=>[i("Small")]),_:1}),a(l(t),null,{default:e(()=>[i("Medium")]),_:1}),a(l(t),{size:"large"},{default:e(()=>[i("Large")]),_:1}),a(l(t),{size:"big"},{default:e(()=>[i("Big")]),_:1}),a(l(t),{size:"huge"},{default:e(()=>[i("Huge")]),_:1}),a(l(t),{size:"massive"},{default:e(()=>[i("Massive")]),_:1})]),_:1}))}},Ie=`<template>
...
</template>`,ke={__name:"GroupSizeDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Group Size",code:Ie},{description:e(()=>[i(" Labels can share sizes together ")]),example:e(()=>[a(l(g),{size:"huge"},{default:e(()=>[a(l(t),null,{default:e(()=>[i("Fun")]),_:1}),a(l(t),null,{default:e(()=>[i("Happy")]),_:1}),a(l(t),null,{default:e(()=>[i("Smart")]),_:1}),a(l(t),null,{default:e(()=>[i("Witty")]),_:1})]),_:1})]),_:1}))}},Fe=`<template>
...
</template>`,ze={__name:"ColoredGroupDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Clored Group",code:Fe},{description:e(()=>[i(" Labels can share colors together ")]),example:e(()=>[a(l(g),{color:"blue"},{default:e(()=>[a(l(t),null,{default:e(()=>[i(" Fun "),a(l(m),{name:"close"})]),_:1}),a(l(t),null,{default:e(()=>[i(" Happy "),a(l(S),null,{default:e(()=>[i("Smart")]),_:1})]),_:1}),a(l(t),null,{default:e(()=>[i("Insane")]),_:1}),a(l(t),null,{default:e(()=>[i("Exciting")]),_:1})]),_:1})]),_:1}))}},Be=`<template>
  <SuiLabelGroup basic>
    <SuiLabel>
      Fun
      <SuiIcon name="close" />
...
</template>`,Te={__name:"BasicGroupDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Basic Group",code:Be},{description:e(()=>[i(" Labels can share their style together ")]),example:e(()=>[a(l(g),{basic:""},{default:e(()=>[a(l(t),null,{default:e(()=>[i(" Fun "),a(l(m),{name:"close"})]),_:1}),a(l(t),null,{default:e(()=>[i(" Happy "),a(l(S),null,{default:e(()=>[i("Smart")]),_:1})]),_:1}),a(l(t),null,{default:e(()=>[i("Insane")]),_:1}),a(l(t),null,{default:e(()=>[i("Exciting")]),_:1})]),_:1})]),_:1}))}},Pe=`<template>
  <SuiLabelGroup size="huge">
    <SuiLabel>Fun</SuiLabel>
    <SuiLabel>Happy</SuiLabel>
    <SuiLabel>Smart</SuiLabel>
...
</template>`,Ve={__name:"TagGroupDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Tag Group",code:Pe},{description:e(()=>[i(" Labels can share tag formatting ")]),example:e(()=>[a(l(g),{tag:""},{default:e(()=>[a(l(t),{as:"a"},{default:e(()=>[i("$10.00")]),_:1}),a(l(t),{as:"a"},{default:e(()=>[i("$19.99")]),_:1}),a(l(t),{as:"a"},{default:e(()=>[i("$24.99")]),_:1}),a(l(t),{as:"a"},{default:e(()=>[i("$10.25")]),_:1})]),_:1})]),_:1}))}},Ae=`<template>
  <SuiLabelGroup tag>
...
</template>`,Re={__name:"CircularGroupDoc",setup(c){return(o,n)=>(r(),u(s,{label:"Circular Group",code:Ae},{description:e(()=>[i(" Labels can share shapes ")]),example:e(()=>[a(l(g),{circular:""},{default:e(()=>[a(l(t),{as:"a"},{default:e(()=>[i("1")]),_:1}),a(l(t),{as:"a"},{default:e(()=>[i("3")]),_:1}),a(l(t),{as:"a"},{default:e(()=>[i("4")]),_:1}),a(l(t),{as:"a"},{default:e(()=>[i("14")]),_:1}),a(l(t),{as:"a"},{default:e(()=>[i("16")]),_:1}),a(l(t),{as:"a"},{default:e(()=>[i("34")]),_:1})]),_:1})]),_:1}))}},je={__name:"Label",setup(c){const o=[{id:"label",label:"Label",category:"Types",component:F},{id:"image",label:"Image",category:"Types",component:A},{id:"pointing",label:"Pointing",category:"Types",component:j},{id:"corner",label:"Corner",category:"Types",component:Y},{id:"tag",label:"Tag",category:"Types",component:q},{id:"ribbon",label:"Ribbon",category:"Types",component:X},{id:"attached",label:"Attached",category:"Types",component:ae},{id:"horizontal",label:"Horizontal",category:"Types",component:ie},{id:"floating",label:"Floating",category:"Types",component:oe},{id:"inverted",label:"Inverted",category:"Types",component:ue},{id:"detail",label:"Detail",category:"Content",component:ne},{id:"icon",label:"Icon",category:"Content",component:de},{id:"link",label:"Link",category:"Content",component:pe},{id:"disabled",label:"Disabled",category:"States",component:_e},{id:"fluid",label:"Fluid",category:"Variations",component:ge},{id:"circular",label:"Circular",category:"Variations",component:fe},{id:"basic",label:"Basic",category:"Variations",component:ye},{id:"colored",label:"Colored",category:"Variations",component:Ge},{id:"basic-tag",label:"Basic Tag",category:"Variations",component:$e},{id:"size",label:"Size",category:"Variations",component:De},{id:"group-size",label:"Group Size",category:"Groups",component:ke},{id:"colored-group",label:"Colored Group",category:"Groups",component:ze},{id:"basic-group",label:"Basic Group",category:"Groups",component:Te},{id:"tag-group",label:"Tag Group",category:"Groups",component:Ve},{id:"circular-group",label:"Circular Group",category:"Groups",component:Re}];return(n,Me)=>(r(),u(D,{title:"Label",description:"A label displays content classification","component-docs":o}))}};export{je as default};
