import{e as u,r as d,o,c as n,w as a,a as i,b as v,u as s,aW as p,t as _,L as V,p as g,F as S,s as y,D as x}from"./index-BLRrc4sh.js";import{_ as m}from"./DocSection-Da03Tz-a.js";const k=`<template>
...
const value = ref(7)
<\/script>`,W=u({__name:"DisabledDoc",setup(c){const e=d(7);return(r,l)=>(o(),n(m,{label:"Disabled",code:R},{description:a(()=>[i(" A slider can appear disabled ")]),example:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),disabled:""},null,8,["modelValue"])]),_:1}))}}),B=`<template>
  <Segment inverted>
...
const value = ref(8)
<\/script>`,H=u({__name:"InvertedDoc",setup(c){const e=d(8);return(r,l)=>(o(),n(m,{label:"Inverted",code:B},{description:a(()=>[i(" A slider can be inverted ")]),example:a(()=>[v(s(V),{inverted:""},{default:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),inverted:""},null,8,["modelValue"])]),_:1})]),_:1}))}}),F=`<template>
...
const value = ref(5)
<\/script>`,M=u({__name:"ReversedDoc",setup(c){const e=d(5);return(r,l)=>(o(),n(m,{label:"Reversed",code:F},{description:a(()=>[i(" A slider can be reversed ")]),example:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),reversed:""},null,8,["modelValue"]),i(" Slider value: "+_(e.value),1)]),_:1}))}}),N=`<template>
...
const value = ref(5)
<\/script>`,E=u({__name:"VerticalDoc",setup(c){const e=d(5);return(r,l)=>(o(),n(m,{label:"Vertical",code:N},{description:a(()=>[i(" A slider can be vertical ")]),example:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),vertical:""},null,8,["modelValue"]),i(" Slider value: "+_(e.value),1)]),_:1}))}}),Y=`<template>
  <Slider
