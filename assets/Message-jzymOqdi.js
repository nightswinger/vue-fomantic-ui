import{o as i,c as r,w as a,a as s,b as e,u as t,a7 as o,e as m,K as p,Y as u,g as h,a5 as _,F as g,a4 as b,O as y,d as f,D as w}from"./index-CFQxuMLK.js";import{_ as d}from"./DocSection-bYVctxpZ.js";const v=`<template>
  <Message
  ...
  />
</template>`,$=m({__name:"ListMessageDoc",setup(l){return(c,n)=>(i(),r(d,{label:"List Message",code:x},{description:a(()=>[s(" A message with a list ")]),example:a(()=>[e(t(o),{header:"New Site Features",list:["You can now have cover images on blog pages","Drafts will now auto-save while writing"]})]),_:1}))}}),F=`<template>
  <Message
    icon="inbox"
  ...
  />
</template>`,W=m({__name:"HiddenDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Hidden",code:V},{description:a(()=>[s(" A message can be hidden ")]),example:a(()=>[e(t(o),{hidden:"",content:"You can't see me"})]),_:1}))}}),Y=`<template>
  <Message
    visible
    content="You can always see me"
  />
</template>`,k=m({__name:"VisibleDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Visible",code:Y},{description:a(()=>[s(" A message can be set to visible to force itself to be shown. ")]),example:a(()=>[e(t(o),{visible:"",content:"You can always see me"})]),_:1}))}}),N=`<template>
  <Message
    aligned="center"
  ...
  <Message
    ...
    content="When are you going to update?"
  />
</template>`,z=m({__name:"AlignedDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Aligned",code:N},{description:a(()=>[s(" A message can be displayed center or right aligned ")]),example:a(()=>[e(t(o),{aligned:"center",header:"New Version is available!",content:"When are you going to update?"}),e(t(o),{aligned:"right",header:"New Version is available!",content:"When are you going to update?"})]),_:1}))}}),S=`<template>
  <Message
    floating
    content="Way to go!"
  />
  ...
  <Message
    ...
    closable
  />
</template>`,H=m({__name:"WarningDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Warning",code:O},{description:a(()=>[s(" A message may be formatted to display warning messages. ")]),example:a(()=>[e(t(o),{warning:"",header:"You must register before you can do that!",content:"Visit our registration page, then try again",closable:""})]),_:1}))}}),U=`<template>
  <Message
    info
    ...
    closable
  />
</template>`,E=m({__name:"InfoDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Info",code:U},{description:a(()=>[s(" A message may be formatted to display information. ")]),example:a(()=>[e(t(o),{info:"",header:"Was this what you wanted?",list:["It's good to see you again.","Did you know it's been a while?"],closable:""},null,8,["list"])]),_:1}))}}),q=`<template>
  <Message
    positive
