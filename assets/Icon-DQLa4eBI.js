import{o as i,c as s,w as n,a as c,b as e,u as o,K as r,d as m,N as d,D as p}from"./index-C5UtasSn.js";import{_ as u}from"./DocSection-DNwpJszJ.js";const _=`<template>
...
</template>`,E={__name:"IconsDoc",setup(t){return(a,l)=>(i(),s(u,{label:"Icons",code:q},{description:n(()=>[c(" Several icons can be used together as a group ")]),example:n(()=>[e(o(d),{size:"huge"},{default:n(()=>[e(o(r),{name:"circle outline",size:"big"}),e(o(r),{name:"user"})]),_:1}),e(o(d),{size:"huge"},{default:n(()=>[e(o(r),{name:"dont",size:"big",color:"red"}),e(o(r),{name:"user",color:"black"})]),_:1})]),_:1}))}},H=`<template>
  <SuiIconGroup size="huge">
    <SuiIcon name="puzzle" />
