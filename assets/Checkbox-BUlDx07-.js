import{O as m,r as f,o as d,c as u,w as o,a as r,b as t,u as c,a5 as n,k,l as i,t as v,f as h}from"./index-BtqR3fgc.js";import{_ as b}from"./DocSection-Bplbrfto.js";const _=`<template>
...
const checked = ref(false)
<\/script>`,A=m({__name:"SliderDoc",setup(p){const e=f(!1);return(s,l)=>(d(),u(b,{label:"Slider",code:F},{description:o(()=>[r(" A checkbox can look like a slider ")]),example:o(()=>[t(c(n),{slider:"",modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=a=>e.value=a)},null,8,["modelValue"])]),_:1}))}}),B={__name:"Checkbox",setup(p){const e=[{id:"checkbox",label:"Checkbox",category:"Types",component:x},{id:"multiple",label:"Multiple",category:"Types",component:g},{id:"toggle",label:"Toggle",category:"Types",component:y},{id:"slider",label:"Slider",category:"Types",component:A}],s={Checkbox:{props:[{name:"label",type:"string",default:"null",description:"Label of the checkbox."},{name:"modelValue",type:"any",default:"null",description:"Value binding of the checkbox."},{name:"value",type:"any",default:"null",description:"Value of the checkbox."}],events:[{name:"change",description:"Callback to invoke when checkbox value is changed."},{name:"click",description:"Callback to invoke when checkbox is clicked."}]}};return(l,a)=>(d(),u(h,{title:"Checkbox",description:"A checkbox allows a user to select a value from a small set of options, often binary","component-docs":e,"api-docs":s}))}};export{B as default};
