import{d as u,r as _,o as r,c,w as e,a as o,b as t,u as n,I as s,_ as p,L as i,e as h,v as I,f as x,g as S,h as k,i as M,T as g,k as v,A as b,Y as y,p as w,j as f,l as $,m as A,D as L}from"./index-5MvC7eWK.js";const C=`<template>
  <Menu
    :items="items"
    :widths="items.length"
...
<\/script>`,z=u({__name:"PointingDoc",setup(m){const a=_(["Home","Messages","Friends"]);return(l,d)=>(r(),c(p,{label:"Pointing",code:F},{description:e(()=>[o(" A menu can point to show its relationship to nearby content ")]),example:e(()=>[t(n(s),{pointing:"",items:a.value},{right:e(()=>[t(n(i),{as:"div"},{default:e(()=>[t(n(h),{icon:"search",placeholder:"Search..."})]),_:1})]),_:1},8,["items"]),t(n(I),null,{default:e(()=>[H]),_:1}),t(n(s),{secondary:"",pointing:"",items:a.value},{right:e(()=>[t(n(i),null,{default:e(()=>[o(" Logout ")]),_:1})]),_:1},8,["items"]),t(n(I),null,{default:e(()=>[R]),_:1})]),_:1}))}}),E=`<template>
  <Menu
    ...
    :items="['Bio', 'Photos']"
  />
</template>`,P=u({__name:"TabularDoc",setup(m){return(a,l)=>(r(),c(p,{label:"Tabular",code:E},{description:e(()=>[o(" A menu can be formatted to show tabs of information ")]),example:e(()=>[t(n(s),{tabular:"",items:["Bio","Photos"]})]),_:1}))}}),j=`<template>
