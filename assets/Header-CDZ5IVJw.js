import{o as d,c as n,w as e,a,b as t,u as r,h as o,J as _,l as m,n as h,f as p,V as H,x as u,D as S}from"./index-3N8A7B9S.js";import{_ as s}from"./DocSection-DqOV4wTl.js";const f=`<template>
...
</template>`,V={__name:"SubheaderDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Subheader",code:T},{description:e(()=>[a(" Headers may contain subheaders ")]),example:e(()=>[t(r(o),{as:"h2"},{default:e(()=>[a(" Account Settings "),t(r(h),null,{default:e(()=>[a(" Manage your account settings and set e-mail preferences. ")]),_:1})]),_:1})]),_:1}))}},F=`<template>
  <SuiHeader disabled>
    Disabled Header
  </SuiHeader>
