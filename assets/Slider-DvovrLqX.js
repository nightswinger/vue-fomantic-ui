import{O as u,r as d,o,c as n,w as a,a as i,b as v,u as s,aU as p,t as _,y as V,P as g,Q as S,R as y,f as x}from"./index-BtqR3fgc.js";import{_ as m}from"./DocSection-Bplbrfto.js";const k=`<template>
...
const value = ref(8)
<\/script>`,H=u({__name:"InvertedDoc",setup(c){const e=d(8);return(r,l)=>(o(),n(m,{label:"Inverted",code:W},{description:a(()=>[i(" A slider can be inverted ")]),example:a(()=>[v(s(V),{inverted:""},{default:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),inverted:""},null,8,["modelValue"])]),_:1})]),_:1}))}}),M=`<template>
...
const value = ref(5)
<\/script>`,F=u({__name:"VerticalDoc",setup(c){const e=d(5);return(r,l)=>(o(),n(m,{label:"Vertical",code:E},{description:a(()=>[i(" A slider can be vertical ")]),example:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),vertical:""},null,8,["modelValue"]),i(" Slider value: "+_(e.value),1)]),_:1}))}}),O=`<template>
  <Slider
...
<\/script>`,P=u({__name:"ColoredDoc",setup(c){const e=d(5),r=d(["red","orange","yellow","olive","green","teal","blue","violet","purple","pink","brown","grey","black"]);return(l,t)=>(o(),n(m,{label:"Colored",code:O},{description:a(()=>[i(" A slider can be different colors ")]),example:a(()=>[(o(!0),g(S,null,y(r.value,f=>(o(),n(s(p),{key:f,color:f,modelValue:e.value,"onUpdate:modelValue":t[0]||(t[0]=b=>e.value=b)},null,8,["color","modelValue"]))),128))]),_:1}))}}),Q=`<template>
  <Segment inverted>
    <Slider
      v-for="color in colors"
      :key="color"
