import{O as i,r as _,o as n,c,w as t,a as g,b as e,u as r,aK as o,D as u,y as b,d as v,f as P}from"./index-BtqR3fgc.js";import{_ as d}from"./DocSection-Bplbrfto.js";const f=`<template>
...
</template>`,S=i({__name:"ProgressDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Progress",code:w},{description:t(()=>[g(" A progress bar can contain a text value indicating current progress ")]),example:t(()=>[e(r(o),{progress:"",percent:43})]),_:1}))}}),C=`<template>
  <Progress progress="centered" :percent="57" />
</template>`,D=i({__name:"CenteredProgressTextDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Centered Progress Text",code:C},{description:t(()=>[g(" The text inside a progress can be centered ")]),example:t(()=>[e(r(o),{progress:"centered",percent:57})]),_:1}))}}),A=`<template>
  <Progress progress :percent="12" label="Uploading Files" />
</template>`,B=i({__name:"LabelDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Label",code:A},{description:t(()=>[g(" A progress element can contain a label ")]),example:t(()=>[e(r(o),{progress:"",percent:12,label:"Uploading Files"})]),_:1}))}}),z=`<template>
