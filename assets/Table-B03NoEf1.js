import{e as h,r as p,o as r,c as m,w as a,a as c,b as t,u as e,ag as u,ah as n,P as D,R as T,z as S,d,t as N,a5 as x,C as A,K as _,ai as y,a8 as R,p as k,F as w,s as j,D as E}from"./index-BLRrc4sh.js";import{_ as g}from"./DocSection-Da03Tz-a.js";const $={class:"content"},P={class:"sub header"},q=`<template>
...
<\/script>`,G=h({__name:"PositiveNegativeDoc",setup(f){const o=p([{name:"No Name Specified",status:"Unknown",notes:"None"},{name:"Jimmy",status:"Approved",notes:"None"},{name:"Jamie",status:"Unknown",notes:"Requires call"},{name:"Jill",status:"Unknown",notes:"None"}]),i=({index:v})=>v===1,l=({value:v})=>v==="Requires call",s=({index:v})=>v===3,b=({value:v,index:J})=>J===0&&v==="None";return(v,J)=>(r(),m(g,{label:"Positive / Negative",code:M},{description:a(()=>[c(" A cell or row may let a user know whether a value is good or bad ")]),example:a(()=>[t(e(u),{celled:"",items:o.value,rowPositive:i,rowNegative:s},{default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status"},{body:a(({data:C})=>[C.status==="Approved"?(r(),m(e(_),{key:0,name:"checkmark"})):y("",!0),c(" "+N(C.status),1)]),_:1}),t(e(n),{field:"notes",header:"Notes",positive:l,negative:b},{body:a(({data:C})=>[C.notes==="Requires call"?(r(),m(e(_),{key:0,name:"close"})):y("",!0),c(" "+N(C.notes),1)]),_:1})]),_:1},8,["items"])]),_:1}))}}),Y=`<template>
  <Table
    celled
    :items="items"
    :rowError="rowError"
...
<\/script>`,Ae=h({__name:"VerticalAlignmentDoc",setup(f){const o=p([{name:"John",status:"Approved",notes:"Notes"},{name:"Jamie",status:"Approved",notes:"Notes"}]),i=({index:s})=>s===0?"top aligned":null,l=({index:s})=>s===1?"bottom aligned":null;return(s,b)=>(r(),m(g,{label:"Vertical Alignment",code:Je},{description:a(()=>[c(" A table header, row, or cell can adjust its vertical alignment ")]),example:a(()=>[t(e(u),{striped:"",items:o.value,rowClass:i},{default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status",cellClass:l}),t(e(n),{field:"notes",header:"Notes"},{body:a(({data:v})=>[c(N(v.notes),1),Ne,c(" 1"),ye,c(" 2"),Ce]),_:1})]),_:1},8,["items"])]),_:1}))}}),De=`<template>
  <Table
    striped
    :items="items"
    :rowClass="rowClass"
