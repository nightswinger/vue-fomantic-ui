import{f as n,o as s,c as u,w as a,a as i,b as e,u as t,I as l,J as m,L as p,_ as d,M as b,g as _,t as S,d as v,p as f,D as h}from"./index-Ygle4ekK.js";const g=`<template>
...
</template>`,k=n({__name:"InvertedDoc",setup(r){return(o,c)=>(s(),u(d,{label:"Inverted",code:I},{description:a(()=>[i(" A statistic can be formatted to be different colors ")]),example:a(()=>[e(t(f),{inverted:""},{default:a(()=>[e(t(b),{inverted:""},{default:a(()=>[e(t(l),{color:"red",value:"27",label:"Red"}),e(t(l),{color:"orange",value:"8",label:"Orange"}),e(t(l),{color:"yellow",value:"28",label:"Yellow"}),e(t(l),{color:"olive",value:"7",label:"Olive"}),e(t(l),{color:"green",value:"14",label:"Green"}),e(t(l),{color:"teal",value:"82",label:"Teal"}),e(t(l),{color:"blue",value:"1",label:"Blue"}),e(t(l),{color:"violet",value:"22",label:"Violet"}),e(t(l),{color:"purple",value:"23",label:"Purple"}),e(t(l),{color:"pink",value:"15",label:"Pink"}),e(t(l),{color:"brown",value:"36",label:"Brown"}),e(t(l),{color:"grey",value:"49",label:"Grey"})]),_:1})]),_:1})]),_:1}))}}),F=v("br",null,null,-1),B=`<template>
