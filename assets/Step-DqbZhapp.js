import{o as s,c as a,w as e,a as p,b as t,u as i,$ as c,a0 as _,f as u,r,E as v,g as S,Y as g,e as h,D as b}from"./index-DSC_QGPC.js";import{_ as d}from"./DocSection-Dy7AO88P.js";import{_ as y}from"./paragraph-acT4RHv3.js";const C=`<template>
  <StepGroup>
    <Step>Shopping</Step>
  </StepGroup>
...
const active = ref(1)
<\/script>`,R=u({__name:"FluidDoc",setup(l){const o=r([{title:"Shipping",description:"Choose your shipping options",icon:"plane"},{title:"Billing",description:"Enter billing information",icon:"dollar"}]),n=r(1);return(m,f)=>(s(),a(d,{label:"Fluid",code:Q},{description:e(()=>[p(" A fluid step takes up the width of its container ")]),example:e(()=>[t(i(v),{columns:2},{default:e(()=>[t(i(S),null,{default:e(()=>[t(i(c),{fluid:"",vertical:"",steps:o.value,activeStep:n.value},null,8,["steps","activeStep"])]),_:1}),t(i(S),null,{default:e(()=>[p(" The steps take up the entire column width ")]),_:1})]),_:1})]),_:1}))}}),j=`<template>
  <StepGroup
    unstackable
    :steps="steps"
    :activeStep="active"
