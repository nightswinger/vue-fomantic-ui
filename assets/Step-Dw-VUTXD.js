import{o as s,c as a,w as e,a as p,b as t,u as i,$ as r,a0 as _,O as u,r as c,i as g,j as S,y as v,d as h,a1 as b,f as y}from"./index-DqtkPo3d.js";import{_ as d}from"./DocSection-hLonYMiG.js";const C=`<template>
  <StepGroup>
    <Step>Shopping</Step>
  </StepGroup>
...
const active = ref(1)
<\/script>`,H=u({__name:"FluidDoc",setup(l){const o=c([{title:"Shipping",description:"Choose your shipping options",icon:"plane"},{title:"Billing",description:"Enter billing information",icon:"dollar"}]),n=c(1);return(m,f)=>(s(),a(d,{label:"Fluid",code:L},{description:e(()=>[p(" A fluid step takes up the width of its container ")]),example:e(()=>[t(i(g),{columns:2},{default:e(()=>[t(i(S),null,{default:e(()=>[t(i(r),{fluid:"",vertical:"",steps:o.value,activeStep:n.value},null,8,["steps","activeStep"])]),_:1}),t(i(S),null,{default:e(()=>[p(" The steps take up the entire column width ")]),_:1})]),_:1})]),_:1}))}}),J=`<template>
  <StepGroup
    unstackable
    :steps="steps"
    :activeStep="active"
