import{R as i,r as _,o as n,c,w as t,a as g,b as e,u as r,aJ as o,D as u,y as b,d as v,f as P}from"./index-DXf-rKoW.js";import{_ as d}from"./DocSection-C2fGI9ub.js";const f=`<template>
...
</template>`,H=i({__name:"SizeDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Size",code:G},{description:t(()=>[g(" A progress bar can vary in size ")]),example:t(()=>[e(r(o),{percent:88,size:"tiny",label:"tiny"}),e(r(o),{percent:100,size:"small",label:"small",success:""}),e(r(o),{percent:83,label:"standard"}),e(r(o),{percent:73,size:"large",label:"large"}),e(r(o),{percent:94,size:"big",label:"big"})]),_:1}))}}),K=`<template>
