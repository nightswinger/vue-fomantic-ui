import{o as r,c as n,w as t,a as o,b as e,u as a,g as m,V as l,a4 as F,O as d,a5 as b,a6 as _,a7 as p,D as S}from"./index-BPzz6yRK.js";import{_ as u}from"./DocSection-CUzZAhfI.js";const h=`<template>
  <SuiForm>
    <SuiFormField
      label="First Name"
...
</template>`,E={__name:"WarningDoc",setup(s){return(i,c)=>(r(),n(u,{label:"Warning",code:A},{description:t(()=>[o(" If a form is in warning state, it will automatically show any warning message block. ")]),example:t(()=>[e(a(m),{warning:""},{default:t(()=>[e(a(l),{label:"E-mail",type:"email",placeholder:"joe@schome.com"}),e(a(p),{warning:"",header:"Could you check something!",content:"That e-mail has been subscribed, but you have not yet clicked the verification link in your e-mail."}),e(a(d),{type:"submit"},{default:t(()=>[o("Submit")]),_:1})]),_:1})]),_:1}))}},I=`<template>
  <SuiForm>
    <SuiFormGroup>
...
</template>`,j={__name:"DisabledDoc",setup(s){return(i,c)=>(r(),n(u,{label:"Disabled",code:I},{description:t(()=>[o(" Individual fields may be disabled ")]),example:t(()=>[e(a(m),null,{default:t(()=>[e(a(b),null,{default:t(()=>[e(a(l),{disabled:"",label:"First name",placeholder:"Read only"}),e(a(l),{disabled:"",label:"Last name",placeholder:"Disabled"})]),_:1})]),_:1})]),_:1}))}},V={__name:"Form",setup(s){const i=[{id:"form",label:"Form",category:"Types",component:f},{id:"field",label:"Field",category:"Content",component:g},{id:"fields",label:"Fields",category:"Content",component:w},{id:"textarea",label:"TextArea",category:"Content",component:D},{id:"loading",label:"Loading",category:"Form States",component:T},{id:"success",label:"Success",category:"Form States",component:B},{id:"error",label:"Error",category:"Form States",component:L},{id:"warning",label:"Warning",category:"Form States",component:E},{id:"disabled",label:"Disabled",category:"Field States",component:j}];return(c,v)=>(r(),n(S,{title:"Form",description:"A form displays a set of related user input fields in a structured way","component-docs":i}))}};export{V as default};
