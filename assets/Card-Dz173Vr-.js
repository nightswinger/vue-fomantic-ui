import{O as g,o as n,c as l,w as e,a as r,b as t,u as a,al as d,n as c,am as i,d as o,e as k,m as D,r as h,an as v,P as y,Q as w,R as b,t as f,I as F,D as x,ao as j,h as A,ap as I,aq as $,i as M,j as G,y as E,f as N}from"./index-Bk7GY-tj.js";import{_}from"./DocSection-D3vdzv11.js";const V=o("span",null,"Joined in 2013",-1),J=o("span",{class:"right floated"},"14h",-1),H={class:"right floated"},B=`<template>
  <Card>
...
<\/script>`,W=g({__name:"HeaderDoc",setup(p){const s=h([{header:"Elliot Fu",meta:"Friend",description:"Elliot Fu is a film-maker from New York."},{header:"Veronika Ossi",meta:"Friend",description:"Veronika Ossi is a set designer living in New York who enjoys kittens, music, and partying."},{header:"Jenny Hess",meta:"Friend",description:"Jenny is a student studying Media Management at the New School"}]);return(u,C)=>(n(),l(_,{label:"Header",code:Q},{description:e(()=>[r(" A card can contain a header ")]),example:e(()=>[t(a(v),null,{default:e(()=>[(n(!0),y(w,null,b(s.value,m=>(n(),l(a(d),null,{default:e(()=>[t(a(i),null,{header:e(()=>[r(f(m.header),1)]),meta:e(()=>[r(f(m.meta),1)]),description:e(()=>[r(f(m.description),1)]),_:2},1024)]),_:2},1024))),256))]),_:1})]),_:1}))}}),X=o("span",null,"2 days ago",-1),U=o("a",null,"Animals",-1),Z=`<template>
  <Card>
...
</template>`,ee=g({__name:"MetadataDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Metadata",code:Z},{description:e(()=>[r(" A card can contain content metadata ")]),example:e(()=>[t(a(d),null,{default:e(()=>[t(a(i),{header:"Cute Dog"},{meta:e(()=>[X,U]),description:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1})]),_:1})]),_:1}))}}),ae=`<template>
  <CardGroup>
    <Card v-for="item in items">
      <CardContent>
        <template #header>
...
</template>`,Qe=g({__name:"ColumnCountDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Column Count",code:qe},{description:e(()=>[r(" A group of cards can set how many cards should exist in a row ")]),example:e(()=>[t(a(v),{itemsPerRow:4},{default:e(()=>[t(a(d),null,{default:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}),t(a(d),null,{default:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}),t(a(d),null,{default:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}),t(a(d),null,{default:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1})]),_:1})]),_:1}))}}),We=`<template>
...
<\/script>`,Xe=g({__name:"StackableDoc",setup(p){const s=h(["elliot","helen","jenny","veronika","stevie","steve"]);return(u,C)=>(n(),l(_,{label:"Stackable",code:We},{description:e(()=>[r(" A group of cards can automatically stack rows to a single columns on mobile devices ")]),example:e(()=>[t(a(v),{itemsPerRow:3,stackable:""},{default:e(()=>[(n(!0),y(w,null,b(s.value,m=>(n(),l(a(d),null,{default:e(()=>[t(a(c),{src:`/vue-fomantic-ui/images/avatar/large/${m}.jpg`},null,8,["src"])]),_:2},1024))),256))]),_:1})]),_:1}))}}),Ue=`<template>
