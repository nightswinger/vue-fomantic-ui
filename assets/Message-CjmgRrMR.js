import{o as i,c as r,w as a,a as s,b as e,u as t,a4 as o,R as d,e as p,y as u,k as h,a2 as _,l as g,a1 as b,D as y,d as f,f as w}from"./index-DXf-rKoW.js";import{_ as m}from"./DocSection-C2fGI9ub.js";const v=`<template>
  <Message
  ...
  />
</template>`,A=d({__name:"DismissableBlockDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Dismissable Block",code:D},{description:a(()=>[s(" A message that the user can choose to hide ")]),example:a(()=>[e(t(o),{header:"Welcome back!",content:"This is a special notification which you can dismiss if you're bored with it.",closable:"",onClose:n[0]||(n[0]=()=>console.log("Message closed"))})]),_:1}))}}),V=`<template>
  <Message
    hidden
  ...
  <Message
    ...
    closable
  />
</template>`,O=d({__name:"WarningDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Warning",code:H},{description:a(()=>[s(" A message may be formatted to display warning messages. ")]),example:a(()=>[e(t(o),{warning:"",header:"You must register before you can do that!",content:"Visit our registration page, then try again",closable:""})]),_:1}))}}),R=`<template>
  <Message
    info
    ...
    closable
  />
</template>`,U=d({__name:"InfoDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Info",code:R},{description:a(()=>[s(" A message may be formatted to display information. ")]),example:a(()=>[e(t(o),{info:"",header:"Was this what you wanted?",list:["It's good to see you again.","Did you know it's been a while?"],closable:""},null,8,["list"])]),_:1}))}}),E=`<template>
  <Message
    positive
