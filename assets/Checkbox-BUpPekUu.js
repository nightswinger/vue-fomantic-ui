import{e as m,r as f,o as d,c as u,w as o,a as r,b as t,u as c,a4 as n,g as k,V as i,t as v,D as h}from"./index-1OxQlk_2.js";import{_ as b}from"./DocSection-DUJg2L7o.js";const _=`<template>
...
<\/script>`,V=m({__name:"MultipleDoc",setup(p){const e=f(["Apple"]);return(s,l)=>(d(),u(b,{label:"Multiple",code:C},{description:o(()=>[r(" Multiple mode is enabled by default, v-model property refers to an array to bind the selected values ")]),example:o(()=>[t(c(k),null,{default:o(()=>[t(c(i),null,{default:o(()=>[r(" Selected values: "+v(e.value),1)]),_:1}),t(c(i),null,{default:o(()=>[t(c(n),{label:"Apple",value:"Apple",modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=a=>e.value=a)},null,8,["modelValue"])]),_:1}),t(c(i),null,{default:o(()=>[t(c(n),{label:"Banana",value:"Banana",modelValue:e.value,"onUpdate:modelValue":l[1]||(l[1]=a=>e.value=a)},null,8,["modelValue"])]),_:1}),t(c(i),null,{default:o(()=>[t(c(n),{label:"Chocolate",value:"Chocolate",modelValue:e.value,"onUpdate:modelValue":l[2]||(l[2]=a=>e.value=a)},null,8,["modelValue"])]),_:1})]),_:1})]),_:1}))}}),g=`<template>
...
const checked = ref(false)
<\/script>`,y=m({__name:"ToggleDoc",setup(p){const e=f(!1);return(s,l)=>(d(),u(b,{label:"Toggle",code:g},{description:o(()=>[r(" A checkbox can toggle ")]),example:o(()=>[t(c(n),{toggle:"",modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=a=>e.value=a)},null,8,["modelValue"])]),_:1}))}}),F=`<template>
