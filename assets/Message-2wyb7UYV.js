import{o as i,c as r,w as a,a as s,b as e,u as t,E as o,_ as d,d as m,k as p,C as u,n as h,l as _,m as g,p as b,j as y,e as f,D as w}from"./index-RtEKpQy5.js";const v=`<template>
  <Message
  ...
  <Message
    ...
    closable
  />
</template>`,U=m({__name:"InfoDoc",setup(l){return(c,n)=>(i(),r(d,{label:"Info",code:O},{description:a(()=>[s(" A message may be formatted to display information. ")]),example:a(()=>[e(t(o),{info:"",header:"Was this what you wanted?",list:["It's good to see you again.","Did you know it's been a while?"],closable:""},null,8,["list"])]),_:1}))}}),q=`<template>
  <Message
    positive
