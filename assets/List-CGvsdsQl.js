import{g,r as I,o as s,c as r,w as e,a as i,b as a,u as t,v as p,E as f,F as S,G as b,U as n,t as _,J as C,H as m,Y as v,I as x,f as H,K as u,V as h,x as A,D as j}from"./index-DnKco_xq.js";import{_ as L}from"./DocSection-cZg6Pyvx.js";const w=`<template>
  <List :items="items" />
</template>
...
<\/script>`,$=g({__name:"ListDoc",setup(d){const o=I(["Apples","Pears","Oranges"]);return(c,y)=>(s(),r(L,{label:"List",code:w},{description:e(()=>[i(" A list groups related content ")]),example:e(()=>[a(t(p),{items:o.value},null,8,["items"])]),_:1}))}}),F=["href"],z=["href"],T=`<template>
  <List>
    <ListItem
      v-for="item in items"
      :key="item.content"
...
<\/script>`,V=g({__name:"ListWithHeaderDescriptionDoc",setup(d){const o=I([{header:"fomantic/Fomantic-UI",description:"Updated 10 mins ago",as:"a"},{header:"fomantic/Fomantic-UI-Docs",description:"Updated 22 mins ago",as:"a"},{header:"fomantic/Fomantic-UI-LESS",description:"Updated 34 mins ago",as:"a"}]);return(c,y)=>(s(),r(L,{code:P},{example:e(()=>[a(t(p),{relaxed:"",divided:""},{default:e(()=>[(s(!0),f(S,null,b(o.value,l=>(s(),r(t(n),{key:l.header},{prepend:e(()=>[a(t(C),{name:"github",size:"large",aligned:"middle"})]),default:e(()=>[a(t(m),{as:"a"},{default:e(()=>[i(_(l.header),1)]),_:2},1024),a(t(v),null,{default:e(()=>[i(_(l.description),1)]),_:2},1024)]),_:2},1024))),128))]),_:1})]),_:1}))}}),B=`<template>
  <SuiList bulleted>
...
</template>`,G={__name:"BulletedDoc",setup(d){return(o,c)=>(s(),r(L,{label:"Bulleted",code:B},{description:e(()=>[i(" A list can mark items with a bullet ")]),example:e(()=>[a(t(p),{bulleted:""},{default:e(()=>[a(t(n),null,{default:e(()=>[i("Gaining Access")]),_:1}),a(t(n),null,{default:e(()=>[i("Inviting Friends")]),_:1}),a(t(n),null,{default:e(()=>[i(" Benefits "),a(t(x),null,{default:e(()=>[a(t(n),null,{default:e(()=>[i("Link to somewhere")]),_:1}),a(t(n),null,{default:e(()=>[i("Rebates")]),_:1}),a(t(n),null,{default:e(()=>[i("Discounts")]),_:1})]),_:1})]),_:1}),a(t(n),null,{default:e(()=>[i("Warranty")]),_:1})]),_:1})]),_:1}))}},R=H("a",null,"Languages",-1),J=`<template>
  <SuiList ordered>
...
</template>`,E={__name:"OrderedDoc",setup(d){return(o,c)=>(s(),r(L,{label:"Ordered",code:J},{description:e(()=>[i(" A list can be ordered numerically ")]),example:e(()=>[a(t(p),{ordered:""},{default:e(()=>[a(t(n),{as:"a"},{default:e(()=>[i("Getting Started")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("Introduction")]),_:1}),a(t(n),null,{default:e(()=>[R,a(t(x),null,{default:e(()=>[a(t(n),{as:"a"},{default:e(()=>[i("HTML")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("Javascript")]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("CSS")]),_:1})]),_:1})]),_:1}),a(t(n),{as:"a"},{default:e(()=>[i("Review")]),_:1})]),_:1})]),_:1}))}},W=`<template>
  <List link>
