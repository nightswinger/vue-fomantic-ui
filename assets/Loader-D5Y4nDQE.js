import{o as l,c as s,w as i,a as t,b as e,u as a,Y as c,S as d,T as r,q as n,D as g}from"./index-B5QC1uZA.js";import{_ as p}from"./DocSection-B6QQW_sQ.js";const _=`<template>
  <SuiSegment>
    <SuiDimmer active>
      <SuiLoader />
    </SuiDimmer>
...
</template>`,k={__name:"SpeedDoc",setup(m){return(o,u)=>(l(),s(p,{label:"Speed",code:A},{description:i(()=>[t(" Loaders can appear slow, normal or fast ")]),example:i(()=>[e(a(r),{slow:"",active:"",inline:""}),e(a(r),{active:"",inline:""}),e(a(r),{fast:"",active:"",inline:""})]),_:1}))}},C=`<template>
...
</template>`,V={__name:"ColorsDoc",setup(m){return(o,u)=>(l(),s(p,{label:"Colors",code:C},{description:i(()=>[t(" Loaders can be different colors ")]),example:i(()=>[e(a(r),{active:"",inline:"",primary:""}),e(a(r),{active:"",inline:"",secondary:""}),e(a(r),{active:"",inline:"",color:"red"}),e(a(r),{active:"",inline:"",color:"orange"}),e(a(r),{active:"",inline:"",color:"yellow"}),e(a(r),{active:"",inline:"",color:"olive"}),e(a(r),{active:"",inline:"",color:"green"}),e(a(r),{active:"",inline:"",color:"teal"}),e(a(r),{active:"",inline:"",color:"blue"}),e(a(r),{active:"",inline:"",color:"violet"}),e(a(r),{active:"",inline:"",color:"purple"}),e(a(r),{active:"",inline:"",color:"pink"}),e(a(r),{active:"",inline:"",color:"brown"}),e(a(r),{active:"",inline:"",color:"grey"}),e(a(r),{active:"",inline:"",color:"black"})]),_:1}))}},T=`<template>
  <SuiSegment>
    <SuiDimmer active>
...
</template>`,P={__name:"SizeDoc",setup(m){return(o,u)=>(l(),s(p,{label:"Size",code:T},{description:i(()=>[t(" Loaders can have different sizes ")]),example:i(()=>[e(a(c),null,{default:i(()=>[e(a(d),{active:""},{default:i(()=>[e(a(r),{text:"",size:"mini"},{default:i(()=>[t("Loading")]),_:1})]),_:1}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),e(a(c),null,{default:i(()=>[e(a(d),{active:""},{default:i(()=>[e(a(r),{text:"",size:"tiny"},{default:i(()=>[t("Loading")]),_:1})]),_:1}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),e(a(c),null,{default:i(()=>[e(a(d),{active:""},{default:i(()=>[e(a(r),{text:"",size:"small"},{default:i(()=>[t("Loading")]),_:1})]),_:1}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),e(a(c),null,{default:i(()=>[e(a(d),{active:""},{default:i(()=>[e(a(r),{text:"",size:"large"},{default:i(()=>[t("Loading")]),_:1})]),_:1}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),e(a(c),null,{default:i(()=>[e(a(d),{active:""},{default:i(()=>[e(a(r),{text:"",size:"big"},{default:i(()=>[t("Loading")]),_:1})]),_:1}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),e(a(c),null,{default:i(()=>[e(a(d),{active:""},{default:i(()=>[e(a(r),{text:"",size:"huge"},{default:i(()=>[t("Loading")]),_:1})]),_:1}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},q=`<template>
  <SuiSegment inverted>
    <SuiLoader active inverted />

    <SuiImage src="/vue-fomantic-ui/images/wireframe/short-paragraph.png" />
  </SuiSegment>
</template>`,B={__name:"InvertedDoc",setup(m){return(o,u)=>(l(),s(p,{label:"Inverted",code:q},{description:i(()=>[t(" Loaders can have their colors inverted. ")]),example:i(()=>[e(a(c),{inverted:""},{default:i(()=>[e(a(r),{active:"",inverted:""}),e(a(n),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},j={__name:"Loader",setup(m){const o=[{id:"loader",label:"Loader",category:"Types",component:S},{id:"text-loader",label:"Text Loader",category:"Types",component:v},{id:"indeterminate",label:"Indeterminate",category:"States",component:L},{id:"active",label:"Active",category:"States",component:w},{id:"disabled",label:"Disabled",category:"States",component:D},{id:"inline",label:"Inline",category:"Variations",component:y},{id:"inline-center",label:"Inline Center",category:"Variations",component:z},{id:"speed",label:"Speed",category:"Variations",component:k},{id:"colors",label:"Colors",category:"Variations",component:V},{id:"size",label:"Size",category:"Variations",component:P},{id:"inverted",label:"Inverted",category:"Variations",component:B}];return(u,F)=>(l(),s(g,{title:"Loader",description:"A loader alerts a user to wait for an activity to complete","component-docs":o}))}};export{j as default};
