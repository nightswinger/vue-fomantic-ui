import{o as s,c as o,w as a,a as d,b as e,u as t,s as n,_ as m,f as p,x as u,d as l,D as _}from"./index-5MvC7eWK.js";const b=p("img",{src:u},null,-1),g=`<template>
...
</template>`,x={__name:"MobileDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Mobile",code:f},{description:a(()=>[d(" An ad can use common mobile ad sizes ")]),example:a(()=>[e(t(n),{unit:"mobile banner",test:"Mobile Banner"}),e(t(n),{unit:"mobile leaderboard",test:"Mobile Leaderboard"})]),_:1}))}},B=`<template>
  <Advertisement unit="medium rectangle" test="Medium Rectangle" />
</template>`,$={__name:"RectangleDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Rectangle",code:B},{description:a(()=>[d(" An ad can use a common rectangle ad unit size ")]),example:a(()=>[e(t(n),{unit:"medium rectangle",test:"Medium Rectangle"})]),_:1}))}},h=`<template>
