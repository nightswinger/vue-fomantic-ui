import{e as v,r as l,o as d,c as m,w as o,a as f,b as n,u as c,aT as h,O as g,d as t,j as b,av as r,D as x}from"./index-1OxQlk_2.js";import{_}from"./DocSection-DUJg2L7o.js";const S=`<template>
...
<\/script>`,N=v({__name:"SidebarPusherDoc",setup(p){const e=l(!1),s=l([{icon:"gamepad",text:"Games"},{icon:"video camera",text:"Channels"},{icon:"video play",text:"Videos"}]);return(u,i)=>(d(),m(_,{code:O},{example:o(()=>[t("div",y,[t("a",{class:"item",onClick:i[0]||(i[0]=a=>e.value=!e.value)},[C,f(" Menu ")])]),n(c(b),{attached:"bottom"},{default:o(()=>[n(c(h),{visible:e.value,"onUpdate:visible":i[1]||(i[1]=a=>e.value=a),items:s.value,icon:"labeled",mountOnBody:!1},null,8,["visible","items"]),t("div",w,[n(c(b),{basic:""},{default:o(()=>[B,$,V,A,D]),_:1})])]),_:1})]),_:1}))}}),G={__name:"Sidebar",setup(p){const e=[{id:"sidebar",label:"Sidebar",category:"Types",component:[k,N]}],s={Sidebar:{props:[{name:"animation",type:"string",default:"overlay",description:"Specifies the animation of the sidebar."},{name:"dimmed",type:"boolean",default:"false",description:"When specified, display the dim inside pusher content."},{name:"direction",type:"string",default:"left",description:"Specifies the direction the sidebar should appear on."},{name:"visible",type:"boolean",default:"false",description:"Specifies the visibility of the sidebar."}],events:[{name:"change",description:"Callback to invoke when checkbox value is changed."},{name:"click",description:"Callback to invoke when checkbox is clicked."}]}};return(u,i)=>(d(),m(x,{title:"Sidebar",description:"A sidebar hides additional content beside a page.","component-docs":e,"api-docs":s}))}};export{G as default};
