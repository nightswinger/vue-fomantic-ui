import{f as s,o as r,c,w as e,a as t,b as i,u as a,E as p,y as _,A as w,B as v,g as n,e as C,a8 as x,z as f,q as l,Y as G,t as b,v as y,D as k}from"./index-DSC_QGPC.js";import{_ as g}from"./DocSection-Dy7AO88P.js";const A=`<template>
  <Grid>
    <GridColumn
      v-for="i in 16"
      :key="i"
...
</template>`,B=s({__name:"ColumnsDoc",setup(u){return(d,m)=>(r(),c(g,{label:"Columns",code:E},{description:e(()=>[t(" Columns each contain gutters giving them equal spacing from other columns ")]),example:e(()=>[i(a(p),null,{default:e(()=>[(r(),_(w,null,v(4,o=>i(a(n),{width:8,key:o},{default:e(()=>[i(a(l),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:2},1024)),64))]),_:1})]),_:1}))}}),P=`<template>
  <Grid>
