import{aK as m,z as h,o as l,c as r,w as t,a,b as i,d as S,r as b,u as f,D as d,a6 as _,e as w,f as k}from"./index-DXf-rKoW.js";import{_ as p}from"./DocSection-C2fGI9ub.js";const B=`<template>
...
<\/script>`,M={__name:"DirectionDoc",setup(u){const{toast:e}=m(),s=()=>{e({horizontal:!0,position:"top left",title:"Watch out!",message:"Next one will open to the right"})};return(o,c)=>{const n=h("SuiButton");return l(),r(p,{label:"Direction",code:F},{description:t(()=>[a(" Toasts can stack horizontal ")]),example:t(()=>[i(n,{onClick:s},{default:t(()=>[a("Show")]),_:1})]),_:1})}}},L=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,O={__name:"CenterAligned",setup(u){const{toast:e}=m(),s=()=>{e({centered:!0,title:"Veronika has joined",message:"Welcome to the Fomantic-UI community!"})};return(o,c)=>{const n=h("SuiButton");return l(),r(p,{label:"Center Aligned",code:L},{description:t(()=>[a(" The toasts content can be shown center aligned. ")]),example:t(()=>[i(n,{onClick:s},{default:t(()=>[a("Show")]),_:1})]),_:1})}}},W=`<template>
...
<\/script>`,N={__name:"MessageStyleDoc",setup(u){const{toast:e}=m(),s=()=>{e({messageStyle:!0,message:"I got my style from the message class",color:"purple"})};return(o,c)=>{const n=h("SuiButton");return l(),r(p,{label:"Use Message Style",code:K},{description:t(()=>[a(" You can use all of the styles and colors from the message component. ")]),example:t(()=>[i(n,{onClick:s},{default:t(()=>[a("Show")]),_:1})]),_:1})}}},z=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,R={__name:"IncreasingProgressBarDoc",setup(u){const{toast:e}=m(),s=()=>{e({title:"LOOK",message:"See, how long i will last",showProgress:"top",showProgressUp:!0})};return(o,c)=>{const n=h("SuiButton");return l(),r(p,{label:"Increasing Progress Bar",code:z},{description:t(()=>[a(" You can use the progress bar to show the progress of a task. ")]),example:t(()=>[i(n,{onClick:s},{default:t(()=>[a("Show")]),_:1})]),_:1})}}},G=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,ct={__name:"ActionVerticalAttachedDoc",setup(u){const{toast:e}=m(),s=()=>{e({message:"Do you really want to star Fomantic-UI?",displayTime:0,color:"black",actions:({close:o})=>[_(d,{color:"green",onclick:()=>{e({message:'You clicked "yes", toast closes by default'}),o()}},()=>"Yes, really"),_(d,{color:"red",onclick:()=>{e({message:'You clicked "maybe", toast closes by default'}),o()}},()=>"Maybe later")],actionsProps:{attached:"left",vertical:!0}})};return(o,c)=>(l(),r(p,{label:"Vertical Attached",code:at},{description:t(()=>[a(" Vertical actions can also be displayed as button groups using vertical attached."),st,a(" Vertical attached actions also support left. ")]),example:t(()=>[i(f(d),{onClick:s},{default:t(()=>[a("Show")]),_:1})]),_:1}))}},lt={__name:"Toast",setup(u){const e=[{id:"minimal",label:"Minimal",category:"Types",component:v},{id:"titled",label:"Titled",category:"Types",component:x},{id:"progress-bar",label:"Progress Bar",category:"Types",component:C},{id:"toast-type",label:"Toast Type",category:"Variations",component:D},{id:"position",label:"Position",category:"Variations",component:P},{id:"attached-position",label:"Attached Position",category:"Variations",component:U},{id:"direction",label:"Direction",category:"Variations",component:M},{id:"center-aligned",label:"Center Aligned",category:"Variations",component:O},{id:"duration",label:"Duration",category:"Variations",component:j},{id:"message-style",label:"Use Message Style",category:"Variations",component:N},{id:"increasing-progress-bar",label:"Increasing Progress Bar",category:"Variations",component:R},{id:"color-variants",label:"Color Variants",category:"Variations",component:E},{id:"inverted-colors",label:"Inverted Colors",category:"Variations",component:H},{id:"general",label:"General",category:"Actions",component:q},{id:"action-basic",label:"Basic",category:"Actions",component:X},{id:"action-attached",label:"Attached",category:"Actions",component:tt},{id:"action-vertical",label:"Vertical",category:"Actions",component:et},{id:"action-vertical-attached",label:"Vertical Attached",category:"Actions",component:ct}];return(s,o)=>(l(),r(k,{title:"Toast",description:"A toast allows users to be notified of an event","component-docs":e}))}};export{lt as default};
