import{o as s,c as o,w as a,a as d,b as e,u as t,y as n,_ as m,e as p,q as u,d as l,D as _}from"./index-_NJh6V5r.js";const b=p("img",{src:u},null,-1),g=`<template>
...
</template>`,q=l({__name:"CenteredDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Centered",code:V},{description:a(()=>[d(" An advertisement can appear centered ")]),example:a(()=>[e(t(n),{centered:"",unit:"banner",test:"Centered"})]),_:1}))}}),w=`<template>
  <Advertisement centered unit="banner" test="Centered" />
</template>`,H=l({__name:"TestDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Test",code:w},{description:a(()=>[d(" A advertisement can be formatted to help verify placement ")]),example:a(()=>[e(t(n),{unit:"medium rectangle",test:"Ad Unit 1"})]),_:1}))}}),j={__name:"Advertisement",setup(c){const r=[{id:"ad",label:"Ad",category:"Types",component:A},{id:"common-units",label:"Common Units",category:"Types",component:v},{id:"mobile",label:"Mobile",category:"Types",component:B},{id:"rectangle",label:"Rectangle",category:"Types",component:$},{id:"button",label:"Button",category:"Types",component:T},{id:"skyscraper",label:"Skyscraper",category:"Types",component:L},{id:"banner",label:"Banner",category:"Types",component:C},{id:"leaderboards",label:"Leaderboards",category:"Types",component:S},{id:"panorama",label:"Panorama",category:"Types",component:R},{id:"netboard",label:"Netboard",category:"Types",component:P},{id:"centered",label:"Centered",category:"Variations",component:q},{id:"test",label:"Test",category:"Variations",component:H}];return(i,U)=>(s(),o(_,{title:"Advertisement",description:"An ad displays third-party promotional content","component-docs":r}))}};export{j as default};
