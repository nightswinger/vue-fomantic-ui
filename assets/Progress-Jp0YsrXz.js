import{f as i,r as _,o as n,c,w as t,a as g,b as e,u as r,N as o,$ as u,_ as d,p as v,d as b,D as P}from"./index-Ygle4ekK.js";const f=`<template>
...
const value = ref(10)
<\/script>`,y=i({__name:"IndicatingDoc",setup(l){const s=_(10);return(a,p)=>(n(),c(d,{label:"Indicating",code:$},{description:t(()=>[g(" An indicating progress bar visually indicates the current level of progress of a task ")]),example:t(()=>[e(r(o),{indicating:"",progress:"",percent:s.value,label:`${s.value}% Funded`},null,8,["percent","label"]),e(r(u),{icon:"minus",onClick:p[0]||(p[0]=m=>s.value-=10)}),e(r(u),{icon:"plus",onClick:p[1]||(p[1]=m=>s.value+=10)})]),_:1}))}}),h=`<template>
  <Progress :percent="33" />
...
</template>`,A=i({__name:"CenteredProgressTextDoc",setup(l){return(s,a)=>(n(),c(d,{label:"Centered Progress Text",code:C},{description:t(()=>[g(" The text inside a progress can be centered ")]),example:t(()=>[e(r(o),{progress:"centered",percent:57})]),_:1}))}}),D=`<template>
