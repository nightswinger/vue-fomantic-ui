import{R as h,r as p,o as r,c as m,w as a,a as c,b as t,u as e,ac as u,ad as n,x as D,h as T,n as S,d,t as N,a1 as x,D as A,e as _,ae as y,a4 as R,X as k,Z as w,a0 as j,f as E}from"./index-DXf-rKoW.js";import{_ as g}from"./DocSection-C2fGI9ub.js";const $={class:"content"},P={class:"sub header"},q=`<template>
...
<\/script>`,Z=h({__name:"ErrorDoc",setup(f){const o=p([{name:"No Name Specified",status:"Approved",notes:"None"},{name:"Jimmy",status:"Cannot pull data",notes:"None"},{name:"Jamie",status:"Approved",notes:"Classified"},{name:"Jill",status:"Approved",notes:"None"}]),i=({data:s})=>s.name==="Jimmy",l=({value:s})=>s==="Classified";return(s,b)=>(r(),m(g,{label:"Error",code:Y},{description:a(()=>[c(" A cell or row may call attention to an error or a negative value ")]),example:a(()=>[t(e(u),{celled:"",items:o.value,rowError:i},{default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status"}),t(e(n),{field:"notes",header:"Notes",error:l},{body:a(({data:v})=>[v.notes==="Classified"?(r(),m(e(_),{key:0,name:"attention"})):y("",!0),c(" "+N(v.notes),1)]),_:1})]),_:1},8,["items"])]),_:1}))}}),O=`<template>
  <Table
    celled
    :items="items"
...
<\/script>`,K=h({__name:"WarningDoc",setup(f){const o=p([{name:"No Name Specified",status:"Unknown",notes:"None"},{name:"Jimmy",status:"Requires Action",notes:"None"},{name:"Jamie",status:"Unknown",notes:"Hostile"},{name:"Jill",status:"Unknown",notes:"None"}]),i=({data:s})=>s.name==="Jimmy",l=({value:s})=>s==="Hostile";return(s,b)=>(r(),m(g,{label:"Warning",code:O},{description:a(()=>[c(" A cell or row may warn a user ")]),example:a(()=>[t(e(u),{celled:"",items:o.value,rowWarning:i},{default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status"},{body:a(({data:v})=>[v.status==="Requires Action"?(r(),m(e(_),{key:0,name:"attention"})):y("",!0),c(" "+N(v.status),1)]),_:1}),t(e(n),{field:"notes",header:"Notes",warning:l},{body:a(({data:v})=>[v.notes==="Hostile"?(r(),m(e(_),{key:0,name:"attention"})):y("",!0),c(" "+N(v.notes),1)]),_:1})]),_:1},8,["items"])]),_:1}))}}),X=`<template>
  <Table
    celled
    :items="items"
    :rowActive="rowActive"
...
<\/script>`,Q=h({__name:"ActiveDoc",setup(f){const o=p([{name:"Jamie",status:"Approved",notes:"Requires call"},{name:"John",status:"Requires Action",notes:"None"},{name:"Jamie",status:"Approved",notes:"Requires call"},{name:"Jill",status:"Approved",notes:"None"}]),i=({data:s})=>s.name==="John",l=({value:s})=>s==="Jill";return(s,b)=>(r(),m(g,{label:"Active",code:X},{description:a(()=>[c(" A cell or row can be active or selected by a user ")]),example:a(()=>[t(e(u),{celled:"",items:o.value,rowActive:i},{default:a(()=>[t(e(n),{field:"name",header:"Name",active:l}),t(e(n),{field:"status",header:"Status"}),t(e(n),{field:"notes",header:"Notes"})]),_:1},8,["items"])]),_:1}))}}),ee=`<template>
  <Table
    celled
    :items="items"
...
<\/script>`,Ke=h({__name:"PaddedDoc",setup(f){const o=p([{name:"John",status:"Approved",notes:"He is a very nice guy and I enjoyed talking to him on the telephone. I hope we get to talk again."},{name:"Jamie",status:"Approved",notes:"Jamie was not interested in purchasing our product."}]);return(i,l)=>(r(),m(g,{label:"Padded",code:Oe},{description:a(()=>[c(" A table may sometimes need to be more padded for legibility ")]),example:a(()=>[t(e(u),{padded:"",items:o.value},{default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status"}),t(e(n),{field:"notes",header:"Notes"})]),_:1},8,["items"])]),_:1}))}}),Xe=`<template>
  <Table
    padded="very"
    :items="items"
  >
...
<\/script>`,Qe=h({__name:"PaddedVeryDoc",setup(f){const o=p([{name:"John",status:"Approved",notes:"He is a very nice guy and I enjoyed talking to him on the telephone. I hope we get to talk again."},{name:"Jamie",status:"Approved",notes:"Jamie was not interested in purchasing our product."}]);return(i,l)=>(r(),m(g,{code:Xe},{example:a(()=>[t(e(u),{padded:"very",items:o.value},{default:a(()=>[t(e(n),{field:"name",header:"Name"}),t(e(n),{field:"status",header:"Status"}),t(e(n),{field:"notes",header:"Notes"})]),_:1},8,["items"])]),_:1}))}}),et=`<template>
  <Table
    compact
    :items="items"
  >
