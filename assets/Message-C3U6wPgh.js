import{o as i,c as r,w as a,a as s,b as e,u as t,a8 as o,O as d,e as p,y as u,k as h,a6 as _,l as g,a5 as b,D as y,d as f,f as w}from"./index-BtqR3fgc.js";import{_ as m}from"./DocSection-Bplbrfto.js";const v=`<template>
  <Message
  ...
  <Message
    ...
    closable
  />
</template>`,E=d({__name:"InfoDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Info",code:U},{description:a(()=>[s(" A message may be formatted to display information. ")]),example:a(()=>[e(t(o),{info:"",header:"Was this what you wanted?",list:["It's good to see you again.","Did you know it's been a while?"],closable:""},null,8,["list"])]),_:1}))}}),R=`<template>
  <Message
    positive
