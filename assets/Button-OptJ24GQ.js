import{r as b,o as c,c as l,w as t,a as i,b as e,u as o,C as n,t as g,U as p,K as _,X as m,L as f,B as d,d as B,e as v,D as h}from"./index-BLRrc4sh.js";import{_ as s}from"./DocSection-Da03Tz-a.js";const y=`<template>
...
</template>`,D={__name:"LabeledIconDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Labeled Icon",code:L},{description:t(()=>[i(" A button can use an icon as a label ")]),example:t(()=>[e(o(n),{labeled:"",icon:"pause",content:"Pause"}),e(o(n),{labeled:"right",icon:"right arrow",content:"Next"}),e(o(n),{labeled:"",icon:""},{default:t(()=>[e(o(_),{loading:"",name:"spinner"}),i(" Loading ")]),_:1})]),_:1}))}},P=`<template>
...
</template>`,j={__name:"ConditionalsDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Conditionals",code:W},{description:t(()=>[i(" Button groups can contain conditionals ")]),example:t(()=>[e(o(d),null,{default:t(()=>[e(o(n),{content:"Cancel"}),H,e(o(n),{content:"Save",positive:""})]),_:1}),e(o(d),null,{default:t(()=>[e(o(n),{content:"un"}),Y,e(o(n),{content:"deux",positive:""})]),_:1})]),_:1}))}},K=`<template>
  <SuiButton active icon="user" content=" Follow" />
</template>`,U={__name:"ActiveDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Active",code:K},{description:t(()=>[i(" A button can show it is currently the active user selection ")]),example:t(()=>[e(o(n),{active:"",icon:"user",content:" Follow"})]),_:1}))}},X=`<template>
  <SuiButton disabled icon="user" content=" Followed" />
</template>`,J={__name:"DisabledDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Disabled",code:X},{description:t(()=>[i(" A button can show it is currently unable to be interacted with ")]),example:t(()=>[e(o(n),{disabled:"",icon:"user",content:" Followed"})]),_:1}))}},Q=`<template>
...
</template>`,Z={__name:"LoadingDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Loading",code:Q},{description:t(()=>[i(" A button can show a loading indicator ")]),example:t(()=>[e(o(n),{loading:"",content:"Loading"}),e(o(n),{loading:"double",primary:"",content:"Loading"}),e(o(n),{loading:"elastic",secondary:"",content:"Loading"})]),_:1}))}},tt=`<template>
...
</template>`,Nt={__name:"GroupSizesDoc",setup(r){return(a,u)=>(c(),l(s,{label:"Group Sizes",code:qt},{description:t(()=>[i(" Groups can have a shared color ")]),example:t(()=>[e(o(d),{size:"large"},{default:t(()=>[e(o(n),null,{default:t(()=>[i("One")]),_:1}),e(o(n),null,{default:t(()=>[i("Two")]),_:1}),e(o(n),null,{default:t(()=>[i("Three")]),_:1})]),_:1})]),_:1}))}},Ht={__name:"Button",setup(r){const a=[{id:"button",label:"Button",category:"Types",component:x},{id:"emphasis",label:"Emphasis",category:"Types",component:k},{id:"animated",label:"Animated",category:"Types",component:G},{id:"labeled",label:"Labeled",category:"Types",component:C},{id:"icon",label:"Icon",category:"Types",component:V},{id:"labeled-icon",label:"Labeled Icon",category:"Types",component:D},{id:"basic",label:"Basic",category:"Types",component:z},{id:"tertiary",label:"Tertiary",category:"Types",component:O},{id:"inverted",label:"Inverted",category:"Types",component:q},{id:"buttons",label:"Buttons",category:"Groups",component:M},{id:"icon-buttons",label:"Icon Buttons",category:"Groups",component:R},{id:"content",label:"Content",category:"Content",component:j},{id:"active",label:"Active",category:"States",component:U},{id:"disabled",label:"Disabled",category:"States",component:J},{id:"loading",label:"Loading",category:"States",component:Z},{id:"social",label:"Social",category:"Variations",component:et},{id:"size",label:"Size",category:"Variations",component:nt},{id:"floated",label:"Floated",category:"Variations",component:at},{id:"colored",label:"Colored",category:"Variations",component:ct},{id:"compact",label:"Compact",category:"Variations",component:rt},{id:"toggle",label:"Toggle",category:"Variations",component:dt},{id:"positive",label:"Positive",category:"Variations",component:_t},{id:"negative",label:"Negative",category:"Variations",component:Bt},{id:"fluid",label:"Fluid",category:"Variations",component:bt},{id:"circular",label:"Circular",category:"Variations",component:gt},{id:"vertically-attached",label:"Vertically Attached",category:"Variations",component:yt},{id:"horizontally-attached",label:"Horizontally Attached",category:"Variations",component:wt},{id:"vertical-buttons",label:"Vertical Buttons",category:"Group Variations",component:$t},{id:"stackable-buttons",label:"Stackable Buttons",category:"Group Variations",component:Tt},{id:"labeled-icon-buttons",label:"Labeled Icon Buttons",category:"Group Variations",component:At},{id:"mixed-group",label:"Mixed Group",category:"Group Variations",component:Lt},{id:"equal-width",label:"Equal Width",category:"Group Variations",component:Pt},{id:"colored-buttons",label:"Colored Buttons",category:"Group Variations",component:Ft},{id:"basic-buttons",label:"Basic Buttons",category:"Group Variations",component:It},{id:"group-sizes",label:"Group Sizes",category:"Group Variations",component:Nt}];return(u,S)=>(c(),l(h,{title:"Button",description:"A button indicates a possible user action","component-docs":a}))}};export{Ht as default};
