import{o as d,c as n,w as e,a,b as t,u as r,h as o,e as _,q as m,s as h,d as p,n as H,y as u,f as S}from"./index-DqtkPo3d.js";import{_ as s}from"./DocSection-hLonYMiG.js";const f=`<template>
...
</template>`,F={__name:"SubheaderDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Subheader",code:T},{description:e(()=>[a(" Headers may contain subheaders ")]),example:e(()=>[t(r(o),{as:"h2"},{default:e(()=>[a(" Account Settings "),t(r(h),null,{default:e(()=>[a(" Manage your account settings and set e-mail preferences. ")]),_:1})]),_:1})]),_:1}))}},I=`<template>
  <SuiHeader disabled>
    Disabled Header
  </SuiHeader>
