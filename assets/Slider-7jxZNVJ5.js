import{f as u,r as d,o,c as n,w as a,a as i,b as v,u as s,aU as p,t as _,Y as V,y as g,A as S,B as y,D as x}from"./index-DSC_QGPC.js";import{_ as m}from"./DocSection-Dy7AO88P.js";const k=`<template>
...
const value = ref(6)
<\/script>`,D=u({__name:"LabeledTickedSliderDoc",setup(c){const e=d(6);return(r,l)=>(o(),n(m,{label:"Labeled Ticked Slider",code:A},{description:a(()=>[i(" A slider that show its labels and ticks ")]),example:a(()=>[v(s(p),{labeled:"ticked",modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t)},null,8,["modelValue"])]),_:1}))}}),U=`<template>
  <Slider
    v-model="value"
    labeled="ticked"
...
const value = ref()
<\/script>`,z=u({__name:"CustomInterpretedLabelsDoc",setup(c){const e=d();return(r,l)=>(o(),n(m,{label:"Custom Interpreted Labels",code:U},{description:a(()=>[i(" You can provide a function which returns a custom label according to the label value ")]),example:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),labeled:"ticked",labels:["α","β","γ","δ","ε","ζ","η","θ","ι","κ","λ","μ","ν","ξ","ο","π","ρ","σ/ς","τ","υ","φ"],max:20},null,8,["modelValue"])]),_:1}))}}),C=`<template>
...
const value = ref(40)
<\/script>`,L=u({__name:"StepDoc",setup(c){const e=d(40);return(r,l)=>(o(),n(m,{label:"Step",code:C},{description:a(()=>[i(" A slider can change the default step increment ")]),example:a(()=>[v(s(p),{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=t=>e.value=t),labeled:"",step:5,max:120,min:20},null,8,["modelValue"])]),_:1}))}}),T=`<template>
  <Slider
    v-model="value"
    range
    labeled="ticked"
