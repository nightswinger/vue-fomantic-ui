import{e as d,r as m,o as c,c as s,w as o,a as i,b as n,u as r,ac as x,B as g,C as b,D as f}from"./index-B2sz39O7.js";import{_ as v}from"./DocSection-LsN_yblw.js";const h=`<template>
  <Dropdown
    v-model="selected"
    text="File"
    :options="options"
...
<\/script>`,H=d({__name:"FloatingDoc",setup(u){const e=m(),l=[{text:"Edit Post",icon:"edit"},{text:"Remove Post",icon:"delete"},{text:"Hide Post",icon:"hide"}];return(p,t)=>(c(),s(v,{label:"Floating",code:$},{description:o(()=>[i(" A dropdown menu can appear to be floating below an element ")]),example:o(()=>[n(r(g),{color:"teal"},{default:o(()=>[n(r(b),null,{default:o(()=>[i("Save")]),_:1}),n(r(x),{modelValue:e.value,"onUpdate:modelValue":t[0]||(t[0]=a=>e.value=a),options:l,button:"",icon:"dropdown",floating:""},null,8,["modelValue"])]),_:1})]),_:1}))}}),G={__name:"Dropdown",setup(u){const e=[{id:"dropdown",label:"Dropdown",category:"Types",component:_},{id:"selection",label:"Selection",category:"Types",component:w},{id:"search-selection",label:"Search Selection",category:"Types",component:y},{id:"clearable-selection",label:"Clearable Selection",category:"Types",component:P},{id:"multiple-selection",label:"Multiple Selection",category:"Types",component:V},{id:"search-dropdown",label:"Search Dropdown",category:"Types",component:F},{id:"search-in-menu",label:"Search In-Menu",category:"Types",component:I},{id:"inline",label:"Inline",category:"Types",component:k},{id:"pointing",label:"Pointing",category:"Types",component:U},{id:"floating",label:"Floating",category:"Types",component:H}];return(l,p)=>(c(),s(f,{title:"Dropdown",description:"A dropdown allows a user to select a value from a series of options","component-docs":e}))}};export{G as default};
