import{g as p,r as d,o as a,c as s,w as t,a as m,b as i,u as l,aU as g,H as r,I as f,K as _,A as b,D as R}from"./index-3N8A7B9S.js";import{_ as v}from"./DocSection-DqOV4wTl.js";const x=`<template>
...
<\/script>`,I=p({__name:"SizeDoc",setup(u){const o=d(["mini","tiny","small","medium","large","huge","massive"]);return(c,n)=>(a(),s(v,{label:"Size",code:T},{description:t(()=>[m(" A rating can vary in size ")]),example:t(()=>[(a(!0),r(f,null,_(o.value,e=>(a(),r("div",{key:e},[i(l(g),{size:e,defaultRating:3,maxRating:4,color:"yellow"},null,8,["size"]),i(l(b),{hidden:""})]))),128))]),_:1}))}}),U={__name:"Rating",setup(u){const o=[{id:"rating",label:"Rating",category:"Types",component:h},{id:"icon",label:"Icon",category:"Types",component:w},{id:"color",label:"Color",category:"Types",component:z},{id:"partial-ratings",label:"Partial Ratings",category:"Types",component:A},{id:"disabled",label:"Disabled",category:"States",component:C},{id:"size",label:"Size",category:"Variations",component:I}],c={Rating:{props:[{name:"color",type:"string",default:"",description:"A rating can have different colors"},{name:"defaultRating",type:"number",default:0,description:"The initial value of rating."},{name:"disabled",type:"boolean",default:!1,description:"When present, it specifies that the component should be disabled."},{name:"icon",type:"string",default:"star",description:"A rating can use a set of specified icons."},{name:"maxRating",type:"number",default:1,description:"The total number of icons."},{name:"modelValue",type:"number",default:"null",description:"A value of rating."},{name:"size",type:"string",default:"",description:"A rating can have different sizes."}],events:[{name:"change",description:"Callback to invoke on value change."}]}};return(n,e)=>(a(),s(R,{title:"Rating",description:"A rating indicates user interest in content","component-docs":o,"api-docs":c}))}};export{U as default};
