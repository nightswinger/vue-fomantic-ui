import{f as h,r as p,o as r,c as m,w as a,a as c,b as t,u as e,ae as u,af as n,j as D,N as T,q as S,e as d,t as N,a4 as x,O as A,U as _,ag as y,a7 as R,y as k,A as j,B as w,D as E}from"./index-DSC_QGPC.js";import{_ as g}from"./DocSection-Dy7AO88P.js";const $={class:"content"},P={class:"sub header"},q=`<template>
...
<\/script>`,Oe=h({__name:"InvertedColoredDoc",setup(f){const o=p([{food:"Apple",calories:200,protein:"0g"},{food:"Orange",calories:62,protein:"0g"}]),i=["red","orange","yellow","olive","green","teal","blue","violet","purple","pink","brown","grey","black"];return(l,s)=>(r(),m(g,{code:Ye},{example:a(()=>[(r(),k(j,null,w(i,b=>t(e(u),{color:b,key:b,inverted:"",items:o.value},{default:a(()=>[t(e(n),{field:"food",header:"Food"}),t(e(n),{field:"calories",header:"Calories"}),t(e(n),{field:"protein",header:"Protein"})]),_:2},1032,["color","items"])),64))]),_:1}))}}),Ze=`<template>
  <Table
    padded
    :items="items"
  >
