import{o as d,c as n,w as e,a,b as t,u as r,N as o,U as _,l as m,C as p,e as h,q as H,Y as u,D as S}from"./index-DSC_QGPC.js";import{_ as s}from"./DocSection-Dy7AO88P.js";const f=`<template>
...
</template>`,y={__name:"IconHeadersDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Icon Headers",code:x},{description:e(()=>[a(" A header can be formatted to emphasize an icon ")]),example:e(()=>[t(r(o),{icon:""},{default:e(()=>[t(r(_),{name:"settings"}),t(r(m),null,{default:e(()=>[a(" Account Settings ")]),_:1}),t(r(p),null,{default:e(()=>[a(" Manage your account settings and set e-mail preferences. ")]),_:1})]),_:1})]),_:1}))}},A=h("span",null,"$10.99",-1),$=`<template>
...
</template>`,k={__name:"ImageDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Image",code:w},{description:e(()=>[a(" A header may contain an image ")]),example:e(()=>[t(r(o),{as:"h2"},{default:e(()=>[t(r(H),{src:"/vue-fomantic-ui/images/avatar/large/steve.jpg",avatar:""}),a(" Steve ")]),_:1})]),_:1}))}},C=`<template>
  <SuiHeader as="h2">
    <SuiIcon name="plug" />
    <SuiHeaderContent>
      Uptime Guarantee
...
</template>`,B={__name:"IconDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Icon",code:C},{description:e(()=>[a(" A header may contain an Icon ")]),example:e(()=>[t(r(o),{as:"h2"},{default:e(()=>[t(r(_),{name:"plug"}),t(r(m),null,{default:e(()=>[a(" Uptime Guarantee ")]),_:1})]),_:1})]),_:1}))}},T=`<template>
  <SuiHeader as="h2">
    Account Settings
    <SuiHeaderSubheader>
      Manage your account settings and set e-mail preferences.
...
</template>`,F={__name:"SubheaderDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Subheader",code:T},{description:e(()=>[a(" Headers may contain subheaders ")]),example:e(()=>[t(r(o),{as:"h2"},{default:e(()=>[a(" Account Settings "),t(r(p),null,{default:e(()=>[a(" Manage your account settings and set e-mail preferences. ")]),_:1})]),_:1})]),_:1}))}},I=`<template>
  <SuiHeader disabled>
    Disabled Header
  </SuiHeader>
</template>`,P={__name:"DisabledDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Disabled",code:I},{description:e(()=>[a(" A header can show that it is inactive ")]),example:e(()=>[t(r(o),{disabled:""},{default:e(()=>[a(" Disabled Header ")]),_:1})]),_:1}))}},G=`<template>
  <SuiHeader as="h3" dividing>
    Dividing Header
  </SuiHeader>
</template>`,V={__name:"DividingDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Dividing",code:G},{description:e(()=>[a(" A header can be formatted to divide itself from the content below it ")]),example:e(()=>[t(r(o),{as:"h3",dividing:""},{default:e(()=>[a(" Dividing Header ")]),_:1})]),_:1}))}},z=`<template>
  <SuiHeader as="h3" block>
    Block Header
  </SuiHeader>
</template>`,q={__name:"BlockDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Block",code:z},{description:e(()=>[a(" A header can be formatted to appear inside a content block ")]),example:e(()=>[t(r(o),{as:"h3",block:""},{default:e(()=>[a(" Block Header ")]),_:1})]),_:1}))}},O=`<template>
...
</template>`,Y={__name:"AttachedDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Attached",code:O},{description:e(()=>[a(" A header can be attached to other content, like a segment ")]),example:e(()=>[t(r(o),{as:"h2",attached:"top"},{default:e(()=>[a(" Attached Header ")]),_:1}),t(r(u),{attached:""},{default:e(()=>[a(" Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ")]),_:1})]),_:1}))}},L=`<template>
  <SuiSegment clearing>
...
</template>`,M={__name:"FloatingDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Floating",code:L},{description:e(()=>[a(" A header can sit to the left or right of other content ")]),example:e(()=>[t(r(u),{clearing:""},{default:e(()=>[t(r(o),{as:"h3",floated:"right"},{default:e(()=>[a(" Go Forward ")]),_:1}),t(r(o),{as:"h3",floated:"left"},{default:e(()=>[a(" Go Back ")]),_:1})]),_:1})]),_:1}))}},R=`<template>
  <SuiSegment>
...
</template>`,N={__name:"TextAlignmentDoc",setup(l){return(i,c)=>(d(),n(s,{label:"Text Alignment",code:R},{description:e(()=>[a(" A header can have its text aligned to a side ")]),example:e(()=>[t(r(u),null,{default:e(()=>[t(r(o),{as:"h3",textAlign:"right"},{default:e(()=>[a("Float Right")]),_:1}),t(r(o),{as:"h3",textAlign:"left"},{default:e(()=>[a("Float Left")]),_:1}),t(r(o),{as:"h3",textAlign:"justified"},{default:e(()=>[a(" This text takes up the full width of the container ")]),_:1}),t(r(o),{as:"h3",textAlign:"center"},{default:e(()=>[a("Centered")]),_:1})]),_:1})]),_:1}))}},U=`<template>
