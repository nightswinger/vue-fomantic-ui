import{e as g,o as n,c as l,w as e,a as r,b as t,u as a,aj as d,z as c,ak as i,d as o,K as k,Y as D,r as h,al as v,p as y,F as w,s as b,t as f,B as F,C as x,am as j,R as A,an as M,ao as $,V as I,f as G,L as E,D as V}from"./index-B2sz39O7.js";import{_}from"./DocSection-LsN_yblw.js";const N=o("span",null,"Joined in 2013",-1),B=o("span",{class:"right floated"},"14h",-1),H={class:"right floated"},J=`<template>
  <Card>
...
</template>`,Ve=g({__name:"LinkCardDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Link Card",code:Ee},{description:e(()=>[r(" A card can be formatted so that the entire contents link to another page ")]),example:e(()=>[t(a(d),{href:"https://dog.com"},{default:e(()=>[t(a(i),{header:"Cute Dog"},{meta:e(()=>[Fe,je]),description:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(i),{extra:""},{default:e(()=>[o("div",Ae,[t(a(c),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1}),t(a(d),{link:""},{default:e(()=>[t(a(i),{header:"Cute Dog"},{meta:e(()=>[Me,Ie]),description:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(i),{extra:""},{default:e(()=>[o("div",Ge,[t(a(c),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1})]),_:1}))}}),Ne=o("span",{class:"right floated"},"2 days ago",-1),Be={class:"right floated"},He=`<template>
  <Card>
    <CardContent header="Cute Dog">
      <template #meta>
