import{o as i,c as r,w as a,a as s,b as e,u as t,a7 as o,e as d,U as p,j as u,g as h,a5 as _,V as g,a4 as b,O as y,d as f,D as w}from"./index-1OxQlk_2.js";import{_ as m}from"./DocSection-DUJg2L7o.js";const v=`<template>
  <Message
  ...
  />
</template>`,V=d({__name:"DismissableBlockDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Dismissable Block",code:A},{description:a(()=>[s(" A message that the user can choose to hide ")]),example:a(()=>[e(t(o),{header:"Welcome back!",content:"This is a special notification which you can dismiss if you're bored with it.",closable:"",onClose:n[0]||(n[0]=()=>console.log("Message closed"))})]),_:1}))}}),D=`<template>
  <Message
    hidden
    content="You can't see me"
  />
</template>`,W=d({__name:"HiddenDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Hidden",code:D},{description:a(()=>[s(" A message can be hidden ")]),example:a(()=>[e(t(o),{hidden:"",content:"You can't see me"})]),_:1}))}}),k=`<template>
  <Message
    visible
  ...
  />
</template>`,I=d({__name:"CompactDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Compact",code:B},{description:a(()=>[s(" A message can only take up the width of its content. ")]),example:a(()=>[e(t(o),{compact:"",content:"Get all the best inventions in your e-mail every day. Sign up now!"})]),_:1}))}}),G=f("a",{href:"#"},"Login here",-1),P=`<template>
  <Message
    attached
...
</template>`,L=d({__name:"AttachedDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Attached",code:P},{description:a(()=>[s(" A message can be formatted to attach itself to other content ")]),example:a(()=>[e(t(o),{attached:"",header:"Welcome to our site!",content:"Fill out the form below to sign-up for a new account"}),e(t(u),{attached:""},{default:a(()=>[e(t(h),null,{default:a(()=>[e(t(_),{widths:"equal"},{default:a(()=>[e(t(g),{label:"First Name",placeholder:"First Name"}),e(t(g),{label:"Last Name",placeholder:"Last Name"})]),_:1}),e(t(g),{label:"Username",placeholder:"Username"}),e(t(g),{label:"Password",type:"password",placeholder:"Password"}),e(t(g),null,{default:a(()=>[e(t(b),{label:"I agree to the Terms and Conditions"})]),_:1}),e(t(y),{primary:""},{default:a(()=>[s("Submit")]),_:1})]),_:1})]),_:1}),e(t(o),{warning:"",attached:"bottom"},{default:a(()=>[e(t(p),{name:"help"}),s(" Already signed up? "),G,s(" instead. ")]),_:1})]),_:1}))}}),O=`<template>
  <Message
    warning
    ...
    closable
  />
</template>`,H=d({__name:"WarningDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Warning",code:O},{description:a(()=>[s(" A message may be formatted to display warning messages. ")]),example:a(()=>[e(t(o),{warning:"",header:"You must register before you can do that!",content:"Visit our registration page, then try again",closable:""})]),_:1}))}}),U=`<template>
  <Message
    info
    ...
    closable
  />
</template>`,E=d({__name:"InfoDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Info",code:U},{description:a(()=>[s(" A message may be formatted to display information. ")]),example:a(()=>[e(t(o),{info:"",header:"Was this what you wanted?",list:["It's good to see you again.","Did you know it's been a while?"],closable:""},null,8,["list"])]),_:1}))}}),j=`<template>
  <Message
    positive
  ...
  <Message
    ...
    closable
  />
</template>`,q=d({__name:"PositiveSuccessDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Positive / Success",code:j},{description:a(()=>[s(" A message may be formatted to display a positive message. ")]),example:a(()=>[e(t(o),{positive:"",header:"You are eligible for a reward",content:"Go to your special offers page to see now.",closable:""}),e(t(o),{success:"",header:"Your user registration was successful.",content:"You may now log-in with the username you have chosen",closable:""})]),_:1}))}}),J=`<template>
  <Message
    negative
...
</template>`,Z=d({__name:"SizeDoc",setup(l){return(c,n)=>(i(),r(m,{label:"Size",code:X},{description:a(()=>[s(" A message can have different sizes ")]),example:a(()=>[e(t(o),{size:"mini",content:"This is a mini message."}),e(t(o),{size:"tiny",content:"This is a tiny message."}),e(t(o),{size:"small",content:"This is a small message."}),e(t(o),{size:"large",content:"This is a large message."}),e(t(o),{size:"big",content:"This is a big message."}),e(t(o),{size:"huge",content:"This is a huge message."}),e(t(o),{size:"massive",content:"This is a massive message."})]),_:1}))}}),ae={__name:"Message",setup(l){const c=[{id:"message",label:"Message",category:"Types",component:M},{id:"list-message",label:"List Message",category:"Types",component:$},{id:"icon-message",label:"Icon Message",category:"Types",component:F},{id:"dismissable-block",label:"Dismissable Block",category:"Types",component:V},{id:"hidden",label:"Hidden",category:"States",component:W},{id:"visible",label:"Visible",category:"States",component:N},{id:"aligned",label:"Aligned",category:"Variations",component:z},{id:"floating",label:"Floating",category:"Variations",component:C},{id:"compact",label:"Compact",category:"Variations",component:I},{id:"attached",label:"Attached",category:"Variations",component:L},{id:"warning",label:"Warning",category:"Variations",component:H},{id:"info",label:"Info",category:"Variations",component:E},{id:"positive-success",label:"Positive / Success",category:"Variations",component:q},{id:"negative-error",label:"Negative / Error",category:"Variations",component:R},{id:"colored",label:"Colored",category:"Variations",component:Q},{id:"size",label:"Size",category:"Variations",component:Z}];return(n,ee)=>(i(),r(w,{title:"Message",description:"A message displays information that explains nearby content","component-docs":c}))}};export{ae as default};
