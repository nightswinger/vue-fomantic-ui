import{o as s,c as o,w as a,a as d,b as e,u as t,aj as n,d as p,ak as u,e as l,D as _}from"./index-C5UtasSn.js";import{_ as m}from"./DocSection-DNwpJszJ.js";const b=p("img",{src:u},null,-1),g=`<template>
...
</template>`,k={__name:"ButtonDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Button",code:h},{description:a(()=>[d(" An ad can use button ad unit size ")]),example:a(()=>[e(t(n),{unit:"button",test:"Button"}),e(t(n),{unit:"square button",test:"Square Button"}),e(t(n),{unit:"small button",test:"Small Button"})]),_:1}))}},T=`<template>
  <Advertisement unit="skyscraper" test="Skyscraper"  />
  <Advertisement unit="wide skyscraper" test="Wide Skyscraper"  />
</template>`,L={__name:"SkyscraperDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Skyscraper",code:T},{description:a(()=>[d(" An ad can use skyscraper ad unit size ")]),example:a(()=>[e(t(n),{unit:"skyscraper",test:"Skyscraper"}),e(t(n),{unit:"wide skyscraper",test:"Wide Skyscraper"})]),_:1}))}},D=`<template>
  <Advertisement unit="banner" test="Banner" />
...
</template>`,S={__name:"LeaderboardsDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Leaderboards",code:M},{description:a(()=>[d(" An ad can use leaderboard ad unit size ")]),example:a(()=>[e(t(n),{unit:"leaderboard",test:"Leaderboard"}),e(t(n),{unit:"large leaderboard",test:"Large Leaderboard"}),e(t(n),{unit:"billboard",test:"Billboard"})]),_:1}))}},R=`<template>
  <Advertisement unit="panorama" test="Panorama" />
</template>`,z=l({__name:"PanoramaDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Panorama",code:R},{description:a(()=>[d(" An ad can use panorama ad unit size ")]),example:a(()=>[e(t(n),{unit:"panorama",test:"Panorama"})]),_:1}))}}),N=`<template>
  ...
  <Advertisement centered unit="banner" test="Centered" />
</template>`,H=l({__name:"TestDoc",setup(c){return(r,i)=>(s(),o(m,{label:"Test",code:q},{description:a(()=>[d(" A advertisement can be formatted to help verify placement ")]),example:a(()=>[e(t(n),{unit:"medium rectangle",test:"Ad Unit 1"})]),_:1}))}}),E={__name:"Advertisement",setup(c){const r=[{id:"ad",label:"Ad",category:"Types",component:A},{id:"common-units",label:"Common Units",category:"Types",component:v},{id:"mobile",label:"Mobile",category:"Types",component:B},{id:"rectangle",label:"Rectangle",category:"Types",component:$},{id:"button",label:"Button",category:"Types",component:k},{id:"skyscraper",label:"Skyscraper",category:"Types",component:L},{id:"banner",label:"Banner",category:"Types",component:C},{id:"leaderboards",label:"Leaderboards",category:"Types",component:S},{id:"panorama",label:"Panorama",category:"Types",component:z},{id:"netboard",label:"Netboard",category:"Types",component:P},{id:"centered",label:"Centered",category:"Variations",component:w},{id:"test",label:"Test",category:"Variations",component:H}];return(i,U)=>(s(),o(_,{title:"Advertisement",description:"An ad displays third-party promotional content","component-docs":r}))}};export{E as default};
