import{f as g,o as n,c as l,w as e,a as r,b as t,u as a,K as d,t as c,W as i,d as o,g as k,m as D,_,r as h,q as v,h as y,F as w,i as b,j as f,k as F,$ as x,Z as j,l as A,R as M,X as $,n as I,s as G,p as E,D as N}from"./index-9Cq7k5SN.js";const V=o("span",null,"Joined in 2013",-1),H=o("span",{class:"right floated"},"14h",-1),J={class:"right floated"},B=`<template>
  <Card>
...
<\/script>`,X=g({__name:"HeaderDoc",setup(p){const s=h([{header:"Elliot Fu",meta:"Friend",description:"Elliot Fu is a film-maker from New York."},{header:"Veronika Ossi",meta:"Friend",description:"Veronika Ossi is a set designer living in New York who enjoys kittens, music, and partying."},{header:"Jenny Hess",meta:"Friend",description:"Jenny is a student studying Media Management at the New School"}]);return(u,C)=>(n(),l(_,{label:"Header",code:W},{description:e(()=>[r(" A card can contain a header ")]),example:e(()=>[t(a(v),null,{default:e(()=>[(n(!0),y(w,null,b(s.value,m=>(n(),l(a(d),null,{default:e(()=>[t(a(i),null,{header:e(()=>[r(f(m.header),1)]),meta:e(()=>[r(f(m.meta),1)]),description:e(()=>[r(f(m.description),1)]),_:2},1024)]),_:2},1024))),256))]),_:1})]),_:1}))}}),Z=o("span",null,"2 days ago",-1),Q=o("a",null,"Animals",-1),U=`<template>
  <Card>
...
</template>`,ee=g({__name:"MetadataDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Metadata",code:U},{description:e(()=>[r(" A card can contain content metadata ")]),example:e(()=>[t(a(d),null,{default:e(()=>[t(a(i),{header:"Cute Dog"},{meta:e(()=>[Z,Q]),description:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1})]),_:1})]),_:1}))}}),ae=`<template>
  <CardGroup>
    <Card v-for="item in items">
      <CardContent>
        <template #header>
...
</template>`,De=g({__name:"RaisedCardDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Raised Card",code:$e},{description:e(()=>[r(" A card can contain content metadata ")]),example:e(()=>[t(a(d),{raised:""},{default:e(()=>[t(a(i),{header:"Cute Dog"},{meta:e(()=>[be,ke]),description:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(i),{extra:""},{default:e(()=>[o("div",xe,[t(a(c),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1})]),_:1}))}}),Fe=o("span",null,"2 days ago",-1),je=o("a",null,"Animals",-1),Ae={class:"right floated"},Me=o("span",null,"2 days ago",-1),Ie=o("a",null,"Animals",-1),Ge={class:"right floated"},Ee=`<template>
...
</template>`,Ne=g({__name:"LinkCardDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Link Card",code:Ee},{description:e(()=>[r(" A card can be formatted so that the entire contents link to another page ")]),example:e(()=>[t(a(d),{href:"https://dog.com"},{default:e(()=>[t(a(i),{header:"Cute Dog"},{meta:e(()=>[Fe,je]),description:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(i),{extra:""},{default:e(()=>[o("div",Ae,[t(a(c),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1}),t(a(d),{link:""},{default:e(()=>[t(a(i),{header:"Cute Dog"},{meta:e(()=>[Me,Ie]),description:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1}),t(a(i),{extra:""},{default:e(()=>[o("div",Ge,[t(a(c),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/matt.jpg"}),r(" Matt ")])]),_:1})]),_:1})]),_:1}))}}),Ve=o("span",{class:"right floated"},"2 days ago",-1),He={class:"right floated"},Je=`<template>
  <Card>
    <CardContent header="Cute Dog">
      <template #meta>
...
</template>`,Re=g({__name:"TextAlignmentDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Text Alignment",code:Ye},{description:e(()=>[r(" Any element inside a card can have its text alignment specified ")]),example:e(()=>[t(a(d),null,{default:e(()=>[t(a(i),null,{header:e(()=>[ze]),description:e(()=>[Se]),_:1}),t(a(i),{extra:""},{default:e(()=>[o("div",Pe,[t(a(c),{avatar:"",src:"/vue-fomantic-ui/images/avatar/small/jenny.jpg"}),r(" Jenny ")])]),_:1})]),_:1})]),_:1}))}}),Te=`<template>
  <Segment inverted>
    <CardGroup inverted>
      <Card v-for="item in items">
        <Image :src="item.avatar" />
...
</template>`,We=g({__name:"ColumnCountDoc",setup(p){return(s,u)=>(n(),l(_,{label:"Column Count",code:qe},{description:e(()=>[r(" A group of cards can set how many cards should exist in a row ")]),example:e(()=>[t(a(v),{itemsPerRow:4},{default:e(()=>[t(a(d),null,{default:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}),t(a(d),null,{default:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}),t(a(d),null,{default:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}),t(a(d),null,{default:e(()=>[t(a(c),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1})]),_:1})]),_:1}))}}),Xe=`<template>
...
<\/script>`,Ze=g({__name:"StackableDoc",setup(p){const s=h(["elliot","helen","jenny","veronika","stevie","steve"]);return(u,C)=>(n(),l(_,{label:"Stackable",code:Xe},{description:e(()=>[r(" A group of cards can automatically stack rows to a single columns on mobile devices ")]),example:e(()=>[t(a(v),{itemsPerRow:3,stackable:""},{default:e(()=>[(n(!0),y(w,null,b(s.value,m=>(n(),l(a(d),null,{default:e(()=>[t(a(c),{src:`/vue-fomantic-ui/images/avatar/large/${m}.jpg`},null,8,["src"])]),_:2},1024))),256))]),_:1})]),_:1}))}}),Qe=`<template>
...
<\/script>`,Ue=g({__name:"DoublingDoc",setup(p){const s=h(["elliot","helen","jenny","veronika","stevie","steve"]);return(u,C)=>(n(),l(_,{label:"Doubling",code:Qe},{description:e(()=>[r(" A group of cards can double its column width for mobile ")]),example:e(()=>[t(a(v),{itemsPerRow:6,doubling:""},{default:e(()=>[(n(!0),y(w,null,b(s.value,m=>(n(),l(a(d),null,{default:e(()=>[t(a(c),{src:`/vue-fomantic-ui/images/avatar/large/${m}.jpg`},null,8,["src"])]),_:2},1024))),256))]),_:1})]),_:1}))}}),aa={__name:"Card",setup(p){const s=[{id:"card",label:"Card",category:"Types",component:z},{id:"cards",label:"Cards",category:"Types",component:P},{id:"content-block",label:"Content Block",category:"Content",component:q},{id:"header",label:"Header",category:"Content",component:X},{id:"metadata",label:"Metadata",category:"Content",component:ee},{id:"buttons",label:"Buttons",category:"Content",component:te},{id:"approval",label:"Approval",category:"Content",component:ie},{id:"description",label:"Description",category:"Content",component:ce},{id:"extra-content",label:"Extra Content",category:"Content",component:ge},{id:"fluid-card",label:"Fluid Card",category:"Variations",component:fe},{id:"centered",label:"Centered Card",category:"Variations",component:he},{id:"horizontal-cards",label:"Horizontal Cards",category:"Variations",component:we},{id:"raised-card",label:"Raised Card",category:"Variations",component:De},{id:"link-card",label:"Link Card",category:"Variations",component:Ne},{id:"floated-content",label:"Floated Content",category:"Variations",component:Be},{id:"text-alignment",label:"Text Alignment",category:"Variations",component:Re},{id:"inverted",label:"Inverted",category:"Variations",component:Le},{id:"colored",label:"Colored",category:"Variations",component:Ke},{id:"column-count",label:"Column Count",category:"Variations",component:We},{id:"stackable",label:"Stackable",category:"Variations",component:Ze},{id:"doubling",label:"Doubling",category:"Variations",component:Ue}];return(u,C)=>(n(),l(N,{title:"Card",description:"A card displays site content in a manner similar to a playing card","component-docs":s}))}};export{aa as default};
