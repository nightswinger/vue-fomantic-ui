import{e as n,o as s,c as u,w as a,a as i,b as e,u as t,ax as l,ay as m,az as p,aA as b,U as _,K as S,d as v,j as f,D as h}from"./index-1OxQlk_2.js";import{_ as d}from"./DocSection-DUJg2L7o.js";const g=`<template>
...
</template>`,E=n({__name:"FloatedDoc",setup(r){return(o,c)=>(s(),u(d,{label:"Floated",code:Q},{description:a(()=>[i(" An statistic can sit to the left or right of other content ")]),example:a(()=>[e(t(f),null,{default:a(()=>[e(t(l),{floated:"right",value:"2,204",label:"Views"}),C,M,e(t(l),{floated:"left",value:"2,204",label:"Views"}),P,O]),_:1})]),_:1}))}}),R=`<template>
