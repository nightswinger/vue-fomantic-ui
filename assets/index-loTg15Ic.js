...
</template>`,yS={__name:"AnimatedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Animated",code:vS},{description:i(()=>[n(" A button can animate to show hidden content ")]),example:i(()=>[t(p(P),{animated:""},{default:i(()=>[t(p(fi),{visible:""},{default:i(()=>[n("Next")]),_:1}),t(p(fi),{hidden:""},{default:i(()=>[t(p(K),{name:"arrow right"})]),_:1})]),_:1}),t(p(P),{animated:"vertical"},{default:i(()=>[t(p(fi),{visible:""},{default:i(()=>[t(p(K),{name:"shop"})]),_:1}),t(p(fi),{hidden:""},{default:i(()=>[n("Shop")]),_:1})]),_:1}),t(p(P),{animated:"fade"},{default:i(()=>[t(p(fi),{visible:""},{default:i(()=>[n(" Sign-up for a Pro account ")]),_:1}),t(p(fi),{hidden:""},{default:i(()=>[n("$12.99 a month")]),_:1})]),_:1})]),_:1}))}},SS=`<template>
...
<\/script>`,lw={__name:"ToggleDoc",setup(e){const a=G(!1);return(l,o)=>($(),D(M,{label:"Toggle",code:aw},{description:i(()=>[n(" A button can be formatted to toggle on and off ")]),example:i(()=>[t(p(P),{toggle:"",active:a.value,onClick:()=>a.value=!a.value,content:a.value?"Voted":"Vote",style:{"min-width":"200px"}},null,8,["active","onClick","content"])]),_:1}))}},nw=`<template>
...
</template>`,lC={__name:"HorizontalAlignmentDoc",setup(e){return(a,l)=>($(),D(M,{label:"Horizontal Alignment",code:aC},{description:i(()=>[n(" A horizontal divider can be aligned ")]),example:i(()=>[t(p(Oe),{horizontal:"",textAlign:"left"},{default:i(()=>[t(p(K),{name:"left align"}),n(" Left Aligned ")]),_:1}),t(p(Oe),{horizontal:"",textAlign:"center"},{default:i(()=>[t(p(K),{name:"center align"}),n(" Center Aligned ")]),_:1}),t(p(Oe),{horizontal:"",textAlign:"right"},{default:i(()=>[t(p(K),{name:"right align"}),n(" Right Aligned ")]),_:1})]),_:1}))}},nC=`<template>
  <SuiSegment inverted>
    <SuiImage wireframe src="/images/wireframe/short-paragraph.png" />
    <SuiDivider inverted />
    <SuiImage wireframe src="/images/wireframe/short-paragraph.png" />
...
</template>`,UC={__name:"IconDoc",setup(e){return(a,l)=>($(),D(M,{label:"Icon",code:qC},{description:i(()=>[n(" A header may contain an Icon ")]),example:i(()=>[t(p(fe),{as:"h2"},{default:i(()=>[t(p(K),{name:"plug"}),t(p(Gl),null,{default:i(()=>[n(" Uptime Guarantee ")]),_:1})]),_:1})]),_:1}))}},YC=`<template>
  <SuiHeader as="h2">
    Account Settings
    <SuiHeaderSubheader>
      Manage your account settings and set e-mail preferences.
...
</template>`,pA={__name:"DisabledDoc",setup(e){return(a,l)=>($(),D(M,{label:"Disabled",code:mA},{description:i(()=>[n(" An icon can show that it is disabled ")]),example:i(()=>[t(p(K),{name:"users",disabled:""})]),_:1}))}},fA=`<template>
  <SuiIcon name="spinner" loading />
  <SuiIcon name="notched circle" loading />
  <SuiIcon name="asterisk" loading />
</template>`,gA={__name:"LoadingDoc",setup(e){return(a,l)=>($(),D(M,{label:"Loading",code:fA},{description:i(()=>[n(" An icon can be used as a simple loader ")]),example:i(()=>[t(p(K),{name:"spinner",loading:""}),t(p(K),{name:"notched circle",loading:""}),t(p(K),{name:"asterisk",loading:""})]),_:1}))}},hA=S("br",null,null,-1),_A=`<template>
  <div>
    This icon
...
</template>`,bA={__name:"FittedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Fitted",code:_A},{description:i(()=>[n(" An icon can be fitted, without any space to the left or right of it. ")]),example:i(()=>[S("div",null,[n(" This icon "),t(p(K),{name:"help",fitted:""}),n(" is fitted. "),hA,n(" This icon "),t(p(K),{name:"help"}),n(" is not fitted. ")])]),_:1}))}},vA=`<template>
...
</template>`,yA={__name:"SizeDoc",setup(e){return(a,l)=>($(),D(M,{label:"Size",code:vA},{description:i(()=>[n(" An icon can vary in size ")]),example:i(()=>[t(p(K),{name:"home",size:"mini"}),t(p(K),{name:"home",size:"tiny"}),t(p(K),{name:"home",size:"small"}),t(p(K),{name:"home"}),t(p(K),{name:"home",size:"large"}),t(p(K),{name:"home",size:"big"}),t(p(K),{name:"home",size:"huge"}),t(p(K),{name:"home",size:"massive"})]),_:1}))}},SA=`<template>
  <SuiIcon name="close" link />
  <SuiIcon name="help" link />
</template>`,wA={__name:"LinkDoc",setup(e){return(a,l)=>($(),D(M,{label:"Link",code:SA},{description:i(()=>[n(" An icon can be formatted as a link ")]),example:i(()=>[t(p(K),{name:"close",link:""}),t(p(K),{name:"help",link:""})]),_:1}))}},CA=`<template>
  <SuiIcon name="cloud" flipped="horizontally" />
  <SuiIcon name="cloud" flipped="vertically" />
</template>`,AA={__name:"FlippedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Flipped",code:CA},{description:i(()=>[n(" An icon can be flipped ")]),example:i(()=>[t(p(K),{name:"cloud",flipped:"horizontally"}),t(p(K),{name:"cloud",flipped:"vertically"})]),_:1}))}},kA=`<template>
  <SuiIcon name="cloud" rotated="clockwise" />
  <SuiIcon name="cloud" rotated="counterclockwise" />
</template>`,xA={__name:"RotatedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Rotated",code:kA},{description:i(()=>[n(" An icon can be rotated ")]),example:i(()=>[t(p(K),{name:"cloud",rotated:"clockwise"}),t(p(K),{name:"cloud",rotated:"counterclockwise"})]),_:1}))}},$A=`<template>
...
</template>`,LA={__name:"BorderedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Bordered",code:TA},{description:i(()=>[n(" An icon can be formatted to appear bordered ")]),example:i(()=>[t(p(K),{name:"users",bordered:""}),t(p(K),{name:"users",bordered:"",color:"teal"}),t(p(K),{name:"users",bordered:"",inverted:"",color:"black"}),t(p(K),{name:"users",bordered:"",inverted:"",color:"teal"})]),_:1}))}},IA=`<template>
...
</template>`,DA={__name:"ColoredDoc",setup(e){return(a,l)=>($(),D(M,{label:"Colored",code:IA},{description:i(()=>[n(" An icon can be formatted with different colors ")]),example:i(()=>[t(p(K),{name:"users",primary:""}),t(p(K),{name:"users",secondary:""}),t(p(K),{name:"users",color:"red"}),t(p(K),{name:"users",color:"orange"}),t(p(K),{name:"users",color:"yellow"}),t(p(K),{name:"users",color:"olive"}),t(p(K),{name:"users",color:"green"}),t(p(K),{name:"users",color:"teal"}),t(p(K),{name:"users",color:"blue"}),t(p(K),{name:"users",color:"violet"}),t(p(K),{name:"users",color:"purple"}),t(p(K),{name:"users",color:"pink"}),t(p(K),{name:"users",color:"brown"}),t(p(K),{name:"users",color:"grey"}),t(p(K),{name:"users",color:"black"})]),_:1}))}},EA=`<template>
...
</template>`,RA={__name:"InvertedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Inverted",code:EA},{description:i(()=>[n(" An icon can have its colors inverted for contrast ")]),example:i(()=>[t(p(K),{name:"users",inverted:""}),t(p(K),{name:"users",inverted:"",primary:""}),t(p(K),{name:"users",inverted:"",secondary:""}),t(p(K),{name:"users",inverted:"",color:"red"}),t(p(K),{name:"users",inverted:"",color:"orange"}),t(p(K),{name:"users",inverted:"",color:"yellow"}),t(p(K),{name:"users",inverted:"",color:"olive"}),t(p(K),{name:"users",inverted:"",color:"green"}),t(p(K),{name:"users",inverted:"",color:"teal"}),t(p(K),{name:"users",inverted:"",color:"blue"}),t(p(K),{name:"users",inverted:"",color:"violet"}),t(p(K),{name:"users",inverted:"",color:"purple"}),t(p(K),{name:"users",inverted:"",color:"pink"}),t(p(K),{name:"users",inverted:"",color:"brown"}),t(p(K),{name:"users",inverted:"",color:"grey"})]),_:1}))}},zA=`<template>
...
</template>`,PA={__name:"IconsDoc",setup(e){return(a,l)=>($(),D(M,{label:"Icons",code:zA},{description:i(()=>[n(" Several icons can be used together as a group ")]),example:i(()=>[t(p(gi),{size:"huge"},{default:i(()=>[t(p(K),{name:"circle outline",size:"big"}),t(p(K),{name:"user"})]),_:1}),t(p(gi),{size:"huge"},{default:i(()=>[t(p(K),{name:"dont",size:"big",color:"red"}),t(p(K),{name:"user",color:"black"})]),_:1})]),_:1}))}},MA=`<template>
  <SuiIconGroup size="huge">
    <SuiIcon name="puzzle" />
...
</template>`,VA={__name:"CornerIconDoc",setup(e){return(a,l)=>($(),D(M,{label:"Corner Icon",code:MA},{description:i(()=>[n(" A group of icons can display a smaller corner icon ")]),example:i(()=>[t(p(gi),{size:"huge"},{default:i(()=>[t(p(K),{name:"puzzle"}),t(p(K),{name:"add",corner:"top left"})]),_:1}),t(p(gi),{size:"huge"},{default:i(()=>[t(p(K),{name:"puzzle"}),t(p(K),{name:"add",corner:"top right"})]),_:1}),t(p(gi),{size:"huge"},{default:i(()=>[t(p(K),{name:"puzzle"}),t(p(K),{name:"add",corner:"bottom left"})]),_:1}),t(p(gi),{size:"huge"},{default:i(()=>[t(p(K),{name:"puzzle"}),t(p(K),{name:"add",corner:"bottom right"})]),_:1})]),_:1}))}},FA={__name:"Icon",setup(e){const a=[{id:"disabled",label:"Disabled",category:"States",component:pA},{id:"loading",label:"Loading",category:"States",component:gA},{id:"fitted",label:"Fitted",category:"Variations",component:bA},{id:"size",label:"Size",category:"Variations",component:yA},{id:"link",label:"Link",category:"Variations",component:wA},{id:"flipped",label:"Flipped",category:"Variations",component:AA},{id:"rotated",label:"Rotated",category:"Variations",component:xA},{id:"circular",label:"Circular",category:"Variations",component:BA},{id:"bordered",label:"Bordered",category:"Variations",component:LA},{id:"colored",label:"Colored",category:"Variations",component:DA},{id:"inverted",label:"Inverted",category:"Variations",component:RA},{id:"icons",label:"Icons",category:"Groups",component:PA},{id:"corner-icon",label:"Corner Icon",category:"Groups",component:VA}];return(l,o)=>($(),D(Ct,{title:"Icon",description:"An icon is a glyph used to represent something else","component-docs":a}))}},HA=`<template>
  <SuiImage size="small" src="/images/wireframe/image.png" />
</template>`,NA={__name:"ImageDoc",setup(e){return(a,l)=>($(),D(M,{label:"Image",code:HA},{description:i(()=>[n(" An image ")]),example:i(()=>[t(p(ce),{size:"small",src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}))}},OA=`<template>
  <SuiImage
    as="a"
    size="medium"
    ...
    target="_blank"
  />
</template>`,jA={__name:"ImageLinkDoc",setup(e){return(a,l)=>($(),D(M,{label:"Image Link",code:OA},{description:i(()=>[n(" An image can be formatted to link to other content ")]),example:i(()=>[t(p(ce),{as:"a",size:"medium",href:"https://google.com",src:"/vue-fomantic-ui/images/wireframe/image-text.png",target:"_blank"})]),_:1}))}},GA=`<template>
  <SuiImage size="small" src="/images/wireframe/image.png" hidden />
</template>`,qA={__name:"HiddenDoc",setup(e){return(a,l)=>($(),D(M,{label:"Hidden",code:GA},{description:i(()=>[n(" An image can be hidden ")]),example:i(()=>[t(p(ce),{size:"small",src:"/vue-fomantic-ui/images/wireframe/image.png",hidden:""})]),_:1}))}},UA=`<template>
  <SuiImage size="small" src="/images/wireframe/image.png" disabled />
</template>`,YA={__name:"DisabledDoc",setup(e){return(a,l)=>($(),D(M,{label:"Disabled",code:UA},{description:i(()=>[n(" An image can show that it is disabled and cannot be selected ")]),example:i(()=>[t(p(ce),{size:"small",src:"/vue-fomantic-ui/images/wireframe/image.png",disabled:""})]),_:1}))}},JA=S("span",null,"Username",-1),WA=`<template>
  <SuiImage src="/images/wireframe/square-image.png" avatar />
  <span>Username</span>
</template>`,KA={__name:"AvatarDoc",setup(e){return(a,l)=>($(),D(M,{label:"Avatar",code:WA},{description:i(()=>[n(" An image may be formatted to appear inline with text as an avatar ")]),example:i(()=>[t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/square-image.png",avatar:""}),JA]),_:1}))}},XA=`<template>
  <SuiImage size="medium" src="/images/wireframe/white-image.png" bordered />
</template>`,QA={__name:"BorderedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Bordered",code:XA},{description:i(()=>[n(" An image may include a border to emphasize the edges of white or transparent content ")]),example:i(()=>[t(p(ce),{size:"medium",src:"/vue-fomantic-ui/images/wireframe/white-image.png",bordered:""})]),_:1}))}},ZA=`<template>
  <SuiImage src="/images/wireframe/image.png" fluid />
</template>`,e0={__name:"FluidDoc",setup(e){return(a,l)=>($(),D(M,{label:"Fluid",code:ZA},{description:i(()=>[n(" An image can take up the width of its container ")]),example:i(()=>[t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png",fluid:""})]),_:1}))}},t0=`<template>
  <SuiImage src="/images/wireframe/image.png" rounded />
</template>`,i0={__name:"RoundedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Rounded",code:t0},{description:i(()=>[n(" An image may appear rounded ")]),example:i(()=>[t(p(ce),{size:"medium",src:"/vue-fomantic-ui/images/wireframe/image.png",rounded:""})]),_:1}))}},a0=`<template>
  <SuiImage src="/images/wireframe/square-image.png" circular />
</template>`,l0={__name:"CircularDoc",setup(e){return(a,l)=>($(),D(M,{label:"Circular",code:a0},{description:i(()=>[n(" An image may appear circular ")]),example:i(()=>[t(p(ce),{size:"medium",src:"/vue-fomantic-ui/images/wireframe/square-image.png",circular:""})]),_:1}))}},n0=S("span",null,"Top Aligned",-1),o0=S("span",null,"Middle Aligned",-1),s0=S("span",null,"Bottom Aligned",-1),r0=`<template>
...
</template>`,u0={__name:"VerticallyAlignedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Vertically Aligned",code:r0},{description:i(()=>[n(" An image can specify its vertical alignment ")]),example:i(()=>[t(p(ce),{verticalAlign:"top",size:"tiny",src:"/vue-fomantic-ui/images/wireframe/image.png"}),n0,t(p(Oe)),t(p(ce),{verticalAlign:"middle",size:"tiny",src:"/vue-fomantic-ui/images/wireframe/image.png"}),o0,t(p(Oe)),t(p(ce),{verticalAlign:"bottom",size:"tiny",src:"/vue-fomantic-ui/images/wireframe/image.png"}),s0]),_:1}))}},c0=S("p",null," Te eum doming eirmod, nominati pertinacia argumentum ad his. Ex eam alia facete scriptorem, est autem aliquip detraxit at. Usu ocurreret referrentur at, cu epicurei appellantur vix. Cum ea laoreet recteque electram, eos choro alterum definiebas in. Vim dolorum definiebas an. Mei ex natum rebum iisque. ",-1),d0=S("p",null," Audiam quaerendum eu sea, pro omittam definiebas ex. Te est latine definitiones. Quot wisi nulla ex duo. Vis sint solet expetenda ne, his te phaedrum referrentur consectetuer. Id vix fabulas oporteat, ei quo vide phaedrum, vim vivendum maiestatis in. ",-1),m0=S("p",null," Eu quo homero blandit intellegebat. Incorrupte consequuntur mei id. Mei ut facer dolores adolescens, no illum aperiri quo, usu odio brute at. Qui te porro electram, ea dico facete utroque quo. Populo quodsi te eam, wisi everti eos ex, eum elitr altera utamur at. Quodsi convenire mnesarchum eu per, quas minimum postulant per id. ",-1),p0=`<template>
  <SuiSegment>
...
</template>`,f0={__name:"CenteredDoc",setup(e){return(a,l)=>($(),D(M,{label:"Centered",code:p0},{description:i(()=>[n(" An image can appear centered in a content block ")]),example:i(()=>[t(p(Le),null,{default:i(()=>[t(p(ce),{centered:"",size:"medium",src:"/vue-fomantic-ui/images/wireframe/image.png"}),c0,d0,t(p(ce),{centered:"",size:"small",src:"/vue-fomantic-ui/images/wireframe/image-text.png"}),m0]),_:1})]),_:1}))}},g0=`<template>
  <SuiSegment>
    <p>
...
</template>`,S0={__name:"FloatedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Floated",code:y0},{description:i(()=>[n(" An image can sit to the left or right of other content ")]),example:i(()=>[t(p(Le),null,{default:i(()=>[t(p(ce),{floated:"left",size:"small",src:"/vue-fomantic-ui/images/wireframe/image-text.png"}),_0,t(p(ce),{floated:"right",size:"small",src:"/vue-fomantic-ui/images/wireframe/image-text.png"}),b0,v0]),_:1})]),_:1}))}},w0=`<template>
...
</template>`,C0={__name:"SizeDoc",setup(e){return(a,l)=>($(),D(M,{label:"Size",code:w0},{description:i(()=>[n(" An image may appear at different sizes ")]),example:i(()=>[t(p(ce),{size:"mini",src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(Oe),{hidden:""}),t(p(ce),{size:"tiny",src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(Oe),{hidden:""}),t(p(ce),{size:"small",src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(Oe),{hidden:""}),t(p(ce),{size:"medium",src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}))}},A0=`<template>
...
</template>`,k0={__name:"GroupSizeDoc",setup(e){return(a,l)=>($(),D(M,{label:"Size",code:A0},{description:i(()=>[n(" A group of images can be formatted to have the same size. ")]),example:i(()=>[t(p(ql),{size:"tiny"},{default:i(()=>[t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}),t(p(Oe),{hidden:""}),t(p(ql),{size:"small"},{default:i(()=>[t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1})]),_:1}))}},x0={__name:"Image",setup(e){const a=[{id:"image",label:"Image",category:"Types",component:NA},{id:"image-link",label:"Image Link",category:"Types",component:jA},{id:"hidden",label:"Hidden",category:"States",component:qA},{id:"disabled",label:"Disabled",category:"States",component:YA},{id:"avatar",label:"Avatar",category:"Variations",component:KA},{id:"bordered",label:"Bordered",category:"Variations",component:QA},{id:"fluid",label:"Fluid",category:"Variations",component:e0},{id:"rounded",label:"Rounded",category:"Variations",component:i0},{id:"circular",label:"Circular",category:"Variations",component:l0},{id:"vertically-aligned",label:"Vertically Aligned",category:"Variations",component:u0},{id:"centered",label:"Centered",category:"Variations",component:f0},{id:"spaced",label:"Spaced",category:"Variations",component:h0},{id:"floated",label:"Floated",category:"Variations",component:S0},{id:"size",label:"Size",category:"Variations",component:C0},{id:"group-size",label:"Size",category:"Groups",component:k0}];return(l,o)=>($(),D(Ct,{title:"Image",description:"An image is a graphic representation of something","component-docs":a}))}},$0=`<template>
  <SuiInput placeholder="Search..." />
</template>`,B0={__name:"InputDoc",setup(e){return(a,l)=>($(),D(M,{label:"Input",code:$0},{description:i(()=>[n(" A standard input ")]),example:i(()=>[t(p(et),{placeholder:"Search..."})]),_:1}))}},T0=`<template>
  <SuiInput focus placeholder="Search..." />
</template>`,L0={__name:"FocusDoc",setup(e){return(a,l)=>($(),D(M,{label:"Focus",code:T0},{description:i(()=>[n(" An input field can show a user is currently interacting with it ")]),example:i(()=>[t(p(et),{focus:"",placeholder:"Search..."})]),_:1}))}},I0=`<template>
  <SuiInput loading icon="user" placeholder="Search..." />
  <SuiInput loading icon="user" iconPosition="left" placeholder="Search..." />
</template>`,D0={__name:"LoadingDoc",setup(e){return(a,l)=>($(),D(M,{label:"Loading",code:I0},{description:i(()=>[n(" An icon input field can show that it is currently loading data ")]),example:i(()=>[t(p(et),{loading:"",icon:"user",placeholder:"Search..."}),t(p(et),{loading:"",icon:"user",iconPosition:"left",placeholder:"Search..."})]),_:1}))}},E0=`<template>
  <SuiInput disabled placeholder="Search..." />
</template>`,R0={__name:"DisabledDoc",setup(e){return(a,l)=>($(),D(M,{label:"Disabled",code:E0},{description:i(()=>[n(" An input field can show that it is disabled ")]),example:i(()=>[t(p(et),{disabled:"",placeholder:"Search..."})]),_:1}))}},z0=`<template>
  <SuiInput error placeholder="Search..." />
</template>`,P0={__name:"ErrorDoc",setup(e){return(a,l)=>($(),D(M,{label:"Error",code:z0},{description:i(()=>[n(" An input field can show the data contains errors ")]),example:i(()=>[t(p(et),{error:"",placeholder:"Search..."})]),_:1}))}},M0=`<template>
  <SuiInput icon="search" placeholder="Search..." />
  <SuiInput icon="users" iconPosition="left" placeholder="Search..." />
</template>`,V0={__name:"IconDoc",setup(e){return(a,l)=>($(),D(M,{label:"Icon",code:M0},{description:i(()=>[n(" An input can be formatted with an icon ")]),example:i(()=>[t(p(et),{icon:"search",placeholder:"Search..."}),t(p(et),{icon:"users",iconPosition:"left",placeholder:"Search..."})]),_:1}))}},F0=`<template>
  <SuiInput label="http://" placeholder="mysite.com" />
</template>`,H0={__name:"LabeledDoc",setup(e){return(a,l)=>($(),D(M,{label:"Labeled",code:F0},{description:i(()=>[n(" An input can be formatted with a label ")]),example:i(()=>[t(p(et),{label:"http://",placeholder:"mysite.com"})]),_:1}))}},N0=`<template>
  <SuiInput action="Search" />
</template>`,O0={__name:"ActionDoc",setup(e){return(a,l)=>($(),D(M,{label:"Action",code:N0},{description:i(()=>[n(" An input can be formatted to alert the user to an action they may perform ")]),example:i(()=>[t(p(et),{action:"Search"})]),_:1}))}},j0=`<template>
  <SuiInput transparent icon="search" placeholder="Search..." />
</template>`,G0={__name:"TransparentDoc",setup(e){return(a,l)=>($(),D(M,{label:"Transparent",code:j0},{description:i(()=>[n(" A transparent input has no background ")]),example:i(()=>[t(p(et),{transparent:"",icon:"search",placeholder:"Search..."})]),_:1}))}},q0=`<template>
  <SuiSegment inverted>
    <SuiInput inverted placeholder="Search..." />
  </SuiSegment>
</template>`,U0={__name:"InvertedDoc",setup(e){return(a,l)=>{const o=y("SuiSegment");return $(),D(M,{label:"Inverted",code:q0},{description:i(()=>[n(" An input can be formatted to appear on dark backgrounds ")]),example:i(()=>[t(o,{inverted:""},{default:i(()=>[t(p(et),{inverted:"",placeholder:"Search..."})]),_:1})]),_:1})}}},Y0=`<template>
  <SuiInput fluid icon="search" placeholder="Search..." />
</template>`,J0={__name:"FluidDoc",setup(e){return(a,l)=>($(),D(M,{label:"Fluid",code:Y0},{description:i(()=>[n(" An input can take the size of its container ")]),example:i(()=>[t(p(et),{fluid:"",icon:"search",placeholder:"Search..."})]),_:1}))}},W0=`<template>
...
</template>`,K0={__name:"SizeDoc",setup(e){return(a,l)=>($(),D(M,{label:"Size",code:W0},{description:i(()=>[n(" An input can vary in size ")]),example:i(()=>[t(p(et),{icon:"search",placeholder:"Search mini...",size:"mini"}),t(p(et),{icon:"search",placeholder:"Search small...",size:"small"}),t(p(et),{icon:"search",placeholder:"Search large...",size:"large"}),t(p(et),{icon:"search",placeholder:"Search big...",size:"big"}),t(p(et),{icon:"search",placeholder:"Search huge...",size:"huge"}),t(p(et),{icon:"search",placeholder:"Search massive...",size:"massive"})]),_:1}))}},X0={__name:"Input",setup(e){const a=[{id:"input",label:"Input",category:"Types",component:B0},{id:"focus",label:"Focus",category:"States",component:L0},{id:"loading",label:"Loading",category:"States",component:D0},{id:"disabled",label:"Disabled",category:"States",component:R0},{id:"error",label:"Error",category:"States",component:P0},{id:"icon",label:"Icon",category:"Variations",component:V0},{id:"labeled",label:"Labeled",category:"Variations",component:H0},{id:"action",label:"Action",category:"Variations",component:O0},{id:"transparent",label:"Transparent",category:"Variations",component:G0},{id:"inverted",label:"Inverted",category:"Variations",component:U0},{id:"fluid",label:"Fluid",category:"Variations",component:J0},{id:"size",label:"Size",category:"Variations",component:K0}];return(l,o)=>($(),D(Ct,{title:"Input",description:"An input is a field used to elicit a response from a user","component-docs":a}))}},Q0=`<template>
  <SuiLabel>
    <SuiIcon name="mail" />
    23
  </SuiLabel>
</template>`,Z0={__name:"LabelDoc",setup(e){return(a,l)=>($(),D(M,{label:"Label",code:Q0},{description:i(()=>[n(" A label ")]),example:i(()=>[t(p(N),null,{default:i(()=>[t(p(K),{name:"mail"}),n(" 23 ")]),_:1})]),_:1}))}},Oo="/vue-fomantic-ui/images/avatar/small/joe.jpg",rp="/vue-fomantic-ui/images/avatar/small/veronika.jpg",ei="/vue-fomantic-ui/images/avatar/small/elliot.jpg",ek=S("img",{src:Oo},null,-1),tk=S("img",{src:rp},null,-1),ik=S("img",{src:ei},null,-1),ak=`<template>
  <SuiLabel as="a" image>
...
</template>`,lk={__name:"ImageDoc",setup(e){return(a,l)=>($(),D(M,{label:"Image",code:ak},{description:i(()=>[n(" A label can be formatted to emphasize an image ")]),example:i(()=>[t(p(N),{as:"a",image:""},{default:i(()=>[ek,n(" Joe ")]),_:1}),t(p(N),{as:"a",image:"",color:"blue"},{default:i(()=>[tk,n(" Veronika "),t(p(ji),null,{default:i(()=>[n("Friend")]),_:1})]),_:1}),t(p(N),{as:"a",image:""},{default:i(()=>[ik,n(" Elliot "),t(p(K),{name:"delete"})]),_:1})]),_:1}))}},nk=S("input",{type:"text",placeholder:"First Name"},null,-1),ok=S("input",{type:"text"},null,-1),sk=S("input",{type:"text",placeholder:"Username"},null,-1),rk=S("input",{type:"password"},null,-1),uk=`<template>
  <SuiForm fluid>
    <SuiFormField>
...
</template>`,ck={__name:"PointingDoc",setup(e){return(a,l)=>($(),D(M,{label:"Pointing",code:uk},{description:i(()=>[n(" A label can point to content next to it ")]),example:i(()=>[t(p(Ul),{fluid:""},{default:i(()=>[t(p(hi),null,{default:i(()=>[nk,t(p(N),{pointing:""},{default:i(()=>[n("Please enter a value")]),_:1})]),_:1}),t(p(Oe)),t(p(hi),null,{default:i(()=>[t(p(N),{pointing:"below"},{default:i(()=>[n("Please enter a value")]),_:1}),ok]),_:1}),t(p(Oe)),t(p(hi),{inline:""},{default:i(()=>[sk,t(p(N),{pointing:"left",color:"red",basic:""},{default:i(()=>[n("That name is taken!")]),_:1})]),_:1}),t(p(Oe)),t(p(hi),{inline:""},{default:i(()=>[t(p(N),{pointing:"right",color:"red",basic:""},{default:i(()=>[n("Your password must be 6 characters or more")]),_:1}),rk]),_:1})]),_:1})]),_:1}))}},dk=`<template>
  <SuiGrid :columns="2">
    <SuiGridColumn>
      <SuiImage
...
</template>`,mk={__name:"CornerDoc",setup(e){return(a,l)=>($(),D(M,{label:"Corner",code:dk},{description:i(()=>[n(" A label can position itself in the corner of an element ")]),example:i(()=>[t(p(Sa),{columns:2},{default:i(()=>[t(p(bt),null,{default:i(()=>[t(p(ce),{label:{as:"a",corner:"left",icon:"heart"},src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1}),t(p(bt),null,{default:i(()=>[t(p(ce),{label:{as:"a",color:"red",corner:"right",icon:"save"},src:"/vue-fomantic-ui/images/wireframe/image.png"})]),_:1})]),_:1})]),_:1}))}},pk=`<template>
...
</template>`,fk={__name:"TagDoc",setup(e){return(a,l)=>($(),D(M,{label:"Tag",code:pk},{description:i(()=>[n(" A label can appear as a tag ")]),example:i(()=>[t(p(N),{as:"a",tag:""},{default:i(()=>[n("New")]),_:1}),t(p(N),{as:"a",tag:"",color:"red"},{default:i(()=>[n("Upcoming")]),_:1}),t(p(N),{as:"a",tag:"",color:"teal"},{default:i(()=>[n("Featured")]),_:1})]),_:1}))}},gk=S("span",null,"Account Details",-1),hk=S("span",null,"User Reviews",-1),_k=S("span",null,"Technical Specifications",-1),bk=S("span",null,"User Reviews",-1),vk=`<template>
  <SuiGrid :columns="2">
    <SuiGridColumn>
      <SuiSegment raised>
...
</template>`,yk={__name:"RibbonDoc",setup(e){return(a,l)=>($(),D(M,{label:"Ribbon",code:vk},{description:i(()=>[n(" A label can appear as a ribbon attaching itself to an element. ")]),example:i(()=>[t(p(Sa),{columns:2},{default:i(()=>[t(p(bt),null,{default:i(()=>[t(p(Le),{raised:""},{default:i(()=>[t(p(N),{as:"a",ribbon:"",color:"red"},{default:i(()=>[n("Overview")]),_:1}),gk,t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"}),t(p(N),{as:"a",ribbon:"",color:"blue"},{default:i(()=>[n("Community")]),_:1}),hk,t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1})]),_:1}),t(p(bt),null,{default:i(()=>[t(p(Le),{raised:""},{default:i(()=>[t(p(N),{as:"a",ribbon:"right",color:"orange"},{default:i(()=>[n("Specs")]),_:1}),_k,t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"}),t(p(N),{as:"a",ribbon:"right",color:"teal"},{default:i(()=>[n("Reviews")]),_:1}),bk,t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/paragraph.png"})]),_:1})]),_:1})]),_:1})]),_:1}))}},Sk=`<template>
  <SuiGrid :columns="3">
    <SuiGridRow>
      <SuiGridColumn>
        <SuiSegment padded>
...
</template>`,xk={__name:"FloatingDoc",setup(e){return(a,l)=>($(),D(M,{label:"Floating",code:kk},{description:i(()=>[n(" A label can float above or below another element ")]),example:i(()=>[t(p(Lo),{compact:""},{default:i(()=>[t(p(Jl),null,{default:i(()=>[t(p(K),{name:"mail"}),n(" Messages "),t(p(N),{floating:"",color:"red"},{default:i(()=>[n("22")]),_:1})]),_:1}),t(p(Jl),null,{default:i(()=>[t(p(K),{name:"users"}),n(" Friends "),t(p(N),{floating:"",color:"teal"},{default:i(()=>[n("22")]),_:1})]),_:1})]),_:1})]),_:1}))}},$k=`<template>
  <SuiSegment inverted>
  ...
  <SuiLabel icon="dog" />
  <SuiLabel icon="cat" />
</template>`,Dk={__name:"IconDoc",setup(e){return(a,l)=>($(),D(M,{label:"Icon",code:Ik},{description:i(()=>[n(" A label can include an icon ")]),example:i(()=>[t(p(N),null,{default:i(()=>[t(p(K),{name:"mail"}),n(" Mail ")]),_:1}),t(p(N),null,{default:i(()=>[t(p(K),{name:"checkmark"}),n(" Test Passed ")]),_:1}),t(p(N),{icon:"dog"}),t(p(N),{icon:"cat"})]),_:1}))}},Ek=`<template>
  <SuiLabel>
    <SuiIcon name="mail" />
    23
  </SuiLabel>
...
</template>`,Rk={__name:"LinkDoc",setup(e){return(a,l)=>($(),D(M,{label:"Link",code:Ek},{description:i(()=>[n(" A label can be a link or contain an item that links ")]),example:i(()=>[t(p(N),{as:"a"},{default:i(()=>[t(p(K),{name:"mail"}),n(" 23 ")]),_:1}),t(p(N),null,{default:i(()=>[t(p(K),{name:"mail"}),n(" 23 "),t(p(ji),null,{default:i(()=>[n("View Mail")]),_:1})]),_:1})]),_:1}))}},zk=`<template>
  <SuiLabel disabled>Disabled Label</SuiLabel>
</template>`,Pk={__name:"DisabledDoc",setup(e){return(a,l)=>($(),D(M,{label:"Disabled",code:zk},{description:i(()=>[n(" A label can show it is currently unable to be interacted with ")]),example:i(()=>[t(p(N),{disabled:""},{default:i(()=>[n("Disabled Label")]),_:1})]),_:1}))}},Mk=`<template>
  <SuiLabel fluid>Fits container</SuiLabel>
</template>`,Vk={__name:"FluidDoc",setup(e){return(a,l)=>($(),D(M,{label:"Fluid",code:Mk},{description:i(()=>[n(" A label can take the width of its container ")]),example:i(()=>[t(p(N),{fluid:""},{default:i(()=>[n("Fits container")]),_:1})]),_:1}))}},Fk=`<template>
...
</template>`,Hk={__name:"CircularDoc",setup(e){return(a,l)=>($(),D(M,{label:"Circular",code:Fk},{description:i(()=>[n(" A label can be circular ")]),example:i(()=>[t(p(N),{circular:"",color:"red"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"orange"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"yellow"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"olive"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"green"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"teal"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"blue"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"violet"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"purple"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"pink"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"brown"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"grey"},{default:i(()=>[n("2")]),_:1}),t(p(N),{circular:"",color:"black"},{default:i(()=>[n("2")]),_:1})]),_:1}))}},Nk=S("img",{src:ei},null,-1),Ok=`<template>
...
</template>`,jk={__name:"BasicDoc",setup(e){return(a,l)=>($(),D(M,{label:"Basic",code:Ok},{description:i(()=>[n(" A label can reduce its complexity ")]),example:i(()=>[t(p(N),{as:"a",basic:""},{default:i(()=>[n("Basic")]),_:1}),t(p(N),{as:"a",basic:"",pointing:""},{default:i(()=>[n("Pointing")]),_:1}),t(p(N),{as:"a",basic:"",image:""},{default:i(()=>[Nk,n(" Elliot ")]),_:1}),t(p(N),{as:"a",basic:"",pointing:"",color:"red"},{default:i(()=>[n("Red Pointing")]),_:1}),t(p(N),{as:"a",basic:"",color:"blue"},{default:i(()=>[n("Blue")]),_:1})]),_:1}))}},Gk=`<template>
...
</template>`,Wk={__name:"SizeDoc",setup(e){return(a,l)=>($(),D(M,{label:"Size",code:Jk},{description:i(()=>[n(" A label can be small or large ")]),example:i(()=>[t(p(N),{size:"mini"},{default:i(()=>[n("Mini")]),_:1}),t(p(N),{size:"tiny"},{default:i(()=>[n("Tiny")]),_:1}),t(p(N),{size:"small"},{default:i(()=>[n("Small")]),_:1}),t(p(N),null,{default:i(()=>[n("Medium")]),_:1}),t(p(N),{size:"large"},{default:i(()=>[n("Large")]),_:1}),t(p(N),{size:"big"},{default:i(()=>[n("Big")]),_:1}),t(p(N),{size:"huge"},{default:i(()=>[n("Huge")]),_:1}),t(p(N),{size:"massive"},{default:i(()=>[n("Massive")]),_:1})]),_:1}))}},Kk=`<template>
...
</template>`,Xk={__name:"GroupSizeDoc",setup(e){return(a,l)=>($(),D(M,{label:"Group Size",code:Kk},{description:i(()=>[n(" Labels can share sizes together ")]),example:i(()=>[t(p(Gi),{size:"huge"},{default:i(()=>[t(p(N),null,{default:i(()=>[n("Fun")]),_:1}),t(p(N),null,{default:i(()=>[n("Happy")]),_:1}),t(p(N),null,{default:i(()=>[n("Smart")]),_:1}),t(p(N),null,{default:i(()=>[n("Witty")]),_:1})]),_:1})]),_:1}))}},Qk=`<template>
...
</template>`,Zk={__name:"ColoredGroupDoc",setup(e){return(a,l)=>($(),D(M,{label:"Clored Group",code:Qk},{description:i(()=>[n(" Labels can share colors together ")]),example:i(()=>[t(p(Gi),{color:"blue"},{default:i(()=>[t(p(N),null,{default:i(()=>[n(" Fun "),t(p(K),{name:"close"})]),_:1}),t(p(N),null,{default:i(()=>[n(" Happy "),t(p(ji),null,{default:i(()=>[n("Smart")]),_:1})]),_:1}),t(p(N),null,{default:i(()=>[n("Insane")]),_:1}),t(p(N),null,{default:i(()=>[n("Exciting")]),_:1})]),_:1})]),_:1}))}},ex=`<template>
  <SuiLabelGroup basic>
    <SuiLabel>
      Fun
      <SuiIcon name="close" />
...
</template>`,tx={__name:"BasicGroupDoc",setup(e){return(a,l)=>($(),D(M,{label:"Basic Group",code:ex},{description:i(()=>[n(" Labels can share their style together ")]),example:i(()=>[t(p(Gi),{basic:""},{default:i(()=>[t(p(N),null,{default:i(()=>[n(" Fun "),t(p(K),{name:"close"})]),_:1}),t(p(N),null,{default:i(()=>[n(" Happy "),t(p(ji),null,{default:i(()=>[n("Smart")]),_:1})]),_:1}),t(p(N),null,{default:i(()=>[n("Insane")]),_:1}),t(p(N),null,{default:i(()=>[n("Exciting")]),_:1})]),_:1})]),_:1}))}},ix=`<template>
  <SuiLabelGroup size="huge">
    <SuiLabel>Fun</SuiLabel>
    <SuiLabel>Happy</SuiLabel>
    <SuiLabel>Smart</SuiLabel>
...
</template>`,ax={__name:"TagGroupDoc",setup(e){return(a,l)=>($(),D(M,{label:"Tag Group",code:ix},{description:i(()=>[n(" Labels can share tag formatting ")]),example:i(()=>[t(p(Gi),{tag:""},{default:i(()=>[t(p(N),{as:"a"},{default:i(()=>[n("$10.00")]),_:1}),t(p(N),{as:"a"},{default:i(()=>[n("$19.99")]),_:1}),t(p(N),{as:"a"},{default:i(()=>[n("$24.99")]),_:1}),t(p(N),{as:"a"},{default:i(()=>[n("$10.25")]),_:1})]),_:1})]),_:1}))}},lx=`<template>
  <SuiLabelGroup tag>
...
</template>`,nx={__name:"CircularGroupDoc",setup(e){return(a,l)=>($(),D(M,{label:"Circular Group",code:lx},{description:i(()=>[n(" Labels can share shapes ")]),example:i(()=>[t(p(Gi),{circular:""},{default:i(()=>[t(p(N),{as:"a"},{default:i(()=>[n("1")]),_:1}),t(p(N),{as:"a"},{default:i(()=>[n("3")]),_:1}),t(p(N),{as:"a"},{default:i(()=>[n("4")]),_:1}),t(p(N),{as:"a"},{default:i(()=>[n("14")]),_:1}),t(p(N),{as:"a"},{default:i(()=>[n("16")]),_:1}),t(p(N),{as:"a"},{default:i(()=>[n("34")]),_:1})]),_:1})]),_:1}))}},ox={__name:"Label",setup(e){const a=[{id:"label",label:"Label",category:"Types",component:Z0},{id:"image",label:"Image",category:"Types",component:lk},{id:"pointing",label:"Pointing",category:"Types",component:ck},{id:"corner",label:"Corner",category:"Types",component:mk},{id:"tag",label:"Tag",category:"Types",component:fk},{id:"ribbon",label:"Ribbon",category:"Types",component:yk},{id:"attached",label:"Attached",category:"Types",component:wk},{id:"horizontal",label:"Horizontal",category:"Types",component:Ak},{id:"floating",label:"Floating",category:"Types",component:xk},{id:"inverted",label:"Inverted",category:"Types",component:Bk},{id:"detail",label:"Detail",category:"Content",component:Lk},{id:"icon",label:"Icon",category:"Content",component:Dk},{id:"link",label:"Link",category:"Content",component:Rk},{id:"disabled",label:"Disabled",category:"States",component:Pk},{id:"fluid",label:"Fluid",category:"Variations",component:Vk},{id:"circular",label:"Circular",category:"Variations",component:Hk},{id:"basic",label:"Basic",category:"Variations",component:jk},{id:"colored",label:"Colored",category:"Variations",component:qk},{id:"basic-tag",label:"Basic Tag",category:"Variations",component:Yk},{id:"size",label:"Size",category:"Variations",component:Wk},{id:"group-size",label:"Group Size",category:"Groups",component:Xk},{id:"colored-group",label:"Colored Group",category:"Groups",component:Zk},{id:"basic-group",label:"Basic Group",category:"Groups",component:tx},{id:"tag-group",label:"Tag Group",category:"Groups",component:ax},{id:"circular-group",label:"Circular Group",category:"Groups",component:nx}];return(l,o)=>($(),D(Ct,{title:"Label",description:"A label displays content classification","component-docs":a}))}},sx=ub(wh);function rx(e){return e&&typeof e=="object"&&"default"in e?e.default:e}var Al=sx,Xn=rx(Pm),ux=Al.defineComponent({props:{code:{type:String},inline:{type:Boolean,default:!1},language:{type:String,default:"markup"}},setup:function(a,l){var o=l.slots,r=l.attrs,c=o&&o.default&&o.default()||[],m=a.code||c&&c.length?c[0].children:"",f=a.inline,s=a.language,u=Xn.languages[s],g="language-".concat(s);return function(){return f?Al.h("code",{class:[g],innerHTML:Xn.highlight(m,u)}):Al.h("pre",Object.assign({},r,{class:[r.class,g]}),[Al.h("code",Object.assign({},r,{class:[r.class,g],innerHTML:Xn.highlight(m,u)}))])}}}),cx=ux;const dx=Rm(cx),mx=R({name:"DocExample",components:{Prism:dx},props:{title:String,description:String,code:String},setup(){const e=G(!1);return{active:e,toggle:()=>e.value=!e.value}}}),px={class:"example"};function fx(e,a,l,o,r,c){const m=y("sui-header-subheader"),f=y("sui-header"),s=y("sui-grid-column"),u=y("sui-icon"),g=y("sui-grid-row"),d=y("prism"),h=y("sui-grid");return $(),he("div",px,[t(h,{columns:2},{default:i(()=>[t(g,null,{default:i(()=>[t(s,null,{default:i(()=>[t(f,{as:"h3"},{default:i(()=>[n(Te(e.title)+" ",1),t(m,null,{default:i(()=>[n(Te(e.description),1)]),_:1})]),_:1})]),_:1}),t(s,{textAlign:"right"},{default:i(()=>[t(u,{name:"code",color:"grey",onClick:e.toggle,link:""},null,8,["onClick"])]),_:1})]),_:1}),t(g,null,{default:i(()=>[t(s,{width:16},{default:i(()=>[Fi(e.$slots,"default",{},void 0,!0)]),_:3}),e.active?($(),D(s,{key:0,width:16},{default:i(()=>[t(d,{language:"markup"},{default:i(()=>[n(Te(e.code),1)]),_:1})]),_:1})):vs("",!0)]),_:3})]),_:3})])}const Ge=ke(mx,[["render",fx],["__scopeId","data-v-fcfb6a67"]]),gx="/vue-fomantic-ui/images/avatar/small/rachel.png",hx="/vue-fomantic-ui/images/avatar/small/lindsay.png",_x="/vue-fomantic-ui/images/avatar/small/matthew.png",$n="/vue-fomantic-ui/images/avatar/small/jenny.jpg",bx="/vue-fomantic-ui/images/avatar/small/tom.jpg",kl="/vue-fomantic-ui/images/avatar/small/christian.jpg",Bn="/vue-fomantic-ui/images/avatar/small/matt.jpg",Va="/vue-fomantic-ui/images/avatar/small/helen.jpg",Ti="/vue-fomantic-ui/images/avatar/small/daniel.jpg",jo="/vue-fomantic-ui/images/avatar/small/stevie.jpg",Wt="/vue-fomantic-ui/images/wireframe/square-image.png",vx=R({name:"ListDoc",components:{DocExample:Ge},setup(){return{listCode:`<sui-list>
...
</div>`}}}),yx={class:"intro"},Sx=S("div",null,"Benefits",-1),wx={class:"list"},Cx=S("a",null,"Languages",-1),Ax=S("a",null,[S("b",null,"Arrested Development")],-1),kx=S("a",null,[S("b",null,"Bob's Burgers")],-1),xx=S("a",null,[S("b",null,"The Godfather Part 2")],-1),$x=S("a",null,[S("b",null,"Twin Peaks")],-1),Bx=S("a",null,[S("b",null,"Arrested Development")],-1),Tx=S("a",null,[S("b",null,"Bob's Burgers")],-1),Lx=S("a",null,[S("b",null,"The Godfather Part 2")],-1);function Ix(e,a,l,o,r,c){const m=y("sui-header-subheader"),f=y("sui-header"),s=y("sui-divider"),u=y("sui-icon"),g=y("sui-menu-item"),d=y("sui-menu"),h=y("sui-container"),v=y("sui-segment"),_=y("sui-list-item"),C=y("sui-list"),k=y("doc-example"),T=y("sui-list-list"),b=y("sui-list-header"),w=y("sui-list-description"),x=y("sui-list-content"),B=y("sui-image");return $(),he("div",null,[t(v,{vertical:""},{default:i(()=>[t(h,{class:"main"},{default:i(()=>[S("div",yx,[t(f,{as:"h1"},{default:i(()=>[n("List "),t(m,null,{default:i(()=>[n(" A list is used to group related content ")]),_:1})]),_:1}),t(s,{hidden:""}),t(d,{floated:"right"},{default:i(()=>[t(g,{as:"a",icon:""},{default:i(()=>[t(u,{name:"edit"})]),_:1}),t(g,{as:"a",icon:""},{default:i(()=>[t(u,{name:"github"})]),_:1})]),_:1})])]),_:1})]),_:1}),t(h,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(k,{title:"List",description:"A list groups related content",code:e.listCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[n("Apples")]),_:1}),t(_,null,{default:i(()=>[n("Pears")]),_:1}),t(_,null,{default:i(()=>[n("Oranges")]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Bulleted",description:"A list can mark items with a bullet",code:e.bulletedCode},{default:i(()=>[t(C,{bulleted:""},{default:i(()=>[t(_,null,{default:i(()=>[n("Gaining Access")]),_:1}),t(_,null,{default:i(()=>[n("Inviting Friends")]),_:1}),t(_,null,{default:i(()=>[Sx,S("div",wx,[t(_,{as:"a"},{default:i(()=>[n("Link to somewhere")]),_:1}),t(_,null,{default:i(()=>[n("Rebates")]),_:1}),t(_,null,{default:i(()=>[n("Discounts")]),_:1})])]),_:1}),t(_,null,{default:i(()=>[n("Warranty")]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Ordered",description:"A list can be ordered numerically",code:e.orderedCode},{default:i(()=>[t(C,{ordered:""},{default:i(()=>[t(_,{as:"a"},{default:i(()=>[n("Getting Started")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Introduction")]),_:1}),t(_,null,{default:i(()=>[Cx,t(T,null,{default:i(()=>[t(_,{as:"a"},{default:i(()=>[n("HTML")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Javascript")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("CSS")]),_:1})]),_:1})]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Review")]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Link",description:"A list can be specially formatted for navigation links",code:e.linkCode},{default:i(()=>[t(C,{link:""},{default:i(()=>[t(_,{active:""},{default:i(()=>[n("Home")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("About")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Jobs")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Team")]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Content")]),_:1}),t(k,{title:"Item",description:"A list item can contain a set of items",code:e.itemCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[n("1")]),_:1}),t(_,null,{default:i(()=>[n("2")]),_:1}),t(_,null,{default:i(()=>[n("3")]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Icon",description:"A list item can contain an icon",code:e.iconCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,{as:"a"},{default:i(()=>[t(u,{name:"help"}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Floated Icon")]),_:1}),t(w,null,{default:i(()=>[n(" This text will always have a left margin to make sure it sits alongside your icon ")]),_:1})]),_:1})]),_:1}),t(_,{as:"a"},{default:i(()=>[t(u,{name:"right triangle"}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Icon Alignment")]),_:1}),t(w,null,{default:i(()=>[n(" Floated icons are by default top aligned. To have an icon top aligned try this example ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(u,{name:"help"}),n(" Inline Text ")]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Image",description:"A list can contain an image",code:e.imageContentCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:gx}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Rachel")]),_:1}),t(w,null,{default:i(()=>[n(" Last seen watching "),Ax,n(" just now. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:hx}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Lindsay")]),_:1}),t(w,null,{default:i(()=>[n(" Last seen watching "),kx,n(" 10 hours ago. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:_x}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Matthew")]),_:1}),t(w,null,{default:i(()=>[n(" Last seen watching "),xx,n(" yesterday. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:$n}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Jenny Hess")]),_:1}),t(w,null,{default:i(()=>[n(" Last seen watching "),$x,n(" 3 days ago. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:rp}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Veronika Ossi")]),_:1}),t(w,null,{default:i(()=>[n(" Has not watched anything recently ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Link",description:"A list can contain links",code:e.linkContentCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,{as:"a"},{default:i(()=>[n("What is a FAQ?")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Who is our user?")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Where is our office located?")]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"header",description:"A list item can contain a header",code:e.headerContentCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(b,null,{default:i(()=>[n("New York City")]),_:1}),n(" A lovely city ")]),_:1}),t(_,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Chicago")]),_:1}),n(" Also quite a lovely city ")]),_:1}),t(_,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Los Angeles")]),_:1}),n(" Sometimes can be a lovely city ")]),_:1}),t(_,null,{default:i(()=>[t(b,null,{default:i(()=>[n("San Francisco")]),_:1}),n(" What a lovely city ")]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Description",description:"A list item can contain a description",code:e.descriptionContentCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(u,{name:"map marker"}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Krolewskie Jadlo")]),_:1}),t(w,null,{default:i(()=>[n(" An excellent polish restaurant, quick delivery and hearty, filling meals. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(u,{name:"map marker"}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Xian Famous Foods")]),_:1}),t(w,null,{default:i(()=>[n(" A taste of Shaanxi's delicious culinary traditions, with delights like spicy cold noodles and lamb burgers. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(u,{name:"map marker"}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Sapporo Haru")]),_:1}),t(w,null,{default:i(()=>[n(" Greenpoint's best choice for quick and delicious sushi. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(u,{name:"map marker"}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Enid's")]),_:1}),t(w,null,{default:i(()=>[n(" At night a bar, during the day a delicious brunch spot. ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(k,{title:"Horizontal",description:"A list can be formatted to have items appear horizontally",code:e.horizontalVarCode},{default:i(()=>[t(C,{horizontal:""},{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:bx}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Tom")]),_:1}),n(" Top Contributor ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:kl}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Christian Rocha")]),_:1}),n(" Admin ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:Bn}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Matt")]),_:1}),n(" Top Rated User ")]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Inverted",description:"A list can be inverted to appear on a dark background",code:e.invertedVarCode},{default:i(()=>[t(v,{inverted:""},{default:i(()=>[t(C,{inverted:"",relaxed:"",divided:""},{default:i(()=>[t(_,null,{default:i(()=>[t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Snickerdoodle")]),_:1}),n(" An excellent companion ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Poodle")]),_:1}),n(" A poodle, its pretty basic ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Paulo")]),_:1}),n(" He's also a dog ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Selection",description:"A selection list formats list items as possible choices",code:e.selectionVarCode},{default:i(()=>[t(C,{selection:"",verticalAlign:"middle"},{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:Va}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Helen")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:kl}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Christian")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:Ti}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Daniel")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Animated",description:"A list can animate to set the current item apart from the list",code:e.animatedVarCode},{default:i(()=>[t(C,{animated:"",verticalAlign:"middle"},{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:Va}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Helen")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:kl}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Christian")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:Ti}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Daniel")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Relaxed",description:"A list can relax its padding to provide more negative space",code:e.relaxedVarCode},{default:i(()=>[t(C,{relaxed:""},{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:Ti}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Daniel Louise")]),_:1}),t(w,null,{default:i(()=>[n(" Last seen watching "),Bx,n(" just now. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:jo}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Stevie Feliciano")]),_:1}),t(w,null,{default:i(()=>[n(" Last seen watching "),Tx,n(" 10 hours ago. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:ei}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Elliot Fu")]),_:1}),t(w,null,{default:i(()=>[n(" Last seen watching "),Lx,n(" yesterday. ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Divided",description:"A list can show divisions between content",code:e.dividedVarCode},{default:i(()=>[t(C,{divided:"",verticalAlign:"middle"},{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:Ti}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Daniel Louise")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:jo}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Stevie Feliciano")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:ei}),t(x,null,{default:i(()=>[t(b,{as:"a"},{default:i(()=>[n("Elliot Fu")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Celled",description:"A list can divide its items into cells",code:e.celledVarCode},{default:i(()=>[t(C,{celled:""},{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:Va}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Snickerdoodle")]),_:1}),n(" An excellent companion ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:Ti}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Poodle")]),_:1}),n(" A poodle, its pretty basic ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:Ti}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Paulo")]),_:1}),n(" He's also a dog ")]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Size",description:"A list can vary in size",code:e.sizeCode},{default:i(()=>[t(C,{horizontal:"",divided:"",size:"mini"},{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:Va}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Helen")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:kl}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Christian")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:Ti}),t(x,null,{default:i(()=>[t(b,null,{default:i(()=>[n("Daniel")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Content Variations")]),_:1}),t(k,{title:"Vertical Aligned",description:"An element inside a list can be vertically aligned",code:e.verticalAlignedCode},{default:i(()=>[t(C,{horizontal:""},{default:i(()=>[t(_,null,{default:i(()=>[t(B,{avatar:"",src:Wt}),t(x,{verticalAlign:"top"},{default:i(()=>[n(" Top Aligned ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:Wt}),t(x,{verticalAlign:"middle"},{default:i(()=>[n(" Middle ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(B,{avatar:"",src:Wt}),t(x,{verticalAlign:"bottom"},{default:i(()=>[n(" Bottom ")]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Floated",description:"An list, or an element inside a list can be floated left or right",code:e.floatedCode},{default:i(()=>[S("div",null,[t(C,{floated:"right",horizontal:""},{default:i(()=>[t(_,{disabled:""},{default:i(()=>[n("© GitHub, Inc.")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Terms")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Privacy")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Contact")]),_:1})]),_:1}),t(C,{horizontal:""},{default:i(()=>[t(_,{as:"a"},{default:i(()=>[n("About Us")]),_:1}),t(_,{as:"a"},{default:i(()=>[n("Jobs")]),_:1})]),_:1})])]),_:1},8,["code"])]),_:1})])}const Dx=ke(vx,[["render",Ix]]),Ex=`<template>
  <SuiSegment>
    <SuiDimmer active>
      <SuiLoader />
    </SuiDimmer>
...
</template>`,Rx={__name:"LoaderDoc",setup(e){return(a,l)=>($(),D(M,{label:"Loader",code:Ex},{description:i(()=>[n(" A loader ")]),example:i(()=>[t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re))]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},zx=`<template>
  <SuiSegment>
    <SuiDimmer active>
...
</template>`,Px={__name:"TextLoaderDoc",setup(e){return(a,l)=>($(),D(M,{label:"Text Loader",code:zx},{description:i(()=>[n(" A loader can contain text ")]),example:i(()=>[t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re),{text:""},{default:i(()=>[n("Loading")]),_:1})]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},Mx=`<template>
  <SuiSegment>
    <SuiDimmer active>
...
</template>`,Vx={__name:"IndeterminateDoc",setup(e){return(a,l)=>($(),D(M,{label:"Indeterminate",code:Mx},{description:i(()=>[n(" A loader can show it's unsure of how long a task will take ")]),example:i(()=>[t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re),{Indeterminate:"",text:""},{default:i(()=>[n("Preparing Files")]),_:1})]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},Fx=`<template>
  <SuiSegment>
    <SuiLoader active />

    <SuiImage src="/images/wireframe/short-paragraph.png" />
  </SuiSegment>
</template>`,Hx={__name:"ActiveDoc",setup(e){return(a,l)=>($(),D(M,{label:"Active",code:Fx},{description:i(()=>[n(" A loader can be active or visible ")]),example:i(()=>[t(p(Le),null,{default:i(()=>[t(p(Re),{active:""}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},Nx=`<template>
  <SuiSegment>
    <SuiLoader disabled />

    <SuiImage src="/images/wireframe/short-paragraph.png" />
  </SuiSegment>
</template>`,Ox={__name:"DisabledDoc",setup(e){return(a,l)=>($(),D(M,{label:"Disabled",code:Nx},{description:i(()=>[n(" A loader can be disabled or hidden ")]),example:i(()=>[t(p(Le),null,{default:i(()=>[t(p(Re),{disabled:""}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},jx=`<template>
  <SuiLoader active inline />
</template>`,Gx={__name:"InlineDoc",setup(e){return(a,l)=>($(),D(M,{label:"Inline",code:jx},{description:i(()=>[n(" Loaders can appear inline with content ")]),example:i(()=>[t(p(Re),{active:"",inline:""})]),_:1}))}},qx=`<template>
  <SuiLoader active inline />
</template>`,Ux={__name:"InlineCenterDoc",setup(e){return(a,l)=>($(),D(M,{label:"Inline Center",code:qx},{description:i(()=>[n(" Loaders can appear inline centered with content ")]),example:i(()=>[t(p(Re),{active:"",inline:"centered"})]),_:1}))}},Yx=`<template>
  <SuiLoader slow active inline />
  <SuiLoader active inline />
  <SuiLoader fast active inline />
</template>`,Jx={__name:"SpeedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Speed",code:Yx},{description:i(()=>[n(" Loaders can appear slow, normal or fast ")]),example:i(()=>[t(p(Re),{slow:"",active:"",inline:""}),t(p(Re),{active:"",inline:""}),t(p(Re),{fast:"",active:"",inline:""})]),_:1}))}},Wx=`<template>
...
</template>`,Kx={__name:"ColorsDoc",setup(e){return(a,l)=>($(),D(M,{label:"Colors",code:Wx},{description:i(()=>[n(" Loaders can be different colors ")]),example:i(()=>[t(p(Re),{active:"",inline:"",primary:""}),t(p(Re),{active:"",inline:"",secondary:""}),t(p(Re),{active:"",inline:"",color:"red"}),t(p(Re),{active:"",inline:"",color:"orange"}),t(p(Re),{active:"",inline:"",color:"yellow"}),t(p(Re),{active:"",inline:"",color:"olive"}),t(p(Re),{active:"",inline:"",color:"green"}),t(p(Re),{active:"",inline:"",color:"teal"}),t(p(Re),{active:"",inline:"",color:"blue"}),t(p(Re),{active:"",inline:"",color:"violet"}),t(p(Re),{active:"",inline:"",color:"purple"}),t(p(Re),{active:"",inline:"",color:"pink"}),t(p(Re),{active:"",inline:"",color:"brown"}),t(p(Re),{active:"",inline:"",color:"grey"}),t(p(Re),{active:"",inline:"",color:"black"})]),_:1}))}},Xx=`<template>
  <SuiSegment>
    <SuiDimmer active>
...
</template>`,Qx={__name:"SizeDoc",setup(e){return(a,l)=>($(),D(M,{label:"Size",code:Xx},{description:i(()=>[n(" Loaders can have different sizes ")]),example:i(()=>[t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re),{text:"",size:"mini"},{default:i(()=>[n("Loading")]),_:1})]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re),{text:"",size:"tiny"},{default:i(()=>[n("Loading")]),_:1})]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re),{text:"",size:"small"},{default:i(()=>[n("Loading")]),_:1})]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re),{text:"",size:"large"},{default:i(()=>[n("Loading")]),_:1})]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re),{text:"",size:"big"},{default:i(()=>[n("Loading")]),_:1})]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1}),t(p(Le),null,{default:i(()=>[t(p(Vt),{active:""},{default:i(()=>[t(p(Re),{text:"",size:"huge"},{default:i(()=>[n("Loading")]),_:1})]),_:1}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},Zx=`<template>
  <SuiSegment inverted>
    <SuiLoader active inverted />

    <SuiImage src="/vue-fomantic-ui/images/wireframe/short-paragraph.png" />
  </SuiSegment>
</template>`,e$={__name:"InvertedDoc",setup(e){return(a,l)=>($(),D(M,{label:"Inverted",code:Zx},{description:i(()=>[n(" Loaders can have their colors inverted. ")]),example:i(()=>[t(p(Le),{inverted:""},{default:i(()=>[t(p(Re),{active:"",inverted:""}),t(p(ce),{src:"/vue-fomantic-ui/images/wireframe/short-paragraph.png"})]),_:1})]),_:1}))}},t$={__name:"Loader",setup(e){const a=[{id:"loader",label:"Loader",category:"Types",component:Rx},{id:"text-loader",label:"Text Loader",category:"Types",component:Px},{id:"indeterminate",label:"Indeterminate",category:"States",component:Vx},{id:"active",label:"Active",category:"States",component:Hx},{id:"disabled",label:"Disabled",category:"States",component:Ox},{id:"inline",label:"Inline",category:"Variations",component:Gx},{id:"inline-center",label:"Inline Center",category:"Variations",component:Ux},{id:"speed",label:"Speed",category:"Variations",component:Jx},{id:"colors",label:"Colors",category:"Variations",component:Kx},{id:"size",label:"Size",category:"Variations",component:Qx},{id:"inverted",label:"Inverted",category:"Variations",component:e$}];return(l,o)=>($(),D(Ct,{title:"Loader",description:"A loader alerts a user to wait for an activity to complete","component-docs":a}))}},at="/vue-fomantic-ui/images/wireframe/short-paragraph.png",i$=R({name:"RailDoc",components:{DocExample:Ge},setup(){return{railCode:`<sui-grid centered :columns="3">
  <sui-grid-column>
    <sui-segment>
  ...
  <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. 
    Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero 
    sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
</sui-segment>`}}}),m$={class:"intro"},p$=S("p",null,"Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.",-1),f$=S("p",null,"Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.",-1),g$=S("p",null,"Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.",-1),h$=S("p",null,"Top",-1),_$=S("p",null,"Middle",-1),b$=S("p",null,"Middle",-1),v$=S("p",null,"Middle",-1),y$=S("p",null,"Bottom",-1),S$=S("p",null,"I'm here to tell you something, and you will probably read me first.",-1),w$=S("p",null,"This segment is on top",-1),C$=S("p",null,"This segment is attached on both sides",-1),A$=S("p",null,"This segment is on bottom",-1),k$=S("p",null,"Fitted Segment",-1),x$=S("p",null,"Horizontally fitted segment",-1),$$=S("p",null,"Vertically fitted segment",-1),B$=S("p",null,"I'm here to tell you something, and you will probably read me first.",-1),T$=S("p",null,"I am pretty noticeable but you might check out other content before you look at me.",-1),L$=S("p",null,"If you notice me you must be looking very hard.",-1),I$=S("p",null,"This segment will appear to the right",-1),D$=S("p",null,"This segment will appear to the left",-1),E$=S("p",null,"Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.",-1);function R$(e,a,l,o,r,c){const m=y("sui-header-subheader"),f=y("sui-header"),s=y("sui-divider"),u=y("sui-icon"),g=y("sui-menu-item"),d=y("sui-menu"),h=y("sui-container"),v=y("sui-segment"),_=y("doc-example"),C=y("sui-button"),k=y("sui-segment-group");return $(),he("div",null,[t(v,{vertical:""},{default:i(()=>[t(h,{class:"main"},{default:i(()=>[S("div",m$,[t(f,{as:"h1"},{default:i(()=>[n("Segment "),t(m,null,{default:i(()=>[n(" A segment is used to create a grouping of related content ")]),_:1})]),_:1}),t(s,{hidden:""}),t(d,{floated:"right"},{default:i(()=>[t(g,{as:"a",icon:""},{default:i(()=>[t(u,{name:"edit"})]),_:1}),t(g,{as:"a",icon:""},{default:i(()=>[t(u,{name:"github"})]),_:1})]),_:1})])]),_:1})]),_:1}),t(h,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(_,{title:"Segment",description:"A segment of content",code:e.segmentCode},{default:i(()=>[t(v,null,{default:i(()=>[n("Pellentesque habitant morbi tristique senectus.")]),_:1})]),_:1},8,["code"]),t(_,{title:"Placeholder Segment",description:"A segment can be used to reserve space for conditionally displayed content",code:e.placeholderCode},{default:i(()=>[t(v,{placeholder:""},{default:i(()=>[t(f,{icon:""},{default:i(()=>[t(u,{name:"file outline"}),n(" No documents are listed for this customer. ")]),_:1}),t(C,{color:"primary"},{default:i(()=>[n("Add Document")]),_:1})]),_:1})]),_:1},8,["code"]),t(_,{title:"Raised",description:"A segment may be formatted to raise above the page",code:e.raisedCode},{default:i(()=>[t(v,{raised:""},{default:i(()=>[p$]),_:1})]),_:1},8,["code"]),t(_,{title:"Stacked",description:"A segment can be formatted to show it contains multiple pages",code:e.stackedCode},{default:i(()=>[t(v,{stacked:""},{default:i(()=>[f$]),_:1})]),_:1},8,["code"]),t(_,{title:"Piled",description:"A segment can be formatted to look like a pile of pages",code:e.piledCode},{default:i(()=>[t(v,{piled:""},{default:i(()=>[g$]),_:1})]),_:1},8,["code"]),t(_,{title:"Vertical Segment",description:"A vertical segment formats content to be aligned as part of a vertical group",code:e.verticalCode},{default:i(()=>[S("div",null,[t(v,{vertical:""},{default:i(()=>[n(" Te eum doming eirmod, nominati pertinacia argumentum ad his. ")]),_:1}),t(v,{vertical:""},{default:i(()=>[n(" Pellentesque habitant morbi tristique senectus. ")]),_:1}),t(v,{vertical:""},{default:i(()=>[n(" Eu quo homero blandit intellegebat. Incorrupte consequuntur mei id. ")]),_:1})])]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Groups")]),_:1}),t(_,{title:"Segments",description:"A group of segments can be formatted to appear together",code:e.segmentsCode},{default:i(()=>[t(k,null,{default:i(()=>[t(v,null,{default:i(()=>[h$]),_:1}),t(v,null,{default:i(()=>[_$]),_:1}),t(v,null,{default:i(()=>[b$]),_:1}),t(v,null,{default:i(()=>[v$]),_:1}),t(v,null,{default:i(()=>[y$]),_:1})]),_:1})]),_:1},8,["code"]),t(_,{title:"Nested Segments",description:"A group of segments can be nested in another group of segments",code:e.nestedCode},{default:i(()=>[t(k,null,{default:i(()=>[t(v,null,{default:i(()=>[n("Top")]),_:1}),t(k,null,{default:i(()=>[t(v,null,{default:i(()=>[n("Nested Top")]),_:1}),t(v,null,{default:i(()=>[n("Nested Middle")]),_:1}),t(v,null,{default:i(()=>[n("Nested Bottom")]),_:1})]),_:1}),t(k,{horizontal:""},{default:i(()=>[t(v,null,{default:i(()=>[n("Top")]),_:1}),t(v,null,{default:i(()=>[n("Middle")]),_:1}),t(v,null,{default:i(()=>[n("Bottom")]),_:1})]),_:1}),t(v,null,{default:i(()=>[n("Bottom")]),_:1})]),_:1})]),_:1},8,["code"]),t(_,{title:"Horizontal Segments",description:"A segment group can appear horizontally",code:e.horizontalCode},{default:i(()=>[t(k,{horizontal:""},{default:i(()=>[t(v,null,{default:i(()=>[n("Left")]),_:1}),t(v,null,{default:i(()=>[n("Middle")]),_:1}),t(v,null,{default:i(()=>[n("Right")]),_:1})]),_:1})]),_:1},8,["code"]),t(_,{title:"Raised Segments",description:"A group of segments can be raised",code:e.raisedSegmentsCode},{default:i(()=>[t(k,{raised:""},{default:i(()=>[t(v,null,{default:i(()=>[n("Top")]),_:1}),t(v,null,{default:i(()=>[n("Middle")]),_:1}),t(v,null,{default:i(()=>[n("Bottom")]),_:1})]),_:1})]),_:1},8,["code"]),t(_,{title:"Stacked Segments",description:"A group of segments can be stacked",code:e.stackedSegmentsCode},{default:i(()=>[t(k,{stacked:""},{default:i(()=>[t(v,null,{default:i(()=>[n("Top")]),_:1}),t(v,null,{default:i(()=>[n("Middle")]),_:1}),t(v,null,{default:i(()=>[n("Bottom")]),_:1})]),_:1})]),_:1},8,["code"]),t(_,{title:"Piled Segments",description:"A group of segments can be piled",code:e.piledSegmentsCode},{default:i(()=>[t(k,{piled:""},{default:i(()=>[t(v,null,{default:i(()=>[n("Top")]),_:1}),t(v,null,{default:i(()=>[n("Middle")]),_:1}),t(v,null,{default:i(()=>[n("Bottom")]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("States")]),_:1}),t(_,{title:"Disabled",description:"A segment may show its content is disabled",code:e.disabledCode},{default:i(()=>[t(v,{disabled:""},{default:i(()=>[n("Disabled content")]),_:1})]),_:1},8,["code"]),t(_,{title:"Loading",description:"A segment may show its content is being loaded",code:e.loadingCode},{default:i(()=>[t(v,{loading:""},{default:i(()=>[n("Now Loading...")]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(_,{title:"Inverted",description:"A segment can have its colors inverted for contrast",code:e.invertedCode},{default:i(()=>[t(v,{inverted:""},{default:i(()=>[S$]),_:1})]),_:1},8,["code"]),t(_,{title:"Attached",description:"A segment can be attached to other content on a page",code:e.attachedCode},{default:i(()=>[S("div",null,[t(v,{attached:"top"},{default:i(()=>[w$]),_:1}),t(v,{attached:""},{default:i(()=>[C$]),_:1}),t(v,{attached:"bottom"},{default:i(()=>[A$]),_:1})])]),_:1},8,["code"]),t(_,{title:"Padded",description:"A segment can increase its padding",code:e.paddedCode},{default:i(()=>[t(v,{padded:""},{default:i(()=>[n("Padded content")]),_:1})]),_:1},8,["code"]),t(_,{title:"Fitted",description:"A segment can remove its padding, vertically or horizontally",code:e.fittedCode},{default:i(()=>[S("div",null,[t(v,{fitted:""},{default:i(()=>[k$]),_:1}),t(v,{fitted:"horizontally"},{default:i(()=>[x$]),_:1}),t(v,{fitted:"vertically"},{default:i(()=>[$$]),_:1})])]),_:1},8,["code"]),t(_,{title:"Compact",description:"A segment may take up only as much space as is necessary",code:e.compactCode},{default:i(()=>[t(v,{compact:""},{default:i(()=>[n("Compact content")]),_:1})]),_:1},8,["code"]),t(_,{title:"Colored",description:"A segment can be colored",code:e.coloredCode},{default:i(()=>[S("div",null,[t(v,{color:"red"},{default:i(()=>[n("Red")]),_:1}),t(v,{color:"orange"},{default:i(()=>[n("Orange")]),_:1}),t(v,{color:"yellow"},{default:i(()=>[n("Yellow")]),_:1}),t(v,{color:"olive"},{default:i(()=>[n("Olive")]),_:1}),t(v,{color:"green"},{default:i(()=>[n("Green")]),_:1}),t(v,{color:"teal"},{default:i(()=>[n("Teal")]),_:1}),t(v,{color:"blue"},{default:i(()=>[n("Blue")]),_:1}),t(v,{color:"violet"},{default:i(()=>[n("Violet")]),_:1}),t(v,{color:"purple"},{default:i(()=>[n("Purple")]),_:1}),t(v,{color:"pink"},{default:i(()=>[n("Pink")]),_:1}),t(v,{color:"brown"},{default:i(()=>[n("Brown")]),_:1}),t(v,{color:"grey"},{default:i(()=>[n("Grey")]),_:1}),t(v,{color:"black"},{default:i(()=>[n("Black")]),_:1})])]),_:1},8,["code"]),t(_,{title:"Emphasis",description:"A segment can be formatted to appear more or less noticeable",code:e.emphasisCode},{default:i(()=>[S("div",null,[t(v,null,{default:i(()=>[B$]),_:1}),t(v,{secondary:""},{default:i(()=>[T$]),_:1}),t(v,{tertiary:""},{default:i(()=>[L$]),_:1})])]),_:1},8,["code"]),t(_,{title:"Circular",description:"A segment can be circular",code:e.circularCode},{default:i(()=>[S("div",null,[t(v,{circular:"",style:{width:"175px",height:"175px"}},{default:i(()=>[t(f,{as:"h2"},{default:i(()=>[n(" Buy Now "),t(m,null,{default:i(()=>[n(" $10.99 ")]),_:1})]),_:1})]),_:1}),t(v,{inverted:"",circular:"",style:{width:"175px",height:"175px"}},{default:i(()=>[t(f,{as:"h2"},{default:i(()=>[n(" Buy Now "),t(m,null,{default:i(()=>[n(" $10.99 ")]),_:1})]),_:1})]),_:1})])]),_:1},8,["code"]),t(_,{title:"Clearing",description:"A segment can clear floated content",code:e.clearingCode},{default:i(()=>[t(v,{clearing:""},{default:i(()=>[t(C,{floated:"right"},{default:i(()=>[n("Floated")]),_:1})]),_:1})]),_:1},8,["code"]),t(_,{title:"Floated",description:"A segment can appear to the left or right of other content",code:e.floatedCode},{default:i(()=>[S("div",null,[t(v,{floated:"right"},{default:i(()=>[I$]),_:1}),t(v,{floated:"left"},{default:i(()=>[D$]),_:1})])]),_:1},8,["code"]),t(_,{title:"Text Alignment",description:"A segment can have its text aligned to a side",code:e.textAlignCode},{default:i(()=>[S("div",null,[t(v,{textAlign:"right"},{default:i(()=>[n(" Right ")]),_:1}),t(v,{textAlign:"left"},{default:i(()=>[n(" Left ")]),_:1}),t(v,{textAlign:"center"},{default:i(()=>[n(" Center ")]),_:1})])]),_:1},8,["code"]),t(_,{title:"Basic",description:"A basic segment has no special formatting",code:e.basicCode},{default:i(()=>[t(v,{basic:""},{default:i(()=>[E$]),_:1})]),_:1},8,["code"])]),_:1})])}const z$=ke(d$,[["render",R$]]),P$=R({name:"StepDoc",components:{DocExample:Ge},setup(){return{stepCode:`<sui-step-group>
...
/>`,dividerCode:`<sui-breadcrumb>
...
</div>`}}}),cB=S("p",null,"We just updated our privacy policy here to better service our customers. We recommend reviewing the changes.",-1),dB=S("p",null,"Get the best news in your e-mail every day.",-1),mB=S("p",null,"You can't see me",-1),pB=S("p",null,"You can always see me",-1),fB=S("p",null,"Way to go!",-1),gB=S("p",null,"Get all the best inventions in your e-mail every day. Sign up now!",-1),hB=S("a",{href:"#"},"Login here",-1),_B=S("p",null,[n("Go to your "),S("b",null,"special offers"),n(" page to see now.")],-1),bB=S("p",null,"That offer has expired",-1);function vB(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-message-header"),u=y("sui-message"),g=y("doc-example"),d=y("sui-message-item"),h=y("sui-message-list"),v=y("sui-icon"),_=y("sui-message-content"),C=y("sui-form-field"),k=y("sui-form-group"),T=y("sui-button"),b=y("sui-form"),w=y("sui-container");return $(),he("div",null,[t(m,{title:"Message",sub:"A message displays information that explains nearby content"}),t(w,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(g,{title:"Message",description:"A basic message",code:e.messageCode},{default:i(()=>[t(u,null,{default:i(()=>[t(s,null,{default:i(()=>[n("Changes in Service")]),_:1}),cB]),_:1})]),_:1},8,["code"]),t(g,{title:"List Message",description:"A message with a list",code:e.listMessageCode},{default:i(()=>[t(u,null,{default:i(()=>[t(s,null,{default:i(()=>[n("New Site Features")]),_:1}),t(h,null,{default:i(()=>[t(d,null,{default:i(()=>[n("You can now have cover images on blog pages")]),_:1}),t(d,null,{default:i(()=>[n("Drafts will now auto-save while writing")]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(g,{title:"Icon Message",description:"A message can contain an icon",code:e.iconMessageCode},{default:i(()=>[t(u,{icon:""},{default:i(()=>[t(v,{name:"inbox"}),t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[n(" Have you heard about our mailing list? ")]),_:1}),dB]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("States")]),_:1}),t(g,{title:"Hidden",description:"A message can be hidden",code:e.hiddenCode},{default:i(()=>[t(u,{hidden:""},{default:i(()=>[mB]),_:1})]),_:1},8,["code"]),t(g,{title:"Visible",description:"A message can be set to visible to force itself to be shown",code:e.visibleCode},{default:i(()=>[t(u,{visible:""},{default:i(()=>[pB]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(g,{title:"Floating",description:"A message can float above content that it is related to",code:e.floatingCode},{default:i(()=>[t(u,{floating:""},{default:i(()=>[fB]),_:1})]),_:1},8,["code"]),t(g,{title:"Compact",description:"A message can only take up the width of its content",code:e.compactCode},{default:i(()=>[t(u,{compact:""},{default:i(()=>[gB]),_:1})]),_:1},8,["code"]),t(g,{title:"Attached",description:"A message can be formatted to attach itself to other content",code:e.attachedCode},{default:i(()=>[S("div",null,[t(u,{attached:"",header:"Welcome to our site!",content:"Fill out the form below to sign-up for a new account"}),t(b,{class:"attached fluid segment"},{default:i(()=>[t(k,{widths:"equal"},{default:i(()=>[t(C,{label:"First Name",placeholder:"First Name"}),t(C,{label:"Last Name",placeholder:"Last Name"})]),_:1}),t(C,{label:"Username",placeholder:"Username"}),t(C,{label:"Password",placeholder:"Password"}),t(T,{color:"primary"},{default:i(()=>[n("Submit")]),_:1})]),_:1}),t(u,{attached:"bottom",warning:""},{default:i(()=>[t(v,{name:"help"}),n(" Already signed up? "),hB,n(" instead. ")]),_:1})])]),_:1},8,["code"]),t(g,{title:"Warning",description:"A message may be formatted to display warning messages",code:e.warningCode},{default:i(()=>[t(u,{warning:""},{default:i(()=>[t(v,{name:"close"}),t(s,null,{default:i(()=>[n(" You must register before you can do that! ")]),_:1}),n(" Visit our registration page, then try again ")]),_:1})]),_:1},8,["code"]),t(g,{title:"Info",description:"A message may be formatted to display information",code:e.infoCode},{default:i(()=>[t(u,{info:""},{default:i(()=>[t(s,null,{default:i(()=>[n("Was this what you wanted?")]),_:1}),t(h,null,{default:i(()=>[n("It's good to see you again.")]),_:1}),t(h,null,{default:i(()=>[n("Did you know it's been a while?")]),_:1})]),_:1})]),_:1},8,["code"]),t(g,{title:"Positive / Success",description:"A message may be formatted to display a positive message",code:e.positiveSuccessCode},{default:i(()=>[t(u,{positive:""},{default:i(()=>[t(s,null,{default:i(()=>[n("You are eligible for a reward")]),_:1}),_B]),_:1})]),_:1},8,["code"]),t(g,{title:"Negative / Error",description:"A message may be formatted to display a negative message",code:e.negativeErrorCode},{default:i(()=>[t(u,{negative:""},{default:i(()=>[t(v,{name:"close"}),t(s,null,{default:i(()=>[n("We're sorry we can't apply that discount")]),_:1}),bB]),_:1})]),_:1},8,["code"]),t(g,{title:"Colored",description:"A message can be formatted to be different colors",code:e.coloredCode},{default:i(()=>[S("div",null,[t(u,{color:"red"},{default:i(()=>[n("Red")]),_:1}),t(u,{color:"orange"},{default:i(()=>[n("Orange")]),_:1}),t(u,{color:"yellow"},{default:i(()=>[n("Yellow")]),_:1}),t(u,{color:"olive"},{default:i(()=>[n("Olive")]),_:1}),t(u,{color:"green"},{default:i(()=>[n("Green")]),_:1}),t(u,{color:"teal"},{default:i(()=>[n("Teal")]),_:1}),t(u,{color:"blue"},{default:i(()=>[n("Blue")]),_:1}),t(u,{color:"violet"},{default:i(()=>[n("Violet")]),_:1}),t(u,{color:"purple"},{default:i(()=>[n("Purple")]),_:1}),t(u,{color:"pink"},{default:i(()=>[n("Pink")]),_:1}),t(u,{color:"brown"},{default:i(()=>[n("Brown")]),_:1}),t(u,{color:"black"},{default:i(()=>[n("Black")]),_:1})])]),_:1},8,["code"]),t(g,{title:"Size",description:"A message can have different sizes",code:e.sizeCode},{default:i(()=>[S("div",null,[t(u,{size:"mini"},{default:i(()=>[n("This is a mini message.")]),_:1}),t(u,{size:"large"},{default:i(()=>[n("This is a large message.")]),_:1}),t(u,{size:"massive"},{default:i(()=>[n("This is a massive message.")]),_:1})])]),_:1},8,["code"])]),_:1})])}const yB=ke(uB,[["render",vB]]),SB=R({name:"TableDoc",components:{DocPageHeader:Ze,DocExample:Ge},setup(){return{tableCode:`<sui-table celled>
  <sui-table-header>
    <sui-table-row>
...
</sui-card-group>`}}}),jB=S("span",{class:"date"},"Joined in 2013",-1),GB=S("a",null,"Elliot Fu",-1),qB=S("a",null,"Jenny Hess",-1),UB=S("a",null,"Stevie Feliciano",-1),YB=S("a",null,"Administrator",-1),JB=S("a",null,"Helen Troy",-1),WB=S("span",{class:"date"},"Joined in 2013",-1),KB=S("span",null,"2 days ago",-1),XB=S("a",null,"Animals",-1),QB=S("p",null,"Cute dogs come in a variety of shapes and sizes. Some cute dogs are cute for their adorable faces, others for their tiny stature, and even others for their massive size.",-1),ZB=S("p",null,"Many people also have their own barometers for what makes a cute dog.",-1),eT=S("p",null,"Cute dogs come in a variety of shapes and sizes. Some cute dogs are cute for their adorable faces, others for their tiny stature, and even others for their massive size.",-1),tT=S("p",null,"Many people also have their own barometers for what makes a cute dog.",-1),iT=S("span",{class:"category"},"Animals",-1),aT=S("span",{class:"category"},"Animals",-1),lT=S("div",{class:"right floated author"},[S("img",{class:"ui avatar image",src:Bn}),n(" Matt ")],-1),nT=S("span",{class:"category"},"Animals",-1),oT=S("div",{class:"right floated author"},[S("img",{class:"ui avatar image",src:Bn}),n(" Matt ")],-1),sT=S("p",null,"Jenny is a student studying Media Management at the New School",-1),rT=S("div",{class:"center aligned author"},[S("img",{class:"ui avatar image",src:$n}),n(" Jenny ")],-1),uT=S("a",null,"Friends",-1),cT=S("span",{class:"right floated"}," Joined in 2013 ",-1),dT=S("a",null,[S("i",{class:"user icon"}),n(" 75 Friends ")],-1),mT=S("a",null,"Coworker",-1),pT=S("span",{class:"right floated"}," Joined in 2011 ",-1),fT=S("a",null,[S("i",{class:"user icon"}),n(" 35 Friends ")],-1),gT=S("a",null,"Coworker",-1),hT=S("span",{class:"right floated"}," Joined in 2014 ",-1),_T=S("a",null,[S("i",{class:"user icon"}),n(" 151 Friends ")],-1);function bT(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-image"),u=y("sui-card-header"),g=y("sui-card-meta"),d=y("sui-card-description"),h=y("sui-card-content"),v=y("sui-icon"),_=y("sui-card"),C=y("doc-example"),k=y("sui-button"),T=y("sui-button-group"),b=y("sui-card-group"),w=y("sui-feed-summary"),x=y("sui-feed-content"),B=y("sui-feed-event"),I=y("sui-feed"),V=y("sui-grid-column"),F=y("sui-grid"),z=y("sui-segment"),j=y("sui-container");return $(),he("div",null,[t(m,{title:"Card",sub:"A card displays site content in a manner similar to a playing card"}),t(j,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(C,{title:"Card",description:"A single card",code:e.cardCode},{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:Ac,wrapped:""}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Kristy")]),_:1}),t(g,null,{default:i(()=>[jB]),_:1}),t(d,null,{default:i(()=>[n(" Kristy is an art director living in New York. ")]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[S("a",null,[t(v,{name:"user"}),n(" 22 Friends ")])]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Cards",description:"A group of cards",code:e.cardsCode},{default:i(()=>[t(b,null,{default:i(()=>[t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(s,{src:ei,floated:"right",size:"mini"}),t(u,null,{default:i(()=>[n("Elliot Fu")]),_:1}),t(g,null,{default:i(()=>[n("Friends of Veronika")]),_:1}),t(d,null,{default:i(()=>[n("Elliot requested permission to view your contact details")]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[t(T,{widths:2},{default:i(()=>[t(k,{basic:"",color:"green"},{default:i(()=>[n("Approve")]),_:1}),t(k,{basic:"",color:"red"},{default:i(()=>[n("Decline")]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(s,{src:$n,floated:"right",size:"mini"}),t(u,null,{default:i(()=>[n("Jenny Hess")]),_:1}),t(g,null,{default:i(()=>[n("New Member")]),_:1}),t(d,null,{default:i(()=>[n("Jenny wants to add you to the group best friends")]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[t(T,{widths:2},{default:i(()=>[t(k,{basic:"",color:"green"},{default:i(()=>[n("Approve")]),_:1}),t(k,{basic:"",color:"red"},{default:i(()=>[n("Decline")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Content")]),_:1}),t(C,{title:"Content Block",description:"A card can contain blocks of content",code:e.contentBlockCode},{default:i(()=>[t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Project Timeline")]),_:1})]),_:1}),t(h,null,{default:i(()=>[t(f,{sub:""},{default:i(()=>[n("Activity")]),_:1}),t(I,{size:"small"},{default:i(()=>[t(B,null,{default:i(()=>[t(x,null,{default:i(()=>[t(w,null,{default:i(()=>[GB,n(" added "),qB,n(" to the project ")]),_:1})]),_:1})]),_:1}),t(B,null,{default:i(()=>[t(x,null,{default:i(()=>[t(w,null,{default:i(()=>[UB,n(" was added as an "),YB]),_:1})]),_:1})]),_:1}),t(B,null,{default:i(()=>[t(x,null,{default:i(()=>[t(w,null,{default:i(()=>[JB,n(" added two pictures ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[t(k,{as:"button"},{default:i(()=>[n("Join Project")]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Image",description:"A card can contain an image",code:e.imageCode},{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:Ac,wrapped:""}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Kristy")]),_:1}),t(g,null,{default:i(()=>[WB]),_:1}),t(d,null,{default:i(()=>[n(" Kristy is an art director living in New York. ")]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[S("a",null,[t(v,{name:"user"}),n(" 22 Friends ")])]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Header",description:"A card can contain a header",code:e.headerCode},{default:i(()=>[t(b,null,{default:i(()=>[t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Elliot Fu")]),_:1}),t(g,null,{default:i(()=>[n("Friend")]),_:1}),t(d,null,{default:i(()=>[n(" Elliot Fu is a film-maker from New York. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Veronika Ossi")]),_:1}),t(g,null,{default:i(()=>[n("Friend")]),_:1}),t(d,null,{default:i(()=>[n(" Veronika Ossi is a set designer living in New York who enjoys kittens, music, and partying. ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Jenny Hess")]),_:1}),t(g,null,{default:i(()=>[n("Friend")]),_:1}),t(d,null,{default:i(()=>[n(" Jenny is a student studying Media Management at the New School ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Metadata",description:"A card can contain content metadata",code:e.metadataCode},{default:i(()=>[t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Cute Dog")]),_:1}),t(g,null,{default:i(()=>[KB,XB]),_:1}),t(d,null,{default:i(()=>[t(s,{src:ze})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Buttons",description:"A card can contain buttons",code:e.buttonsCode},{default:i(()=>[t(b,null,{default:i(()=>[t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Elliot Fu")]),_:1}),t(d,null,{default:i(()=>[n(" Elliot Fu is a film-maker from New York. ")]),_:1})]),_:1}),t(k,{attached:"bottom"},{default:i(()=>[t(v,{name:"add"}),n(" Add Friend ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Veronika Ossi")]),_:1}),t(d,null,{default:i(()=>[n(" Veronika Ossi is a set designer living in New York who enjoys kittens, music, and partying. ")]),_:1})]),_:1}),t(k,{attached:"bottom"},{default:i(()=>[t(v,{name:"add"}),n(" Add Friend ")]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Description",description:"A card can contain a description with one or more paragraphs",code:e.descriptionCode},{default:i(()=>[t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Cute Dog")]),_:1}),t(g,null,{default:i(()=>[n("2 days ago")]),_:1}),t(d,null,{default:i(()=>[QB,ZB]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Extra Content",description:"A card can contain extra content meant to be formatted separately from the main content",code:e.extraContentCode},{default:i(()=>[t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Cute Dog")]),_:1}),t(g,null,{default:i(()=>[n("2 days ago")]),_:1}),t(d,null,{default:i(()=>[eT,tT]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[t(v,{name:"check"}),n(" 121 Votes ")]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(C,{title:"Fluid Card",description:"A fluid card takes up the width of its container",code:e.fluidCardCode},{default:i(()=>[t(F,{columns:3},{default:i(()=>[t(V,null,{default:i(()=>[t(_,{fluid:""},{default:i(()=>[t(s,{src:FB}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Daniel Louise")]),_:1})]),_:1})]),_:1})]),_:1}),t(V,null,{default:i(()=>[t(_,{fluid:""},{default:i(()=>[t(s,{src:Qn}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Helen Troy")]),_:1})]),_:1})]),_:1})]),_:1}),t(V,null,{default:i(()=>[t(_,{fluid:""},{default:i(()=>[t(s,{src:Zn}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Elliot Fu")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Centered Card",description:"A card can center itself inside its container",code:e.centeredCardCode},{default:i(()=>[t(_,{centered:""},{default:i(()=>[t(s,{src:eo}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Elyse")]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Horizontal Cards",description:"A card can display horizontally",code:e.horizontalCardsCode},{default:i(()=>[t(_,{horizontal:""},{default:i(()=>[t(s,{src:eo}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Cute Dog")]),_:1}),t(g,null,{default:i(()=>[iT]),_:1}),t(d,null,{default:i(()=>[t(s,{src:ze})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Raised Card",description:"A card may be formatted to raise above the page",code:e.raisedCode},{default:i(()=>[t(_,{raised:""},{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Cute Dog")]),_:1}),t(g,null,{default:i(()=>[aT]),_:1}),t(d,null,{default:i(()=>[t(s,{src:ze})]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[lT]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Link Card",description:"A card can be formatted so that the entire contents link to another page",code:e.linkCardCode},{default:i(()=>[t(_,{href:"#",raised:""},{default:i(()=>[t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Cute Dog")]),_:1}),t(g,null,{default:i(()=>[nT]),_:1}),t(d,null,{default:i(()=>[t(s,{src:ze})]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[oT]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Text Alignment",description:"Any element inside a card can have its text alignment specified",code:e.textAlignCode},{default:i(()=>[t(_,null,{default:i(()=>[t(h,null,{default:i(()=>[t(u,{textAlign:"center"},{default:i(()=>[n("Jenny Hess")]),_:1}),t(d,{textAlign:"center"},{default:i(()=>[sT]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[rT]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Inverted",description:"Card's colors can be inverted",code:e.invertedCode},{default:i(()=>[t(z,{inverted:""},{default:i(()=>[t(b,{inverted:""},{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:HB}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Matt Giampietro")]),_:1}),t(g,null,{default:i(()=>[uT]),_:1}),t(d,null,{default:i(()=>[n(" Matthew is an interior designer living in New York. ")]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[cT,dT]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:NB}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Molly")]),_:1}),t(g,null,{default:i(()=>[mT]),_:1}),t(d,null,{default:i(()=>[n(" Molly is a personal assistant living in Paris. ")]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[pT,fT]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:eo}),t(h,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Elyse")]),_:1}),t(g,null,{default:i(()=>[gT]),_:1}),t(d,null,{default:i(()=>[n(" Elyse is a copywriter working in New York. ")]),_:1})]),_:1}),t(h,{extra:""},{default:i(()=>[hT,_T]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Colored",description:"A card can specify a color",code:e.coloredCode},{default:i(()=>[t(b,{itemsPerRow:4},{default:i(()=>[t(_,{color:"primary",href:"#"},{default:i(()=>[t(s,{src:xl})]),_:1}),t(_,{color:"secondary",href:"#"},{default:i(()=>[t(s,{src:xl})]),_:1}),t(_,{color:"red",href:"#"},{default:i(()=>[t(s,{src:xl})]),_:1}),t(_,{color:"orange",href:"#"},{default:i(()=>[t(s,{src:xl})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Column Count",description:"A group of cards can set how many cards should exist in a row",code:e.columnCountCode},{default:i(()=>[t(b,{itemsPerRow:4},{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:ue})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:ue})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:ue})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:ue})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Stackable",description:"A group of cards can automatically stack rows to a single columns on mobile devices",code:e.stackableCode},{default:i(()=>[t(b,{itemsPerRow:3,stackable:""},{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:Zn})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:Qn})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:kc})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:xc})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:Go})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:$c})]),_:1})]),_:1})]),_:1},8,["code"]),t(C,{title:"Doubling",description:"A group of cards can double its column width for mobile",code:e.doublingCode},{default:i(()=>[t(b,{itemsPerRow:6,doubling:""},{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:Zn})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:Qn})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:kc})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:xc})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:Go})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:$c})]),_:1})]),_:1})]),_:1},8,["code"])]),_:1})])}const vT=ke(OB,[["render",bT]]),yT=R({name:"CommentDoc",components:{DocPageHeader:Ze,DocExample:Ge},setup(){return{commentsCode:`<sui-comment-group>
  ...
  </sui-segment>`}}}),ST=S("span",null,"Today at 5:42PM",-1),wT=S("a",null,"Reply",-1),CT=S("span",null,"Yesterday at 12:30AM",-1),AT=S("a",null,"Reply",-1),kT={class:"comments"},xT=S("span",null,"Just now",-1),$T=S("a",null,"Reply",-1),BT=S("span",null,"5 days ago",-1),TT=S("a",null,"Reply",-1),LT=S("div",{class:"date"},"2 days ago",-1),IT=S("div",{class:"rating"},[S("i",{class:"star icon"}),n(" 5 Faves ")],-1),DT=S("a",null,"Reply",-1),ET=S("a",null,"Save",-1),RT=S("a",null,"Hide",-1),zT=S("a",null,[S("i",{class:"expand icon"}),n(" Full-screen ")],-1),PT=S("a",null,"Reply",-1),MT=S("a",null,"Reply",-1),VT=S("a",null,"Replay",-1),FT=S("span",null,"Today at 5:42PM",-1),HT=S("a",{href:"#"},"Replay",-1),NT=S("span",null,"Yesterday at 12:30AM",-1),OT=S("a",{href:"#"},"Replay",-1),jT=S("span",null,"Just now",-1),GT=S("a",{href:"#"},"Replay",-1),qT=S("span",null,"5 days ago",-1),UT=S("a",{href:"#"},"Replay",-1),YT=S("span",null,"Today at 5:42PM",-1),JT=S("a",{href:"#"},"Replay",-1),WT=S("span",null,"Yesterday at 12:30AM",-1),KT=S("a",{href:"#"},"Replay",-1),XT=S("span",null,"Just now",-1),QT=S("a",{href:"#"},"Replay",-1),ZT=S("span",null,"5 days ago",-1),e2=S("a",{href:"#"},"Replay",-1),t2=S("span",null,"Today at 5:42PM",-1),i2=S("a",{href:"#"},"Replay",-1),a2=S("span",null,"Yesterday at 12:30AM",-1),l2=S("a",{href:"#"},"Replay",-1),n2=S("span",null,"Just now",-1),o2=S("a",{href:"#"},"Replay",-1),s2=S("span",null,"5 days ago",-1),r2=S("a",{href:"#"},"Replay",-1),u2=S("span",null,"Today at 5:42PM",-1),c2=S("a",{href:"#"},"Replay",-1),d2=S("span",null,"Yesterday at 12:30AM",-1),m2=S("a",{href:"#"},"Replay",-1),p2=S("span",null,"Just now",-1),f2=S("a",{href:"#"},"Replay",-1),g2=S("span",null,"5 days ago",-1),h2=S("a",{href:"#"},"Replay",-1);function _2(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-comment-avatar"),u=y("sui-comment-author"),g=y("sui-comment-metadata"),d=y("sui-comment-text"),h=y("sui-comment-actions"),v=y("sui-comment-content"),_=y("sui-comment"),C=y("sui-comment-group"),k=y("doc-example"),T=y("sui-form-textarea"),b=y("sui-icon"),w=y("sui-button"),x=y("sui-form"),B=y("sui-segment"),I=y("sui-container");return $(),he("div",null,[t(m,{title:"Comment",sub:"A comment displays user feedback to site content"}),t(I,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(k,{title:"Comments",description:"A basic list of comments",code:e.commentsCode},{default:i(()=>[t(C,null,{default:i(()=>[t(f,{as:"h3",dividing:""},{default:i(()=>[n("Comments")]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/matt.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Matt")]),_:1}),t(g,null,{default:i(()=>[ST]),_:1}),t(d,null,{default:i(()=>[n("How artistic!")]),_:1}),t(h,null,{default:i(()=>[wT]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/elliot.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Elliot Fu")]),_:1}),t(g,null,{default:i(()=>[CT]),_:1}),t(d,null,{default:i(()=>[n("This has been very useful for my research. Thanks as well!")]),_:1}),t(h,null,{default:i(()=>[AT]),_:1})]),_:1}),S("div",kT,[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/jenny.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Jenny Hess")]),_:1}),t(g,null,{default:i(()=>[xT]),_:1}),t(d,null,{default:i(()=>[n("Elliot you are always so right :)")]),_:1}),t(h,null,{default:i(()=>[$T]),_:1})]),_:1})]),_:1})])]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/joe.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Joe Henderson")]),_:1}),t(g,null,{default:i(()=>[BT]),_:1}),t(d,null,{default:i(()=>[n("Dude, this is awesome. Thanks so much")]),_:1}),t(h,null,{default:i(()=>[TT]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Content")]),_:1}),t(k,{title:"avatar",description:"A comment can contain an image or avatar",code:e.avatarCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/elliot.jpg"}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Elliot Fu")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Metadata",description:"A comment can contain metadata about the comment, an arbitrary amount of metadata may be defined",code:e.metadataCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/stevie.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Stevie Feliciano")]),_:1}),t(g,null,{default:i(()=>[LT,IT]),_:1}),t(d,null,{default:i(()=>[n(" Hey guys, I hope this example comment is helping you read this documentation. ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Actions",description:"A comment can contain an list of actions a user may perform related to this comment",code:e.actionsCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/joe.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Tom Lukic")]),_:1}),t(d,null,{default:i(()=>[n(" This will be great for business reports. I will definitely download this. ")]),_:1}),t(h,null,{default:i(()=>[DT,ET,RT,zT]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Reply Form",description:"A comment can contain a form to reply to a comment. This may have arbitrary content",code:e.replyFormCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/steve.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Steve Jobs")]),_:1}),t(g,null,{default:i(()=>[n("2 days ago")]),_:1}),t(d,null,{default:i(()=>[n("Revolutionary!")]),_:1}),t(h,null,{default:i(()=>[PT]),_:1}),t(x,{reply:""},{default:i(()=>[t(T),t(w,{color:"primary",icon:"",labelPosition:"left"},{default:i(()=>[t(b,{name:"edit"}),n(" Add Reply ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("States")]),_:1}),t(k,{title:"Collapsed",description:"Comments can be collapsed, or hidden from view",code:e.collapsedCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/christian.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Christian Rocha")]),_:1}),t(g,null,{default:i(()=>[n("2 days ago")]),_:1}),t(d,null,{default:i(()=>[n(" I'm very interested in this motherboard. Do you know if it'd work in a Intel LGA775 CPU socket? ")]),_:1}),t(h,null,{default:i(()=>[MT]),_:1})]),_:1}),t(C,{collapsed:""},{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/elliot.jpg"}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Elliot Fu")]),_:1}),t(g,null,{default:i(()=>[n("1 days ago")]),_:1}),t(d,null,{default:i(()=>[n("No, it wont")]),_:1}),t(h,null,{default:i(()=>[VT]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(k,{title:"Threaded",description:"A comment list can be threaded to showing the relationship between conversations",code:e.threadedCode},{default:i(()=>[t(C,{threaded:""},{default:i(()=>[t(f,{as:"h3",dividing:""},{default:i(()=>[n("Comments")]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/matt.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Matt")]),_:1}),t(g,null,{default:i(()=>[FT]),_:1}),t(d,null,{default:i(()=>[n(" How artistic! ")]),_:1}),t(h,null,{default:i(()=>[HT]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/elliot.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Elliot Fu")]),_:1}),t(g,null,{default:i(()=>[NT]),_:1}),t(d,null,{default:i(()=>[n(" This has been very useful for my research. Thanks as well! ")]),_:1}),t(h,null,{default:i(()=>[OT]),_:1})]),_:1}),t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/jenny.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Jenny Hess")]),_:1}),t(g,null,{default:i(()=>[jT]),_:1}),t(d,null,{default:i(()=>[n(" Elliot you are always so right :) ")]),_:1}),t(h,null,{default:i(()=>[GT]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/joe.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Joe Henderson")]),_:1}),t(g,null,{default:i(()=>[qT]),_:1}),t(d,null,{default:i(()=>[n(" Dude, this is awesome. Thanks so much ")]),_:1}),t(h,null,{default:i(()=>[UT]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Minimal",description:"Comments can hide extra information unless a user shows intent to interact with a comment",code:e.minimalCode},{default:i(()=>[t(C,{minimal:""},{default:i(()=>[t(f,{as:"h3",dividing:""},{default:i(()=>[n("Comments")]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/matt.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Matt")]),_:1}),t(g,null,{default:i(()=>[YT]),_:1}),t(d,null,{default:i(()=>[n(" How artistic! ")]),_:1}),t(h,null,{default:i(()=>[JT]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/elliot.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Elliot Fu")]),_:1}),t(g,null,{default:i(()=>[WT]),_:1}),t(d,null,{default:i(()=>[n(" This has been very useful for my research. Thanks as well! ")]),_:1}),t(h,null,{default:i(()=>[KT]),_:1})]),_:1}),t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/jenny.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Jenny Hess")]),_:1}),t(g,null,{default:i(()=>[XT]),_:1}),t(d,null,{default:i(()=>[n(" Elliot you are always so right :) ")]),_:1}),t(h,null,{default:i(()=>[QT]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/joe.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Joe Henderson")]),_:1}),t(g,null,{default:i(()=>[ZT]),_:1}),t(d,null,{default:i(()=>[n(" Dude, this is awesome. Thanks so much ")]),_:1}),t(h,null,{default:i(()=>[e2]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Size",description:"Comments can have different sizes",code:e.sizeCode},{default:i(()=>[t(C,{size:"small"},{default:i(()=>[t(f,{as:"h3",dividing:""},{default:i(()=>[n("Comments")]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/matt.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Matt")]),_:1}),t(g,null,{default:i(()=>[t2]),_:1}),t(d,null,{default:i(()=>[n(" How artistic! ")]),_:1}),t(h,null,{default:i(()=>[i2]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/elliot.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Elliot Fu")]),_:1}),t(g,null,{default:i(()=>[a2]),_:1}),t(d,null,{default:i(()=>[n(" This has been very useful for my research. Thanks as well! ")]),_:1}),t(h,null,{default:i(()=>[l2]),_:1})]),_:1}),t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/jenny.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Jenny Hess")]),_:1}),t(g,null,{default:i(()=>[n2]),_:1}),t(d,null,{default:i(()=>[n(" Elliot you are always so right :) ")]),_:1}),t(h,null,{default:i(()=>[o2]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/joe.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Joe Henderson")]),_:1}),t(g,null,{default:i(()=>[s2]),_:1}),t(d,null,{default:i(()=>[n(" Dude, this is awesome. Thanks so much ")]),_:1}),t(h,null,{default:i(()=>[r2]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Inverted",description:"Comments's colors can be inverted",code:e.invertedCode},{default:i(()=>[t(B,{inverted:""},{default:i(()=>[t(C,{inverted:""},{default:i(()=>[t(f,{as:"h3",inverted:"",dividing:""},{default:i(()=>[n("Comments")]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/matt.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Matt")]),_:1}),t(g,null,{default:i(()=>[u2]),_:1}),t(d,null,{default:i(()=>[n(" How artistic! ")]),_:1}),t(h,null,{default:i(()=>[c2]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/elliot.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Elliot Fu")]),_:1}),t(g,null,{default:i(()=>[d2]),_:1}),t(d,null,{default:i(()=>[n(" This has been very useful for my research. Thanks as well! ")]),_:1}),t(h,null,{default:i(()=>[m2]),_:1})]),_:1}),t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/jenny.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Jenny Hess")]),_:1}),t(g,null,{default:i(()=>[p2]),_:1}),t(d,null,{default:i(()=>[n(" Elliot you are always so right :) ")]),_:1}),t(h,null,{default:i(()=>[f2]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,{src:"/images/avatar/small/joe.jpg"}),t(v,null,{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Joe Henderson")]),_:1}),t(g,null,{default:i(()=>[g2]),_:1}),t(d,null,{default:i(()=>[n(" Dude, this is awesome. Thanks so much ")]),_:1}),t(h,null,{default:i(()=>[h2]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"])]),_:1})])}const b2=ke(yT,[["render",_2]]),v2=R({name:"FeedDoc",components:{DocPageHeader:Ze,DocExample:Ge},setup(){return{feedCode:`<sui-feed>
  <sui-feed-event>
    <sui-feed-label>
      <img src="/images/avatar/small/elliot.jpg">
    </sui-feed-label>
...
</sui-feed>`}}}),y2=S("img",{src:ei},null,-1),S2=S("img",{src:ei},null,-1),w2=S("a",null,"Coworkers",-1),C2=S("img",{src:$n},null,-1),A2=S("a",null,"Jenny Hess",-1),k2=S("a",null,"coworker",-1),x2=S("img",{src:Va},null,-1),$2=S("a",null,"Helen Troy",-1),B2=S("a",null,[S("img",{src:ue})],-1),T2=S("a",null,[S("img",{src:ue})],-1),L2=S("a",null,"Elliot Fu",-1),I2=S("a",null,"Jenny Hess",-1),D2=S("a",null,"Stevie Feliciano",-1),E2=S("a",null,"Elliot Fu",-1),R2=S("a",null,"Helen Troy",-1),z2=S("a",null,"Christian Rocha",-1),P2=S("img",{src:ei},null,-1),M2=S("div",{class:"date"},"Just now",-1),V2=S("a",{class:"user"},"Elliot Fu",-1);function F2(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-feed-label"),u=y("sui-feed-user"),g=y("sui-feed-date"),d=y("sui-feed-summary"),h=y("sui-icon"),v=y("sui-feed-like"),_=y("sui-feed-meta"),C=y("sui-feed-content"),k=y("sui-feed-event"),T=y("sui-feed"),b=y("doc-example"),w=y("sui-feed-extra"),x=y("sui-segment"),B=y("sui-container");return $(),he("div",null,[t(m,{title:"Feed",sub:"A feed presents user activity chronologically"}),t(B,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(b,{title:"Feed",description:"A feed",code:e.feedCode},{default:i(()=>[t(T,null,{default:i(()=>[t(k,null,{default:i(()=>[t(s,null,{default:i(()=>[y2]),_:1}),t(C,null,{default:i(()=>[t(d,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Elliot Fu")]),_:1}),n(" added you as a friend "),t(g,null,{default:i(()=>[n("1 Hour Ago")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(v,null,{default:i(()=>[t(h,{name:"like"}),n(" 4 Likes ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Content")]),_:1}),t(b,{title:"Label",description:"An event can contain an image or icon label",code:e.labelCode},{default:i(()=>[t(T,null,{default:i(()=>[t(k,null,{default:i(()=>[t(s,null,{default:i(()=>[S2]),_:1}),t(C,null,{default:i(()=>[n(" You added Elliot Fu to the group "),w2]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(b,{title:"Date",description:"An event or an event summary can contain a date",code:e.dateCode},{default:i(()=>[t(T,null,{default:i(()=>[t(k,null,{default:i(()=>[t(s,null,{default:i(()=>[C2]),_:1}),t(C,null,{default:i(()=>[t(g,null,{default:i(()=>[n(" 3 days ago ")]),_:1}),t(d,null,{default:i(()=>[n(" You added "),A2,n(" to your "),k2,n(" group. ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(b,{title:"Additional information",description:"An event can contain additional information like a set of images or text",code:e.additionalInfoCode},{default:i(()=>[t(T,null,{default:i(()=>[t(k,null,{default:i(()=>[t(s,null,{default:i(()=>[x2]),_:1}),t(C,null,{default:i(()=>[t(g,null,{default:i(()=>[n(" 3 days ago ")]),_:1}),t(d,null,{default:i(()=>[$2,n(" added 2 photos ")]),_:1}),t(w,{images:""},{default:i(()=>[B2,T2]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(b,{title:"Size",description:"A feed can have different sizes",code:e.sizeCode},{default:i(()=>[t(T,{size:"small"},{default:i(()=>[t(f,{as:"h4"},{default:i(()=>[n("Followers Activity")]),_:1}),t(k,null,{default:i(()=>[t(C,null,{default:i(()=>[t(d,null,{default:i(()=>[L2,n(" added "),I2,n(" as a friend ")]),_:1})]),_:1})]),_:1}),t(k,null,{default:i(()=>[t(C,null,{default:i(()=>[t(d,null,{default:i(()=>[D2,n(" added "),E2,n(" as a friend ")]),_:1})]),_:1})]),_:1}),t(k,null,{default:i(()=>[t(C,null,{default:i(()=>[t(d,null,{default:i(()=>[R2,n(" added "),z2,n(" as a friend ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(b,{title:"Inverted",description:"A feed's color can be inverted",code:e.invertedCode},{default:i(()=>[t(x,{inverted:""},{default:i(()=>[t(T,{inverted:""},{default:i(()=>[t(k,null,{default:i(()=>[t(s,null,{default:i(()=>[P2]),_:1}),t(C,null,{default:i(()=>[M2,t(d,null,{default:i(()=>[V2,n(" posted on his page ")]),_:1}),t(w,{text:""},{default:i(()=>[n(" Hey there ! ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"])]),_:1})])}const H2=ke(v2,[["render",F2]]),N2=R({name:"ItemDoc",components:{DocPageHeader:Ze,DocExample:Ge},setup(){return{itemsCode:`<sui-item-group>
  <sui-item>
    <sui-item-image>
      <img src="/images/wireframe/image.png">
    </sui-item-image>
...
</sui-item-group>`}}}),O2=S("img",{src:ue},null,-1),j2=S("span",null,"Description",-1),G2=S("img",{src:at},null,-1),q2=S("img",{src:ue},null,-1),U2=S("span",null,"Description",-1),Y2=S("img",{src:at},null,-1),J2=S("img",{src:ue},null,-1),W2=S("img",{src:ue},null,-1),K2=S("img",{src:ue},null,-1),X2=S("img",{src:ue},null,-1),Q2=S("img",{src:ue},null,-1),Z2=S("img",{src:ue},null,-1),eL=S("img",{src:ue},null,-1),tL=S("span",{class:"price"},"$1200",-1),iL=S("span",{class:"stay"},"1 Month",-1),aL=S("img",{src:at},null,-1),lL=S("span",{class:"price"},"$1000",-1),nL=S("span",{class:"stay"},"2 Weeks",-1),oL=S("img",{src:at},null,-1),sL=S("p",null,"Cute dogs come in a variety of shapes and sizes. Some cute dogs are cute for their adorable faces, others for their tiny stature, and even others for their massive size.",-1),rL=S("p",null,"Many people also have their own barometers for what makes a cute dog.",-1),uL=S("img",{src:at},null,-1),cL=S("img",{src:ue},null,-1),dL=S("span",{class:"cinema"},"Union Square 14",-1),mL=S("img",{src:at},null,-1),pL=S("img",{src:ue},null,-1),fL=S("span",{class:"cinema"},"IFC Cinema",-1),gL=S("img",{src:at},null,-1),hL=S("img",{src:ue},null,-1),_L=S("span",{class:"cinema"},"IFC",-1),bL=S("img",{src:at},null,-1),vL=S("img",{src:at},null,-1),yL=S("img",{src:at},null,-1),SL=S("img",{src:at},null,-1),wL=S("span",{class:"price"},"$1200",-1),CL=S("span",{class:"stay"},"1 Month",-1),AL=S("img",{src:at},null,-1),kL=S("span",{class:"price"},"$1000",-1),xL=S("span",{class:"stay"},"2 Weeks",-1),$L=S("img",{src:at},null,-1);function BL(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-item-image"),u=y("sui-item-header"),g=y("sui-item-meta"),d=y("sui-item-description"),h=y("sui-item-extra"),v=y("sui-item-content"),_=y("sui-item"),C=y("sui-item-group"),k=y("doc-example"),T=y("sui-image"),b=y("sui-icon"),w=y("sui-label"),x=y("sui-button"),B=y("sui-segment"),I=y("sui-container");return $(),he("div",null,[t(m,{title:"Item",sub:"An item view presents large collections of site content for display"}),t(I,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(k,{title:"Items",description:"A group of items",code:e.itemsCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[O2]),_:1}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Header")]),_:1}),t(g,null,{default:i(()=>[j2]),_:1}),t(d,null,{default:i(()=>[G2]),_:1}),t(h,null,{default:i(()=>[n(" Additional Details ")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[q2]),_:1}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Header")]),_:1}),t(g,null,{default:i(()=>[U2]),_:1}),t(d,null,{default:i(()=>[Y2]),_:1}),t(h,null,{default:i(()=>[n(" Additional Details ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Content")]),_:1}),t(k,{title:"Image",description:"An item can contain an image",code:e.imageCode},{default:i(()=>[t(C,{divided:""},{default:i(()=>[t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[J2]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[W2]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[K2]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Content",description:"An item can contain content",code:e.contentCode},{default:i(()=>[t(C,{divided:""},{default:i(()=>[t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[X2]),_:1}),t(v,{verticalAlign:"middle"},{default:i(()=>[n(" Content A ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[Q2]),_:1}),t(v,{verticalAlign:"middle"},{default:i(()=>[n(" Content B ")]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[Z2]),_:1}),t(v,{verticalAlign:"middle"},{default:i(()=>[n(" Content C ")]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Header",description:"An item can contain a header",code:e.headerCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[eL]),_:1}),t(v,{verticalAlign:"middle"},{default:i(()=>[t(u,null,{default:i(()=>[n("12 Years a Slave")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Metadata",description:"An item can contain content metadata",code:e.metadataCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Arrowhead Valley Camp")]),_:1}),t(g,null,{default:i(()=>[tL,iL]),_:1}),t(d,null,{default:i(()=>[aL]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Buck's Homebrew Stayaway")]),_:1}),t(g,null,{default:i(()=>[lL,nL]),_:1}),t(d,null,{default:i(()=>[oL]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Description",description:"An item can contain a description with a single or multiple paragraphs",code:e.descriptionCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Cute Dog")]),_:1}),t(d,null,{default:i(()=>[sL,rL]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Extra Content",description:"An item can contain extra content meant to be formatted separately from the main content",code:e.extraContentCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Cute Dog")]),_:1}),t(d,null,{default:i(()=>[uL]),_:1}),t(h,null,{default:i(()=>[t(b,{name:"check",color:"green"}),n(" 121 Votes ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(k,{title:"Divided",description:"Items can be divided to better distinguish between grouped content",code:e.dividedCode},{default:i(()=>[t(C,{divided:""},{default:i(()=>[t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[cL]),_:1}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("12 Years a Slave")]),_:1}),t(g,null,{default:i(()=>[dL]),_:1}),t(d,null,{default:i(()=>[mL]),_:1}),t(h,null,{default:i(()=>[t(w,null,{default:i(()=>[n("IMAX")]),_:1}),t(w,null,{default:i(()=>[t(b,{name:"globe"}),n(" Additional Languages ")]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[pL]),_:1}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("My Neighbor Totoro")]),_:1}),t(g,null,{default:i(()=>[fL]),_:1}),t(d,null,{default:i(()=>[gL]),_:1}),t(h,null,{default:i(()=>[t(x,{floated:"right",color:"primary"},{default:i(()=>[n(" Buy tickets "),t(b,{name:"right chevron"})]),_:1}),t(w,null,{default:i(()=>[n("Limited")]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(s,null,{default:i(()=>[hL]),_:1}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Watchmen")]),_:1}),t(g,null,{default:i(()=>[_L]),_:1}),t(d,null,{default:i(()=>[bL]),_:1}),t(h,null,{default:i(()=>[t(x,{floated:"right",color:"primary"},{default:i(()=>[n(" Buy tickets "),t(b,{name:"right chevron"})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Relaxed",description:"A group of items can relax its padding to provide more negative space",code:e.relaxedCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(T,{size:"tiny",src:ue}),t(v,{verticalAlign:"middle"},{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("12 Years a Slave")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(T,{size:"tiny",src:ue}),t(v,{verticalAlign:"middle"},{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("My Neighbor Totoro")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(T,{size:"tiny",src:ue}),t(v,{verticalAlign:"middle"},{default:i(()=>[t(u,{as:"a"},{default:i(()=>[n("Watchmen")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Vertical Alignment",description:"Content can specify its vertical alignment",code:e.verticalAlignCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Top Aligned")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,{verticalAlign:"middle"},{default:i(()=>[t(u,null,{default:i(()=>[n("Middle Aligned")]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,{verticalAlign:"bottom"},{default:i(()=>[t(u,null,{default:i(()=>[n("Bottom Aligned")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Floated Content",description:"Any content element can be floated left or right",code:e.floatedContentCode},{default:i(()=>[t(C,null,{default:i(()=>[t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,{verticalAlign:"middle"},{default:i(()=>[t(u,null,{default:i(()=>[n("Content A")]),_:1}),t(d,null,{default:i(()=>[vL]),_:1}),t(h,null,{default:i(()=>[t(x,{floated:"right"},{default:i(()=>[n("Action")]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,{verticalAlign:"middle"},{default:i(()=>[t(u,null,{default:i(()=>[n("Content B")]),_:1}),t(d,null,{default:i(()=>[yL]),_:1}),t(h,null,{default:i(()=>[t(x,{floated:"right"},{default:i(()=>[n("Action")]),_:1})]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,{verticalAlign:"middle"},{default:i(()=>[t(u,null,{default:i(()=>[n("Content C")]),_:1}),t(d,null,{default:i(()=>[SL]),_:1}),t(h,null,{default:i(()=>[t(x,{floated:"right"},{default:i(()=>[n("Action")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(k,{title:"Inverted",description:"An item can be inverted to appear on a dark background",code:e.invertedCode},{default:i(()=>[t(B,{inverted:""},{default:i(()=>[t(C,{inverted:""},{default:i(()=>[t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Arrowhead Valley Camp")]),_:1}),t(g,null,{default:i(()=>[wL,CL]),_:1}),t(d,null,{default:i(()=>[AL]),_:1})]),_:1})]),_:1}),t(_,null,{default:i(()=>[t(T,{size:"small",src:ue}),t(v,null,{default:i(()=>[t(u,null,{default:i(()=>[n("Buck's Homebrew Stayaway")]),_:1}),t(g,null,{default:i(()=>[kL,xL]),_:1}),t(d,null,{default:i(()=>[$L]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["code"])]),_:1})])}const TL=ke(N2,[["render",BL]]),LL=R({name:"StatisticDoc",components:{DocPageHeader:Ze,DocExample:Ge},setup(){return{statisticCode:'<sui-statistic value="5,550" label="Downloads" />',groupCode:`<sui-statistic-group>
...
</sui-segment>`}}}),HL=S("p",null," A dog is a type of domesticated animal. Known for its loyalty and faithfulness, it can be found as a welcome guest in many households across the world. ",-1),NL=S("p",null," There are many breeds of dogs. Each breed varies in size and temperament. Owners often select a breed of dog that they find to be compatible with their own lifestyle and desires from a companion. ",-1),OL=S("p",null," Three common ways for a prospective owner to acquire a dog is from pet shops, private owners, or shelters. ",-1),jL=S("p",null," A pet shop may be the most convenient way to buy a dog. Buying a dog from a private owner allows you to assess the pedigree and upbringing of your dog before choosing to take it home. Lastly, finding your dog from a shelter, helps give a good home to a dog who may not find one so readily. ",-1),GL=S("p",null," A dog is a type of domesticated animal. Known for its loyalty and faithfulness, it can be found as a welcome guest in many households across the world. ",-1),qL=S("p",null," There are many breeds of dogs. Each breed varies in size and temperament. Owners often select a breed of dog that they find to be compatible with their own lifestyle and desires from a companion. ",-1),UL=S("p",null," Three common ways for a prospective owner to acquire a dog is from pet shops, private owners, or shelters. ",-1),YL=S("p",null," A pet shop may be the most convenient way to buy a dog. Buying a dog from a private owner allows you to assess the pedigree and upbringing of your dog before choosing to take it home. Lastly, finding your dog from a shelter, helps give a good home to a dog who may not find one so readily. ",-1),JL=S("p",null," A dog is a type of domesticated animal. Known for its loyalty and faithfulness, it can be found as a welcome guest in many households across the world. ",-1),WL=S("p",null," There are many breeds of dogs. Each breed varies in size and temperament. Owners often select a breed of dog that they find to be compatible with their own lifestyle and desires from a companion. ",-1),KL=S("p",null," Three common ways for a prospective owner to acquire a dog is from pet shops, private owners, or shelters. ",-1),XL=S("p",null," A pet shop may be the most convenient way to buy a dog. Buying a dog from a private owner allows you to assess the pedigree and upbringing of your dog before choosing to take it home. Lastly, finding your dog from a shelter, helps give a good home to a dog who may not find one so readily. ",-1),QL=S("p",null," A dog is a type of domesticated animal. Known for its loyalty and faithfulness, it can be found as a welcome guest in many households across the world. ",-1),ZL=S("p",null," There are many breeds of dogs. Each breed varies in size and temperament. Owners often select a breed of dog that they find to be compatible with their own lifestyle and desires from a companion. ",-1),eI=S("p",null," Three common ways for a prospective owner to acquire a dog is from pet shops, private owners, or shelters. ",-1),tI=S("p",null," A pet shop may be the most convenient way to buy a dog. Buying a dog from a private owner allows you to assess the pedigree and upbringing of your dog before choosing to take it home. Lastly, finding your dog from a shelter, helps give a good home to a dog who may not find one so readily. ",-1),iI=S("p",null," A dog is a type of domesticated animal. Known for its loyalty and faithfulness, it can be found as a welcome guest in many households across the world. ",-1),aI=S("p",null," There are many breeds of dogs. Each breed varies in size and temperament. Owners often select a breed of dog that they find to be compatible with their own lifestyle and desires from a companion. ",-1),lI=S("p",null," Three common ways for a prospective owner to acquire a dog is from pet shops, private owners, or shelters. ",-1),nI=S("p",null," A pet shop may be the most convenient way to buy a dog. Buying a dog from a private owner allows you to assess the pedigree and upbringing of your dog before choosing to take it home. Lastly, finding your dog from a shelter, helps give a good home to a dog who may not find one so readily. ",-1);function oI(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-accordion-tab"),u=y("sui-accordion"),g=y("doc-example"),d=y("sui-segment"),h=y("sui-container");return $(),he("div",null,[t(m,{title:"Accordion",sub:"An accordion allows users to toggle the display of sections of content"}),t(h,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(g,{title:"Accordion",description:"A standard accordion",code:e.accordionCode},{default:i(()=>[t(u,null,{default:i(()=>[t(s,{title:"What is a dog?"},{default:i(()=>[HL]),_:1}),t(s,{title:"What kinds of dogs are there?"},{default:i(()=>[NL]),_:1}),t(s,{title:"How do you acquire a dog?"},{default:i(()=>[OL,jL]),_:1})]),_:1})]),_:1},8,["code"]),t(g,{title:"Styled",description:"A styled accordion adds basic formatting",code:e.styledCode},{default:i(()=>[t(u,{styled:""},{default:i(()=>[t(s,{title:"What is a dog?"},{default:i(()=>[GL]),_:1}),t(s,{title:"What kinds of dogs are there?"},{default:i(()=>[qL]),_:1}),t(s,{title:"How do you acquire a dog?"},{default:i(()=>[UL,YL]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(g,{title:"Fluid",description:"An accordion can take up the width of its container",code:e.fluidCode},{default:i(()=>[t(u,{fluid:"",styled:""},{default:i(()=>[t(s,{title:"What is a dog?"},{default:i(()=>[JL]),_:1}),t(s,{title:"What kinds of dogs are there?"},{default:i(()=>[WL]),_:1}),t(s,{title:"How do you acquire a dog?"},{default:i(()=>[KL,XL]),_:1})]),_:1})]),_:1},8,["code"]),t(g,{title:"Inverted",description:"An accordion can be formatted to appear on dark backgrounds",code:e.invertedCode},{default:i(()=>[t(d,{inverted:""},{default:i(()=>[t(u,{inverted:""},{default:i(()=>[t(s,{title:"What is a dog?"},{default:i(()=>[QL]),_:1}),t(s,{title:"What kinds of dogs are there?"},{default:i(()=>[ZL]),_:1}),t(s,{title:"How do you acquire a dog?"},{default:i(()=>[eI,tI]),_:1})]),_:1})]),_:1})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Usage")]),_:1}),t(g,{title:"Multiple",description:"An accordion can have multiple panels open at the same time",code:e.multipleCode},{default:i(()=>[t(u,{multiple:""},{default:i(()=>[t(s,{title:"What is a dog?"},{default:i(()=>[iI]),_:1}),t(s,{title:"What kinds of dogs are there?"},{default:i(()=>[aI]),_:1}),t(s,{title:"How do you acquire a dog?"},{default:i(()=>[lI,nI]),_:1})]),_:1})]),_:1},8,["code"])]),_:1})])}const sI=ke(FL,[["render",oI]]),rI=R({name:"CalendarDoc",components:{DocPageHeader:Ze,DocExample:Ge},setup(){return{calendar1:G(null),calendarCode:'<sui-calendar v-model="calendar1" placeholder="Date/Time" />'}}});function uI(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-calendar"),u=y("doc-example"),g=y("sui-container");return $(),he("div",null,[t(m,{title:"Calendar",sub:"A calendar allows users to select any date or time"}),t(g,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(u,{title:"Calendar",description:"A standard calendar",code:e.calendarCode},{default:i(()=>[t(s,{modelValue:e.calendar1,"onUpdate:modelValue":a[0]||(a[0]=d=>e.calendar1=d),placeholder:"Date/Time"},null,8,["modelValue"])]),_:1},8,["code"])]),_:1})])}const cI=ke(rI,[["render",uI]]),dI=R({name:"PropertyListTable",props:{properties:Array}});function mI(e,a,l,o,r,c){const m=y("sui-table-header-cell"),f=y("sui-table-row"),s=y("sui-table-header"),u=y("sui-table-cell"),g=y("sui-table-body"),d=y("sui-table");return $(),D(d,{celled:""},{default:i(()=>[t(s,null,{default:i(()=>[t(f,null,{default:i(()=>[t(m,null,{default:i(()=>[n("Name")]),_:1}),t(m,null,{default:i(()=>[n("Type")]),_:1}),t(m,null,{default:i(()=>[n("Default")]),_:1}),t(m,null,{default:i(()=>[n("Description")]),_:1})]),_:1})]),_:1}),t(g,null,{default:i(()=>[($(!0),he(Ce,null,tt(e.properties,h=>($(),D(f,{key:h.name},{default:i(()=>[t(u,null,{default:i(()=>[n(Te(h.name),1)]),_:2},1024),t(u,null,{default:i(()=>[n(Te(h.type),1)]),_:2},1024),t(u,null,{default:i(()=>[n(Te(h.default),1)]),_:2},1024),t(u,null,{default:i(()=>[n(Te(h.description),1)]),_:2},1024)]),_:2},1024))),128))]),_:1})]),_:1})}const Tn=ke(dI,[["render",mI]]),pI=R({name:"CheckboxDoc",components:{DocPageHeader:Ze,DocExample:Ge,PropertyListTable:Tn},setup(){const e=G(!1),a='<sui-checkbox label="Make my profile visible" v-model="checked" />',l=G([]),o=`<sui-checkbox label="Apple" value="Apple" v-model="selected"  />
<sui-checkbox label="Banana" value="Banana" v-model="selected"  />
<sui-checkbox label="Chocolate" value="Chocolate" v-model="selected"  />`,r=G(!1),c='<sui-checkbox toggle v-model="toggle" />',m=G(!1);return{checked:e,checkboxCode:a,selected:l,multipleCode:o,toggle:r,toggleCode:c,slider:m,sliderCode:'<sui-checkbox slider v-model="slider" />',properties:[{name:"label",type:"string",default:"null",description:"Label of the checkbox."},{name:"modelValue",type:"any",default:"null",description:"Value binding of the checkbox."},{name:"value",type:"any",default:"null",description:"Value of the checkbox."}],events:[{name:"change",description:"Callback to invoke when checkbox value is changed."},{name:"click",description:"Callback to invoke when checkbox is clicked."}]}}}),fI={class:"ui form"},gI={class:"grouped fields"},hI={class:"field"},_I={class:"field"},bI={class:"field"};function vI(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-checkbox"),u=y("doc-example"),g=y("property-list-table"),d=y("sui-table-header-cell"),h=y("sui-table-row"),v=y("sui-table-header"),_=y("sui-table-cell"),C=y("sui-table-body"),k=y("sui-table"),T=y("sui-container");return $(),he("div",null,[t(m,{title:"Checkbox",sub:"A checkbox allows a user to select a value from a small set of options, often binary"}),t(T,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(u,{title:"Checkbox",description:"A standard checkbox",code:e.checkboxCode},{default:i(()=>[t(s,{label:"Make my profile visible",modelValue:e.checked,"onUpdate:modelValue":a[0]||(a[0]=b=>e.checked=b)},null,8,["modelValue"])]),_:1},8,["code"]),t(u,{title:"Multiple",description:"Multiple mode is enabled by default, v-model property refers to an array to bind the selected values",code:e.multipleCode},{default:i(()=>[S("div",fI,[S("div",gI,[S("div",hI,[t(s,{label:"Apple",value:"Apple",modelValue:e.selected,"onUpdate:modelValue":a[1]||(a[1]=b=>e.selected=b)},null,8,["modelValue"])]),S("div",_I,[t(s,{label:"Banana",value:"Banana",modelValue:e.selected,"onUpdate:modelValue":a[2]||(a[2]=b=>e.selected=b)},null,8,["modelValue"])]),S("div",bI,[t(s,{label:"Chocolate",value:"Chocolate",modelValue:e.selected,"onUpdate:modelValue":a[3]||(a[3]=b=>e.selected=b)},null,8,["modelValue"])])])]),n(" selected : "+Te(e.selected),1)]),_:1},8,["code"]),t(u,{title:"Toggle",description:"A checkbox can toggle",code:e.toggleCode},{default:i(()=>[t(s,{toggle:"",modelValue:e.toggle,"onUpdate:modelValue":a[4]||(a[4]=b=>e.toggle=b)},null,8,["modelValue"])]),_:1},8,["code"]),t(u,{title:"Slider",description:"A checkbox can look like a slider",code:e.sliderCode},{default:i(()=>[t(s,{slider:"",modelValue:e.slider,"onUpdate:modelValue":a[5]||(a[5]=b=>e.slider=b)},null,8,["modelValue"])]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Properties")]),_:1}),t(g,{properties:e.properties},null,8,["properties"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Events")]),_:1}),t(k,{celled:""},{default:i(()=>[t(v,null,{default:i(()=>[t(h,null,{default:i(()=>[t(d,null,{default:i(()=>[n("Name")]),_:1}),t(d,null,{default:i(()=>[n("Description")]),_:1})]),_:1})]),_:1}),t(C,null,{default:i(()=>[($(!0),he(Ce,null,tt(e.events,b=>($(),D(h,{key:b.name},{default:i(()=>[t(_,null,{default:i(()=>[n(Te(b.name),1)]),_:2},1024),t(_,null,{default:i(()=>[n(Te(b.description),1)]),_:2},1024)]),_:2},1024))),128))]),_:1})]),_:1})]),_:1})])}const yI=ke(pI,[["render",vI]]),SI=R({name:"DimmerDoc",components:{DocPageHeader:Ze,DocExample:Ge},setup(){const e=`<sui-dimmer-dimmable>
...
<\/script>`,EI={__name:"ModalDoc",setup(e){const a=G(!1);return(l,o)=>($(),D(M,{label:"Modal",code:DI},{description:i(()=>[n(" A standard modal ")]),example:i(()=>[t(p(P),{onClick:o[0]||(o[0]=r=>a.value=!0)},{default:i(()=>[n("Show Modal")]),_:1}),t(p(Xl),{modelValue:a.value,"onUpdate:modelValue":o[2]||(o[2]=r=>a.value=r)},{default:i(()=>[t(p(en),null,{default:i(()=>[n("Select a Photo")]),_:1}),t(p(Zl),{image:""},{default:i(()=>[t(p(ce),{wrapped:"",size:"medium",src:"/vue-fomantic-ui/images/avatar/large/rachel.png"}),t(p(Po),null,{default:i(()=>[t(p(fe),null,{default:i(()=>[n("Default Profile Image")]),_:1}),LI,II]),_:1})]),_:1}),t(p(Ql),null,{default:i(()=>[t(p(P),{positive:"",onClick:o[1]||(o[1]=r=>a.value=!1)},{default:i(()=>[n("OK")]),_:1})]),_:1})]),_:1},8,["modelValue"])]),_:1}))}},RI=S("p",null," Your inbox is getting full, would you like us to enable automatic archiving of old messages? ",-1),zI=`<template>
...
const show = ref(false)
<\/script>`,PI={__name:"BasicDoc",setup(e){const a=G(!1);return(l,o)=>($(),D(M,{label:"Basic",code:zI},{description:i(()=>[n(" A modal can reduce its complexity ")]),example:i(()=>[t(p(P),{onClick:o[0]||(o[0]=r=>a.value=!0)},{default:i(()=>[n("Basic Modal")]),_:1}),t(p(Xl),{basic:"",modelValue:a.value,"onUpdate:modelValue":o[2]||(o[2]=r=>a.value=r)},{default:i(()=>[t(p(en),{icon:""},{default:i(()=>[t(p(K),{name:"archive"}),n(" Archive Old Messages")]),_:1}),t(p(Zl),null,{default:i(()=>[RI]),_:1}),t(p(Ql),null,{default:i(()=>[t(p(P),{basic:"",color:"red",inverted:"",icon:"remove",content:"No",onClick:o[1]||(o[1]=r=>a.value=!1)}),t(p(P),{basic:"",color:"green",icon:"checkmark",content:"Yes"})]),_:1})]),_:1},8,["modelValue"])]),_:1}))}},MI={__name:"Modal",setup(e){const a=[{id:"modal",label:"Modal",category:"Types",component:EI},{id:"basic",label:"Basic",category:"Types",component:PI}];return(l,o)=>($(),D(Ct,{title:"Modal",description:"A modal displays content that temporarily blocks interactions with the main view of a site","component-docs":a}))}},VI="/vue-fomantic-ui/images/movies/totoro-horizontal.jpg",FI=R({name:"PopupDoc",components:{DocPageHeader:Ze,DocExample:Ge},setup(){const e=G(null),a=`<sui-button icon ref="trigger">
  <sui-icon name="add" />
</sui-button>
...
<sui-popup size="huge" content="Hello. This is a huge popup" :trigger="sizeTrigger5" />`,q=G(null),W=G(null);return{popupTrigger:e,popupCode:a,titledTrigger1:l,titledTrigger2:o,titledTrigger3:r,titledCode:c,triggerTriger:m,triggerCode:f,basicTrigger:s,basicCode:u,wideTrigger1:g,wideTrigger2:d,wideTrigger3:h,wideCode:v,positionTrigger1:_,positionTrigger2:C,positionTrigger3:k,positionTrigger4:T,positionTrigger5:b,positionTrigger6:w,positionTrigger7:x,positionTrigger8:B,positionCode:I,flowingTrigger:V,flowingCode:F,sizeTrigger1:z,sizeTrigger2:j,sizeTrigger3:X,sizeTrigger4:U,sizeTrigger5:pe,sizeCode:Be,invertedTrigger1:q,invertedTrigger2:W,invertedCode:`<sui-icon name="heart" circular ref="invertedTrigger1" />
...
<sui-rating size="massive" :defaultRating="3" :maxRating="4" color="yellow" />`,properties:[{name:"color",type:"string",default:"",description:"A rating can have different colors"},{name:"defaultRating",type:"number",default:0,description:"The initial value of rating."},{name:"disabled",type:"boolean",default:!1,description:"When present, it specifies that the component should be disabled."},{name:"icon",type:"string",default:"star",description:"A rating can use a set of specified icons."},{name:"maxRating",type:"number",default:1,description:"The total number of icons."},{name:"modelValue",type:"number",default:"null",description:"A value of rating."},{name:"size",type:"string",default:"",description:"A rating can have different sizes."}],events:[{name:"change",description:"Callback to invoke on value change."}]}}}),WI=S("br",null,null,-1),KI=S("br",null,null,-1),XI=S("br",null,null,-1),QI=S("br",null,null,-1),ZI=S("br",null,null,-1),eD=S("br",null,null,-1),tD=S("br",null,null,-1),iD=S("br",null,null,-1),aD=S("br",null,null,-1),lD=S("br",null,null,-1),nD=S("br",null,null,-1),oD=S("br",null,null,-1),sD=S("br",null,null,-1),rD=S("br",null,null,-1),uD=S("br",null,null,-1),cD=S("br",null,null,-1),dD=S("br",null,null,-1),mD=S("br",null,null,-1),pD=S("br",null,null,-1),fD=S("br",null,null,-1),gD=S("br",null,null,-1),hD=S("br",null,null,-1),_D=S("br",null,null,-1),bD=S("br",null,null,-1),vD=S("br",null,null,-1),yD=S("br",null,null,-1),SD=S("br",null,null,-1),wD=S("br",null,null,-1),CD=S("br",null,null,-1),AD=S("br",null,null,-1),kD=S("br",null,null,-1),xD=S("br",null,null,-1),$D=S("br",null,null,-1),BD=S("br",null,null,-1),TD=S("br",null,null,-1),LD=S("br",null,null,-1),ID=S("br",null,null,-1),DD=S("br",null,null,-1),ED=S("br",null,null,-1),RD=S("br",null,null,-1),zD=S("br",null,null,-1),PD=S("br",null,null,-1),MD=S("br",null,null,-1),VD=S("br",null,null,-1),FD=S("br",null,null,-1),HD=S("br",null,null,-1),ND=S("br",null,null,-1),OD=S("br",null,null,-1);function jD(e,a,l,o,r,c){const m=y("doc-page-header"),f=y("sui-header"),s=y("sui-rating"),u=y("doc-example"),g=y("property-list-table"),d=y("sui-table-header-cell"),h=y("sui-table-row"),v=y("sui-table-header"),_=y("sui-table-cell"),C=y("sui-table-body"),k=y("sui-table"),T=y("sui-container");return $(),he("div",null,[t(m,{title:"Rating",sub:"A rating indicates user interest in content"}),t(T,{class:"main"},{default:i(()=>[t(f,{as:"h2",dividing:""},{default:i(()=>[n("Types")]),_:1}),t(u,{title:"Rating",description:"A Basic rating",code:e.ratingCode},{default:i(()=>[t(s)]),_:1},8,["code"]),t(u,{title:"Icon",description:"You can use any available icon as rating indicator",code:e.iconCode},{default:i(()=>[t(s,{defaultRating:2,maxRating:4,color:"yellow"}),WI,KI,t(s,{defaultRating:2,maxRating:4,icon:"heart",color:"red"}),XI,QI,t(s,{defaultRating:2,maxRating:4,icon:"female",color:"purple"}),ZI,eD,t(s,{defaultRating:2,maxRating:4,icon:"male",color:"blue"}),tD,iD,t(s,{defaultRating:2,maxRating:4,icon:"cloud",color:"grey"}),aD,lD,t(s,{defaultRating:2,maxRating:4,icon:"cat",color:"pink"}),nD,oD,t(s,{defaultRating:2,maxRating:4,icon:"circle",color:"orange"})]),_:1},8,["code"]),t(u,{title:"Color",description:"You can specify any color of the FUI color palette",code:e.colorCode},{default:i(()=>[t(s,{defaultRating:1,maxRating:7,color:"red"}),sD,rD,t(s,{defaultRating:2,maxRating:7,color:"orange"}),uD,cD,t(s,{defaultRating:3,maxRating:7,color:"yellow"}),dD,mD,t(s,{defaultRating:4,maxRating:7,color:"olive"}),pD,fD,t(s,{defaultRating:5,maxRating:7,color:"green"}),gD,hD,t(s,{defaultRating:6,maxRating:7,color:"teal"}),_D,bD,t(s,{defaultRating:6,maxRating:7,color:"blue"}),vD,yD,t(s,{defaultRating:5,maxRating:7,color:"violet"}),SD,wD,t(s,{defaultRating:4,maxRating:7,color:"purple"}),CD,AD,t(s,{defaultRating:3,maxRating:7,color:"pink"}),kD,xD,t(s,{defaultRating:2,maxRating:7,color:"brown"}),$D,BD,t(s,{defaultRating:1,maxRating:7,color:"grey"}),TD,LD,t(s,{defaultRating:1,maxRating:7,color:"black"})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("States")]),_:1}),t(u,{title:"Disabled",description:"A rating can be started in non-interactive mode by adding a disabled class",code:e.disabledCode},{default:i(()=>[t(s,{disabled:"",defaultRating:3,maxRating:5,color:"yellow"})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Variations")]),_:1}),t(u,{title:"Size",description:"A rating can vary in size",code:e.sizeCode},{default:i(()=>[t(s,{size:"mini",defaultRating:3,maxRating:4,color:"yellow"}),ID,DD,t(s,{size:"tiny",defaultRating:3,maxRating:4,color:"yellow"}),ED,RD,t(s,{size:"small",defaultRating:3,maxRating:4,color:"yellow"}),zD,PD,t(s,{defaultRating:3,maxRating:4,color:"yellow"}),MD,VD,t(s,{size:"large",defaultRating:3,maxRating:4,color:"yellow"}),FD,HD,t(s,{size:"huge",defaultRating:3,maxRating:4,color:"yellow"}),ND,OD,t(s,{size:"massive",defaultRating:3,maxRating:4,color:"yellow"})]),_:1},8,["code"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Properties")]),_:1}),t(g,{properties:e.properties},null,8,["properties"]),t(f,{as:"h2",dividing:""},{default:i(()=>[n("Events")]),_:1}),t(k,{celled:""},{default:i(()=>[t(v,null,{default:i(()=>[t(h,null,{default:i(()=>[t(d,null,{default:i(()=>[n("Name")]),_:1}),t(d,null,{default:i(()=>[n("Description")]),_:1})]),_:1})]),_:1}),t(C,null,{default:i(()=>[($(!0),he(Ce,null,tt(e.events,b=>($(),D(h,{key:b.name},{default:i(()=>[t(_,null,{default:i(()=>[n(Te(b.name),1)]),_:2},1024),t(_,null,{default:i(()=>[n(Te(b.description),1)]),_:2},1024)]),_:2},1024))),128))]),_:1})]),_:1})]),_:1})])}const GD=ke(JI,[["render",jD]]),qD=R({name:"SidebarDoc",components:{DocPageHeader:Ze,DocExample:Ge,PropertyListTable:Tn},setup(){return{visible1:G(!1),sidebarCode:`<sui-grid :columns="1">
  <sui-grid-column>
...
</sui-segment>`,k=G(3),T='<sui-slider reversed v-model="slider9" />',b=G(18),w='<sui-slider vertical v-model="slider10" :max="20" />',x=G(5),B=G(5),I=G(5),V=G(5),F=G(5),z=G(5),j=G(5),X=G(5),U=G(5),pe=G(5),Be=G(5),q=G(5),W=G(5),de=`<sui-slider color="red" v-model="redSlider" />
...
<\/script>`,iE={__name:"MinimalDoc",setup(e){const{toast:a}=st(),l=()=>{a({message:"I am a toast, nice to meet you !"})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Minimal",code:tE},{description:i(()=>[n(" A minimal toast will just display a message. ")]),example:i(()=>[t(c,{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1})}}},aE=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,lE={__name:"TitledDoc",setup(e){const{toast:a}=st(),l=()=>{a({title:"Better ?",message:"Hey look, I have a title !"})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Titled",code:aE},{description:i(()=>[n(" You can add a title to your toast. ")]),example:i(()=>[t(c,{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1})}}},nE=`<template>
  <SuiButton @click="show">Show</SuiButton>
...
<\/script>`,oE={__name:"ProgressBarDoc",setup(e){const{toast:a}=st(),l=o=>{a({title:"LOOK",message:"See, how long i will last",showProgress:"bottom",showProgressColor:o})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Progress Bar",code:nE},{description:i(()=>[n(" You can attach a progress bar to your toast. ")]),example:i(()=>[t(c,{onClick:l},{default:i(()=>[n("Show")]),_:1}),t(c,{color:"red",onClick:r[0]||(r[0]=m=>l("red"))},{default:i(()=>[n("Show")]),_:1})]),_:1})}}},sE=`<template>
...
<\/script>`,rE={__name:"ToastTypeDoc",setup(e){const{toast:a}=st(),l=o=>{a({message:"You're using the good framework !",type:o})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Toast Type",code:sE},{description:i(()=>[n(" A toast can be used to display different types of informations. ")]),example:i(()=>[t(c,{onClick:r[0]||(r[0]=m=>l("success")),positive:""},{default:i(()=>[n("Success")]),_:1}),t(c,{onClick:r[1]||(r[1]=m=>l("error")),negative:""},{default:i(()=>[n("Error")]),_:1}),t(c,{onClick:r[2]||(r[2]=m=>l("warning")),color:"yellow"},{default:i(()=>[n("Warning")]),_:1})]),_:1})}}},uE=`<template>
...
<\/script>`,cE={__name:"PositionDoc",setup(e){const{toast:a}=st(),l=o=>{a({position:o,message:"Look, I'm here !"})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Position",code:uE},{description:i(()=>[n(" A toast can appear at different positions on the screen. ")]),example:i(()=>[t(c,{onClick:r[0]||(r[0]=m=>l("top left"))},{default:i(()=>[n("Top Left")]),_:1}),t(c,{onClick:r[1]||(r[1]=m=>l("bottom right"))},{default:i(()=>[n("Bottom Right")]),_:1})]),_:1})}}},dE=S("br",null,null,-1),mE=`<template>
...
<\/script>`,pE={__name:"AttachedPosition",setup(e){const{toast:a}=st(),l=o=>{a({attached:o,title:"Watch out!",message:`I am a ${o} attached toast`})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Attached Position",code:mE},{description:i(()=>[n(" A toast can have an attached position which will show the toast over the whole width of the screen."),dE,n(" Just like notifications on mobile devices. ")]),example:i(()=>[t(c,{onClick:r[0]||(r[0]=m=>l("top"))},{default:i(()=>[n("Top")]),_:1}),t(c,{onClick:r[1]||(r[1]=m=>l("bottom"))},{default:i(()=>[n("Bottom")]),_:1})]),_:1})}}},fE=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,gE={__name:"DirectionDoc",setup(e){const{toast:a}=st(),l=()=>{a({horizontal:!0,position:"top left",title:"Watch out!",message:"Next one will open to the right"})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Direction",code:fE},{description:i(()=>[n(" Toasts can stack horizontal ")]),example:i(()=>[t(c,{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1})}}},hE=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,_E={__name:"CenterAligned",setup(e){const{toast:a}=st(),l=()=>{a({centered:!0,title:"Veronika has joined",message:"Welcome to the Fomantic-UI community!"})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Center Aligned",code:hE},{description:i(()=>[n(" The toasts content can be shown center aligned. ")]),example:i(()=>[t(c,{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1})}}},bE=`<template>
...
<\/script>`,vE={__name:"DurationDoc",setup(e){const{toast:a}=st(),l=o=>{a({displayTime:o,message:o===0?"I'll stay here until you click on me !":"You will see me for 5 seconds."})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Duration",code:bE},{description:i(()=>[n(" You can choose how long a toast should be displayed. ")]),example:i(()=>[t(c,{onClick:r[0]||(r[0]=m=>l(5e3))},{default:i(()=>[n("5 seconds")]),_:1}),t(c,{onClick:r[1]||(r[1]=m=>l(0))},{default:i(()=>[n("Stay")]),_:1})]),_:1})}}},yE=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,SE={__name:"MessageStyleDoc",setup(e){const{toast:a}=st(),l=()=>{a({messageStyle:!0,message:"I got my style from the message class",color:"purple"})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Use Message Style",code:yE},{description:i(()=>[n(" You can use all of the styles and colors from the message component. ")]),example:i(()=>[t(c,{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1})}}},wE=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,CE={__name:"IncreasingProgressBarDoc",setup(e){const{toast:a}=st(),l=()=>{a({title:"LOOK",message:"See, how long i will last",showProgress:"top",showProgressUp:!0})};return(o,r)=>{const c=y("SuiButton");return $(),D(M,{label:"Increasing Progress Bar",code:wE},{description:i(()=>[n(" You can use the progress bar to show the progress of a task. ")]),example:i(()=>[t(c,{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1})}}},AE=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,kE={__name:"ColorVariantsDoc",setup(e){const{toast:a}=st(),l=G(0),o=["red","orange","yellow","olive","green","teal","blue","violet","purple","pink","brown","grey","black"],r=()=>{a({color:o[l.value],message:"I am a colorful toast",showProgress:"bottom"}),l.value=(l.value+1)%o.length};return(c,m)=>{const f=y("SuiButton");return $(),D(M,{label:"Color Variants",code:AE},{description:i(()=>[n(" You can use all of the usual color names. ")]),example:i(()=>[t(f,{onClick:r},{default:i(()=>[n("Show")]),_:1})]),_:1})}}},xE={__name:"InvertedColorsDoc",setup(e){const{toast:a}=st(),l=G(0),o=["red","orange","yellow","olive","green","teal","blue","violet","purple","pink","brown","grey","black"],r=()=>{a({color:o[l.value],inverted:!0,message:"I am an inverted colorful toast",showProgress:"bottom"}),l.value=(l.value+1)%o.length};return(c,m)=>{const f=y("SuiButton");return $(),D(M,{label:"Inverted Colors",code:c.code},{description:i(()=>[n(" Same as above, just add inverted to the class definition. ")]),example:i(()=>[t(f,{onClick:r},{default:i(()=>[n("Show")]),_:1})]),_:1},8,["code"])}}},$E=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,LE={__name:"ActionBasicDoc",setup(e){const{toast:a}=st(),l=()=>{a({message:"Do you really want to star Fomantic-UI?",displayTime:0,color:"black",actions:({close:o})=>[J(P,{color:"yellow",onclick:()=>{a({message:'You clicked "yes", toast closes by default'}),o()}},()=>"Yes, really")],actionsProps:{basic:!0,aligned:"left"}})};return(o,r)=>($(),D(M,{label:"Basic",code:TE},{description:i(()=>[n(" The classActions setting provides you a way to adjust the overall appearance of the action buttons. Using basic class does not lighten the actions background. left aligns the buttons to the left. ")]),example:i(()=>[t(p(P),{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1}))}},IE=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,RE={__name:"ActionVerticalDoc",setup(e){const{toast:a}=st(),l=()=>{a({message:"Do you really want to star Fomantic-UI?",displayTime:0,color:"black",actions:({close:o})=>[J(P,{color:"green",onclick:()=>{a({message:'You clicked "yes", toast closes by default'}),o()}},()=>"Yes, really"),J(P,{color:"red",onclick:()=>{a({message:'You clicked "maybe", toast closes by default'}),o()}},()=>"Maybe later")],actionsProps:{vertical:!0}})};return(o,r)=>($(),D(M,{label:"Vertical",code:EE},{description:i(()=>[n(" You can use vertical to display your actions to the right of the toast. ")]),example:i(()=>[t(p(P),{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1}))}},zE=S("br",null,null,-1),PE=`<template>
  <SuiButton @click="show">Show</SuiButton>
</template>
...
<\/script>`,ME={__name:"ActionVerticalAttachedDoc",setup(e){const{toast:a}=st(),l=()=>{a({message:"Do you really want to star Fomantic-UI?",displayTime:0,color:"black",actions:({close:o})=>[J(P,{color:"green",onclick:()=>{a({message:'You clicked "yes", toast closes by default'}),o()}},()=>"Yes, really"),J(P,{color:"red",onclick:()=>{a({message:'You clicked "maybe", toast closes by default'}),o()}},()=>"Maybe later")],actionsProps:{attached:"left",vertical:!0}})};return(o,r)=>($(),D(M,{label:"Vertical Attached",code:PE},{description:i(()=>[n(" Vertical actions can also be displayed as button groups using vertical attached."),zE,n(" Vertical attached actions also support left. ")]),example:i(()=>[t(p(P),{onClick:l},{default:i(()=>[n("Show")]),_:1})]),_:1}))}},VE={__name:"Toast",setup(e){const a=[{id:"minimal",label:"Minimal",category:"Types",component:iE},{id:"titled",label:"Titled",category:"Types",component:lE},{id:"progress-bar",label:"Progress Bar",category:"Types",component:oE},{id:"toast-type",label:"Toast Type",category:"Variations",component:rE},{id:"position",label:"Position",category:"Variations",component:cE},{id:"attached-position",label:"Attached Position",category:"Variations",component:pE},{id:"direction",label:"Direction",category:"Variations",component:gE},{id:"center-aligned",label:"Center Aligned",category:"Variations",component:_E},{id:"duration",label:"Duration",category:"Variations",component:vE},{id:"message-style",label:"Use Message Style",category:"Variations",component:SE},{id:"increasing-progress-bar",label:"Increasing Progress Bar",category:"Variations",component:CE},{id:"color-variants",label:"Color Variants",category:"Variations",component:kE},{id:"inverted-colors",label:"Inverted Colors",category:"Variations",component:xE},{id:"general",label:"General",category:"Actions",component:BE},{id:"action-basic",label:"Basic",category:"Actions",component:LE},{id:"action-attached",label:"Attached",category:"Actions",component:DE},{id:"action-vertical",label:"Vertical",category:"Actions",component:RE},{id:"action-vertical-attached",label:"Vertical Attached",category:"Actions",component:ME}];return(l,o)=>($(),D(Ct,{title:"Toast",description:"A toast allows users to be notified of an event","component-docs":a}))}},FE=[{path:"/",component:W_,children:[{path:"/",component:Cb},{path:"elements/button",component:Rw},{path:"elements/container",component:Uw},{path:"elements/divider",component:_C},{path:"elements/emoji",component:BC},{path:"elements/flag",component:EC},{path:"elements/header",component:dA},{path:"elements/icon",component:FA},{path:"elements/image",component:x0},{path:"elements/input",component:X0},{path:"elements/label",component:ox},{path:"elements/list",component:Dx},{path:"elements/loader",component:t$},{path:"elements/rail",component:n$},{path:"elements/reveal",component:c$},{path:"elements/segment",component:z$},{path:"elements/step",component:N$},{path:"collections/breadcrumb",component:Y$},{path:"collections/form",component:K$},{path:"collections/grid",component:eB},{path:"collections/menu",component:rB},{path:"collections/message",component:yB},{path:"collections/table",component:EB},{path:"views/advertisement",component:VB},{path:"views/card",component:vT},{path:"views/comment",component:b2},{path:"views/feed",component:H2},{path:"views/item",component:TL},{path:"views/statistic",component:VL},{path:"modules/accordion",component:sI},{path:"modules/calendar",component:cI},{path:"modules/checkbox",component:yI},{path:"modules/dimmer",component:CI},{path:"modules/dropdown",component:xI},{path:"modules/embed",component:TI},{path:"modules/modal",component:MI},{path:"modules/popup",component:GI},{path:"modules/progress",component:YI},{path:"modules/rating",component:GD},{path:"modules/sidebar",component:JD},{path:"modules/slider",component:XD},{path:"modules/tab",component:eE},{path:"modules/toast",component:VE}]}],HE=B_({history:jh("/vue-fomantic-ui/"),routes:FE,scrollBehavior(e,a,l){var o;e.hash||(o=document.querySelector(".article"))==null||o.scrollTo(0,0)}});(function(e){var a="\\b(?:BASH|BASHOPTS|BASH_ALIASES|BASH_ARGC|BASH_ARGV|BASH_CMDS|BASH_COMPLETION_COMPAT_DIR|BASH_LINENO|BASH_REMATCH|BASH_SOURCE|BASH_VERSINFO|BASH_VERSION|COLORTERM|COLUMNS|COMP_WORDBREAKS|DBUS_SESSION_BUS_ADDRESS|DEFAULTS_PATH|DESKTOP_SESSION|DIRSTACK|DISPLAY|EUID|GDMSESSION|GDM_LANG|GNOME_KEYRING_CONTROL|GNOME_KEYRING_PID|GPG_AGENT_INFO|GROUPS|HISTCONTROL|HISTFILE|HISTFILESIZE|HISTSIZE|HOME|HOSTNAME|HOSTTYPE|IFS|INSTANCE|JOB|LANG|LANGUAGE|LC_ADDRESS|LC_ALL|LC_IDENTIFICATION|LC_MEASUREMENT|LC_MONETARY|LC_NAME|LC_NUMERIC|LC_PAPER|LC_TELEPHONE|LC_TIME|LESSCLOSE|LESSOPEN|LINES|LOGNAME|LS_COLORS|MACHTYPE|MAILCHECK|MANDATORY_PATH|NO_AT_BRIDGE|OLDPWD|OPTERR|OPTIND|ORBIT_SOCKETDIR|OSTYPE|PAPERSIZE|PATH|PIPESTATUS|PPID|PS1|PS2|PS3|PS4|PWD|RANDOM|REPLY|SECONDS|SELINUX_INIT|SESSION|SESSIONTYPE|SESSION_MANAGER|SHELL|SHELLOPTS|SHLVL|SSH_AUTH_SOCK|TERM|UID|UPSTART_EVENTS|UPSTART_INSTANCE|UPSTART_JOB|UPSTART_SESSION|USER|WINDOWID|XAUTHORITY|XDG_CONFIG_DIRS|XDG_CURRENT_DESKTOP|XDG_DATA_DIRS|XDG_GREETER_DATA_DIR|XDG_MENU_PREFIX|XDG_RUNTIME_DIR|XDG_SEAT|XDG_SEAT_PATH|XDG_SESSION_DESKTOP|XDG_SESSION_ID|XDG_SESSION_PATH|XDG_SESSION_TYPE|XDG_VTNR|XMODIFIERS)\\b",l={pattern:/(^(["']?)\w+\2)[ \t]+\S.*/,lookbehind:!0,alias:"punctuation",inside:null},o={bash:l,environment:{pattern:RegExp("\\$"+a),alias:"constant"},variable:[{pattern:/\$?\(\([\s\S]+?\)\)/,greedy:!0,inside:{variable:[{pattern:/(^\$\(\([\s\S]+)\)\)/,lookbehind:!0},/^\$\(\(/],number:/\b0x[\dA-Fa-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:[Ee]-?\d+)?/,operator:/--|\+\+|\*\*=?|<<=?|>>=?|&&|\|\||[=!+\-*/%<>^&|]=?|[?~:]/,punctuation:/\(\(?|\)\)?|,|;/}},{pattern:/\$\((?:\([^)]+\)|[^()])+\)|`[^`]+`/,greedy:!0,inside:{variable:/^\$\(|^`|\)$|`$/}},{pattern:/\$\{[^}]+\}/,greedy:!0,inside:{operator:/:[-=?+]?|[!\/]|##?|%%?|\^\^?|,,?/,punctuation:/[\[\]]/,environment:{pattern:RegExp("(\\{)"+a),lookbehind:!0,alias:"constant"}}},/\$(?:\w+|[#?*!@$])/],entity:/\\(?:[abceEfnrtv\\"]|O?[0-7]{1,3}|U[0-9a-fA-F]{8}|u[0-9a-fA-F]{4}|x[0-9a-fA-F]{1,2})/};e.languages.bash={shebang:{pattern:/^#!\s*\/.*/,alias:"important"},comment:{pattern:/(^|[^"{\\$])#.*/,lookbehind:!0},"function-name":[{pattern:/(\bfunction\s+)[\w-]+(?=(?:\s*\(?:\s*\))?\s*\{)/,lookbehind:!0,alias:"function"},{pattern:/\b[\w-]+(?=\s*\(\s*\)\s*\{)/,alias:"function"}],"for-or-select":{pattern:/(\b(?:for|select)\s+)\w+(?=\s+in\s)/,alias:"variable",lookbehind:!0},"assign-left":{pattern:/(^|[\s;|&]|[<>]\()\w+(?:\.\w+)*(?=\+?=)/,inside:{environment:{pattern:RegExp("(^|[\\s;|&]|[<>]\\()"+a),lookbehind:!0,alias:"constant"}},alias:"variable",lookbehind:!0},parameter:{pattern:/(^|\s)-{1,2}(?:\w+:[+-]?)?\w+(?:\.\w+)*(?=[=\s]|$)/,alias:"variable",lookbehind:!0},string:[{pattern:/((?:^|[^<])<<-?\s*)(\w+)\s[\s\S]*?(?:\r?\n|\r)\2/,lookbehind:!0,greedy:!0,inside:o},{pattern:/((?:^|[^<])<<-?\s*)(["'])(\w+)\2\s[\s\S]*?(?:\r?\n|\r)\3/,lookbehind:!0,greedy:!0,inside:{bash:l}},{pattern:/(^|[^\\](?:\\\\)*)"(?:\\[\s\S]|\$\([^)]+\)|\$(?!\()|`[^`]+`|[^"\\`$])*"/,lookbehind:!0,greedy:!0,inside:o},{pattern:/(^|[^$\\])'[^']*'/,lookbehind:!0,greedy:!0},{pattern:/\$'(?:[^'\\]|\\[\s\S])*'/,greedy:!0,inside:{entity:o.entity}}],environment:{pattern:RegExp("\\$?"+a),alias:"constant"},variable:o.variable,function:{pattern:/(^|[\s;|&]|[<>]\()(?:add|apropos|apt|apt-cache|apt-get|aptitude|aspell|automysqlbackup|awk|basename|bash|bc|bconsole|bg|bzip2|cal|cargo|cat|cfdisk|chgrp|chkconfig|chmod|chown|chroot|cksum|clear|cmp|column|comm|composer|cp|cron|crontab|csplit|curl|cut|date|dc|dd|ddrescue|debootstrap|df|diff|diff3|dig|dir|dircolors|dirname|dirs|dmesg|docker|docker-compose|du|egrep|eject|env|ethtool|expand|expect|expr|fdformat|fdisk|fg|fgrep|file|find|fmt|fold|format|free|fsck|ftp|fuser|gawk|git|gparted|grep|groupadd|groupdel|groupmod|groups|grub-mkconfig|gzip|halt|head|hg|history|host|hostname|htop|iconv|id|ifconfig|ifdown|ifup|import|install|ip|java|jobs|join|kill|killall|less|link|ln|locate|logname|logrotate|look|lpc|lpr|lprint|lprintd|lprintq|lprm|ls|lsof|lynx|make|man|mc|mdadm|mkconfig|mkdir|mke2fs|mkfifo|mkfs|mkisofs|mknod|mkswap|mmv|more|most|mount|mtools|mtr|mutt|mv|nano|nc|netstat|nice|nl|node|nohup|notify-send|npm|nslookup|op|open|parted|passwd|paste|pathchk|ping|pkill|pnpm|podman|podman-compose|popd|pr|printcap|printenv|ps|pushd|pv|quota|quotacheck|quotactl|ram|rar|rcp|reboot|remsync|rename|renice|rev|rm|rmdir|rpm|rsync|scp|screen|sdiff|sed|sendmail|seq|service|sftp|sh|shellcheck|shuf|shutdown|sleep|slocate|sort|split|ssh|stat|strace|su|sudo|sum|suspend|swapon|sync|sysctl|tac|tail|tar|tee|time|timeout|top|touch|tr|traceroute|tsort|tty|umount|uname|unexpand|uniq|units|unrar|unshar|unzip|update-grub|uptime|useradd|userdel|usermod|users|uudecode|uuencode|v|vcpkg|vdir|vi|vim|virsh|vmstat|wait|watch|wc|wget|whereis|which|who|whoami|write|xargs|xdg-open|yarn|yes|zenity|zip|zsh|zypper)(?=$|[)\s;|&])/,lookbehind:!0},keyword:{pattern:/(^|[\s;|&]|[<>]\()(?:case|do|done|elif|else|esac|fi|for|function|if|in|select|then|until|while)(?=$|[)\s;|&])/,lookbehind:!0},builtin:{pattern:/(^|[\s;|&]|[<>]\()(?:\.|:|alias|bind|break|builtin|caller|cd|command|continue|declare|echo|enable|eval|exec|exit|export|getopts|hash|help|let|local|logout|mapfile|printf|pwd|read|readarray|readonly|return|set|shift|shopt|source|test|times|trap|type|typeset|ulimit|umask|unalias|unset)(?=$|[)\s;|&])/,lookbehind:!0,alias:"class-name"},boolean:{pattern:/(^|[\s;|&]|[<>]\()(?:false|true)(?=$|[)\s;|&])/,lookbehind:!0},"file-descriptor":{pattern:/\B&\d\b/,alias:"important"},operator:{pattern:/\d?<>|>\||\+=|=[=~]?|!=?|<<[<-]?|[&\d]?>>|\d[<>]&?|[<>][&=]?|&[>&]?|\|[&|]?/,inside:{"file-descriptor":{pattern:/^\d/,alias:"important"}}},punctuation:/\$?\(\(?|\)\)?|\.\.|[{}[\];\\]/,number:{pattern:/(^|\s)(?:[1-9]\d*|0)(?:[.,]\d+)?\b/,lookbehind:!0}},l.inside=e.languages.bash;for(var r=["comment","function-name","for-or-select","assign-left","parameter","string","environment","function","keyword","builtin","boolean","file-descriptor","operator","punctuation","number"],c=o.variable[1].inside,m=0;m<r.length;m++)c[r[m]]=e.languages.bash[r[m]];e.languages.sh=e.languages.bash,e.languages.shell=e.languages.bash})(Prism);const Is=bm(kh);Is.use(HE);Is.use(uS);Is.mount("#app");
