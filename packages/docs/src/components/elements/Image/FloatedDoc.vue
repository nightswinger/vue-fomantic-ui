<template>
  <DocSection label="Floated" :code="code">
    <template #description>
      An image can sit to the left or right of other content
    </template>
    <template #example>
      <SuiSegment>
        <SuiImage floated="left" size="small" src="/vue-fomantic-ui/images/wireframe/image-text.png" />
        <p>
        ...
        <SuiImage floated="right" size="small" src="/vue-fomantic-ui/images/wireframe/image-text.png" />
        <p>
...
import { SuiImage, SuiSegment } from 'vue-fomantic-ui'
